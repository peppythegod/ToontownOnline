...
class DistributedNPCScientistAI(
    ...
    def startIfNeeded(self):
        if hasattr(simbase.air,
                   'holidayManager') and simbase.air.holidayManager:
