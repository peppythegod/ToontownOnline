...
class DistributedNPCPetclerkAI(DistributedNPCToonBaseAI):
    ...
    def avatarEnter(self):
        ...
        self.petSeeds.sort()
        self.sendUpdateToAvatarId(avId, 'setPetSeeds', [
            self.petSeeds])
        self.transactionType = ''
        av = self.air.doId2do[avId]
        self.busy = avId
        self.acceptOnce(self.air.getAvatarExitEvent(avId), self._DistributedNPCPetclerkAI__handleUnexpectedExit, extraArgs = [
            avId])
