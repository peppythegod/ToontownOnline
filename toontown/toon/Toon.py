...
def teleportDebug(requestStatus, msg, onlyIfToAv=True):
    if teleportNotify.getDebug():
        teleport = 'teleport'
        if requestStatus.has_key(
                'how') and requestStatus['how'][:len(teleport)] == teleport:
            if (not onlyIfToAv or requestStatus.has_key('avId')
                ) and requestStatus['avId'] > 0:
...
Phase3_5AnimList = (('walk', 'walk'), ('teleport',
                                       'teleport'), ('book', 'book'), ('jump',
                                                                       'jump'),
                    ('running-jump',
                     'running-jump'), ('jump-squat',
                                       'jump-zstart'), ('jump-idle',
                                                        'jump-zhang'),
                    ('jump-land',
                     'jump-zend'), ('running-jump-squat',
                                    'leap_zstart'), ('running-jump-idle',
                                                     'leap_zhang'),
                    ('running-jump-land',
                     'leap_zend'), ('pushbutton',
                                    'press-button'), ('throw', 'pie-throw'),
                    ('victory',
                     'victory-dance'), ('sidestep-left',
                                        'sidestep-left'), ('conked', 'conked'),
                    ('cringe', 'cringe'), ('wave', 'wave'), ('shrug', 'shrug'),
                    ('angry', 'angry'), ('tutorial-neutral',
                                         'tutorial-neutral'), ('left-point',
                                                               'left-point'),
                    ('right-point',
                     'right-point'), ('right-point-start',
                                      'right-point-start'), ('give-props',
                                                             'give-props'),
                    ('give-props-start',
                     'give-props-start'), ('right-hand',
                                           'right-hand'), ('right-hand-start',
                                                           'right-hand-start'),
                    ('duck', 'duck'), ('sidestep-right',
                                       'jump-back-right'), ('periscope',
                                                            'periscope'))
Phase4AnimList = (('sit', 'sit'), ('sit-start', 'intoSit'), ('swim', 'swim'),
                  ('tug-o-war', 'tug-o-war'), ('sad-walk',
                                               'losewalk'), ('sad-neutral',
                                                             'sad-neutral'),
                  ('up', 'up'), ('down', 'down'), ('left', 'left'), ('right',
                                                                     'right'),
                  ('applause', 'applause'), ('confused', 'confused'), ('bow',
                                                                       'bow'),
                  ('curtsy', 'curtsy'), ('bored', 'bored'), ('think', 'think'),
                  ('battlecast', 'fish'), ('cast',
                                           'cast'), ('castlong',
                                                     'castlong'), ('fish-end',
                                                                   'fishEND'),
                  ('fish-neutral',
                   'fishneutral'), ('fish-again',
                                    'fishAGAIN'), ('reel', 'reel'), ('reel-H',
                                                                     'reelH'),
                  ('reel-neutral',
                   'reelneutral'), ('pole',
                                    'pole'), ('pole-neutral',
                                              'poleneutral'), ('slip-forward',
                                                               'slip-forward'),
                  ('slip-backward',
                   'slip-backward'), ('catch-neutral',
                                      'gameneutral'), ('catch-run', 'gamerun'),
                  ('catch-eatneutral',
                   'eat_neutral'), ('catch-eatnrun',
                                    'eatnrun'), ('catch-intro-throw',
                                                 'gameThrow'), ('swing',
                                                                'swing'),
                  ('pet-start',
                   'petin'), ('pet-loop',
                              'petloop'), ('pet-end',
                                           'petend'), ('scientistJealous',
                                                       'scientistJealous'),
                  ('scientistEmcee',
                   'scientistEmcee'), ('scientistWork',
                                       'scientistWork'), ('scientistGame',
                                                          'scientistGame'))
Phase5AnimList = (('water-gun', 'water-gun'), ('hold-bottle',
                                               'hold-bottle'), ('firehose',
                                                                'firehose'),
                  ('spit', 'spit'), ('tickle', 'tickle'), ('smooch', 'smooch'),
                  ('happy-dance',
                   'happy-dance'), ('sprinkle-dust',
                                    'sprinkle-dust'), ('juggle', 'juggle'),
                  ('climb', 'climb'), ('sound', 'shout'), ('toss', 'toss'),
                  ('hold-magnet', 'hold-magnet'), ('hypnotize', 'hypnotize'),
                  ('struggle', 'struggle'), ('lose', 'lose'), ('melt', 'melt'))
Phase5_5AnimList = (('takePhone', 'takePhone'), ('phoneNeutral',
                                                 'phoneNeutral'),
                    ('phoneBack', 'phoneBack'), ('bank', 'jellybeanJar'),
                    ('callPet', 'callPet'), ('feedPet', 'feedPet'),
                    ('start-dig',
                     'into_dig'), ('loop-dig', 'loop_dig'), ('water', 'water'))
Phase6AnimList = (('headdown-putt', 'headdown-putt'), ('into-putt',
                                                       'into-putt'),
                  ('loop-putt', 'loop-putt'), ('rotateL-putt', 'rotateL-putt'),
                  ('rotateR-putt',
                   'rotateR-putt'), ('swing-putt',
                                     'swing-putt'), ('look-putt', 'look-putt'),
                  ('lookloop-putt', 'lookloop-putt'), ('bad-putt', 'bad-putt'),
                  ('badloop-putt', 'badloop-putt'), ('good-putt', 'good-putt'))
Phase9AnimList = (('push', 'push'), )
Phase10AnimList = (('leverReach', 'leverReach'), ('leverPull', 'leverPull'),
...
def compileGlobalAnimList():
    phaseList = [
        Phase3AnimList, Phase3_5AnimList, Phase4AnimList, Phase5AnimList,
        Phase5_5AnimList, Phase6AnimList, Phase9AnimList, Phase10AnimList,
        Phase12AnimList
    ]
    phaseStrList = [
        'phase_3', 'phase_3.5', 'phase_4', 'phase_5', 'phase_5.5', 'phase_6',
        'phase_9', 'phase_10', 'phase_12'
    ]
...
def loadDialog():
    ...
    DogDialogueFiles = ('AV_dog_short', 'AV_dog_med', 'AV_dog_long',
                        'AV_dog_question', 'AV_dog_exclaim', 'AV_dog_howl')
    for file in DogDialogueFiles:
        DogDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))

    catDialogueFiles = ('AV_cat_short', 'AV_cat_med', 'AV_cat_long',
                        'AV_cat_question', 'AV_cat_exclaim', 'AV_cat_howl')
    ...
    horseDialogueFiles = ('AV_horse_short', 'AV_horse_med', 'AV_horse_long',
                          'AV_horse_question', 'AV_horse_exclaim',
                          'AV_horse_howl')
    for file in horseDialogueFiles:
        HorseDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))

    rabbitDialogueFiles = ('AV_rabbit_short', 'AV_rabbit_med',
                           'AV_rabbit_long', 'AV_rabbit_question',
                           'AV_rabbit_exclaim', 'AV_rabbit_howl')
    for file in rabbitDialogueFiles:
        RabbitDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))

    mouseDialogueFiles = ('AV_mouse_short', 'AV_mouse_med', 'AV_mouse_long',
                          'AV_mouse_question', 'AV_mouse_exclaim',
                          'AV_mouse_howl')
    ...
    monkeyDialogueFiles = ('AV_monkey_short', 'AV_monkey_med',
                           'AV_monkey_long', 'AV_monkey_question',
                           'AV_monkey_exclaim', 'AV_monkey_howl')
    for file in monkeyDialogueFiles:
        MonkeyDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))

    bearDialogueFiles = ('AV_bear_short', 'AV_bear_med', 'AV_bear_long',
                         'AV_bear_question', 'AV_bear_exclaim', 'AV_bear_howl')
    for file in bearDialogueFiles:
        BearDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))

    pigDialogueFiles = ('AV_pig_short', 'AV_pig_med', 'AV_pig_long',
                        'AV_pig_question', 'AV_pig_exclaim', 'AV_pig_howl')
    for file in pigDialogueFiles:
        PigDialogueArray.append(base.loadSfx(loadPath + file + '.mp3'))


def unloadDialog():
    global DogDialogueArray, CatDialogueArray, HorseDialogueArray, RabbitDialogueArray, MouseDialogueArray, DuckDialogueArray, MonkeyDialogueArray, BearDialogueArray, PigDialogueArray
    DogDialogueArray = []
    CatDialogueArray = []
    HorseDialogueArray = []
    RabbitDialogueArray = []
...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def setDNAString(self, dnaString):
        ...
        if len(newDNA.torso) < 2:
            self.sendLogSuspiciousEvent(
                'nakedToonDNA %s was requested' % newDNA.torso)
    ...
    def getBookActors(self):
        ...
        self._Toon__bookActors = [bookActor, bookActor2, bookActor3]
    ...
    def getHoleActors(self):
        ...
        self._Toon__holeActors = [holeActor, holeActor2, holeActor3]
        for ha in self._Toon__holeActors:
    ...
    def resetHeight(self):
        if hasattr(self, 'style') and self.style:
            ...
            shoulderHeight = ToontownGlobals.legHeightDict[
                self.style.legs] * bodyScale + ToontownGlobals.torsoHeightDict[
                    self.style.torso] * bodyScale
            height = shoulderHeight + ToontownGlobals.headHeightDict[
                self.style.head] * headScale
    ...
    def generateToonTorso(self, copy=1, genClothes=1):
        ...
        if len(torsoStyle) == 1:
            self.loadModel('phase_3' + filePrefix + '1000', 'torso', '500',
                           copy)
            self.loadModel('phase_3' + filePrefix + '1000', 'torso', '250',
                           copy)
        else:
            self.loadModel('phase_3' + filePrefix + '500', 'torso', '500',
                           copy)
            self.loadModel('phase_3' + filePrefix + '250', 'torso', '250',
                           copy)
        if not copy:
    ...
    def generateToonHead(self, copy=1):
        headHeight = ToonHead.generateToonHead(self, copy, self.style,
                                               ('1000', '500', '250'))
    ...
    def generateHat(self, fromRTM=False):
        ...
        if hat[0] >= len(ToonDNA.HatModels):
            self.sendLogSuspiciousEvent(
                'tried to put a wrong hat idx %d' % hat[0])
            return None
        ...
        if hat[0] != 0:
            ...
            if hatGeom:
                ...
                if AccessoryGlobals.ExtendedHatTransTable.get(hat[0]):
                    transOffset = AccessoryGlobals.ExtendedHatTransTable[
                        hat[0]].get(self.style.head[:2])
                ...
                hatGeom.setPos(transOffset[0][0], transOffset[0][1],
                               transOffset[0][2])
                hatGeom.setHpr(transOffset[1][0], transOffset[1][1],
                               transOffset[1][2])
            ...
            if glassesGeom:
                ...
                if AccessoryGlobals.ExtendedGlassesTransTable.get(glasses[0]):
                    transOffset = AccessoryGlobals.ExtendedGlassesTransTable[
                        glasses[0]].get(self.style.head[:2])
    ...
    def generateBackpack(self, fromRTM=False):
        ...
        if backpack[0] != 0:
            geom = loader.loadModel(
                ToonDNA.BackpackModels[backpack[0]], okMissing=True)
            if geom:
                if backpack[1] != 0:
                ...
                transOffset = None
                if AccessoryGlobals.ExtendedBackpackTransTable.get(
                        backpack[0]):
                    transOffset = AccessoryGlobals.ExtendedBackpackTransTable[
                        backpack[0]].get(self.style.torso[:1])
                ...
                geom.setPos(transOffset[0][0], transOffset[0][1],
                            transOffset[0][2])
                geom.setHpr(transOffset[1][0], transOffset[1][1],
                            transOffset[1][2])
                geom.setScale(transOffset[2][0], transOffset[2][1],
                              transOffset[2][2])
    ...
    def generateShoes(self):
        ...
        if shoes[0] >= len(ToonDNA.ShoesModels):
            self.sendLogSuspiciousEvent(
                'tried to put a wrong shoes idx %d' % shoes[0])
            return None
    ...
    def findSomethingToLookAt(self):
        if self.randGen.random() < 0.10000000000000001 or not hasattr(
                self, 'cr'):
    ...
    def setSpeed(self, forwardSpeed, rotateSpeed):
        ...
        if self.standWalkRunReverse != None:
            ...
            if showWake and self.getZ(render) < wakeWaterHeight and abs(
                    forwardSpeed) > ToontownGlobals.WalkCutOff:
                currT = globalClock.getFrameTime()
                deltaT = currT - self.lastWakeTime
                if action == OTPGlobals.RUN_INDEX or deltaT > ToontownGlobals.WakeRunDelta or deltaT > ToontownGlobals.WakeWalkDelta:
    ...
    def enterSad(self, animMultiplier=1, ts=0, callback=None, extraArgs=[]):
        ...
        self.playingRate = None
        self.standWalkRunReverse = (('sad-neutral', 1.0), ('sad-walk', 1.2),
                                    ('sad-walk', 1.2), ('sad-walk', -1.0))
        self.setSpeed(0, 0)
    ...
    def enterCatching(self,
        ...
        self.playingAnim = None
        self.playingRate = None
        self.standWalkRunReverse = (('catch-neutral', 1.0), ('catch-run', 1.0),
                                    ('catch-run', 1.0), ('catch-run', -1.0))
        self.setSpeed(self.forwardSpeed, self.rotateSpeed)
        self.setActiveShadow(1)
    ...
    def enterCatchEating(self,
        ...
        self.playingAnim = None
        self.playingRate = None
        self.standWalkRunReverse = (('catch-eatneutral',
                                     1.0), ('catch-eatnrun', 1.0),
                                    ('catch-eatnrun', 1.0), ('catch-eatnrun',
                                                             -1.0))
        self.setSpeed(self.forwardSpeed, self.rotateSpeed)
        self.setActiveShadow(0)
    ...
    def getTeleportOutTrack(self, autoFinishTrack=1):
        ...
        holeTrack = Track(
            ...
            (3.3999999999999999, Func(cleanupHoles, holes)))
        if hasattr(self, 'uniqueName'):
        ...
        for hole in holes:
            track.append(
                ActorInterval(hole, 'hole', duration=3.3999999999999999))

        track.append(
            ActorInterval(self, 'teleport', duration=3.3999999999999999))
        return track
    ...
    def getTeleportInTrack(self):
        ...
        holeTrack.append(
            ActorInterval(
                hole,
                'hole',
                startTime=3.3999999999999999,
                endTime=3.1000000000000001))
        holeTrack.append(Wait(0.59999999999999998))
        holeTrack.append(
            ActorInterval(
                hole,
                'hole',
                startTime=3.1000000000000001,
                endTime=3.3999999999999999))
        ...
        toonTrack = Sequence(
            Wait(0.29999999999999999), Func(self.getGeomNode().show),
            Func(self.nametag3d.show),
            ActorInterval(self, 'jump', startTime=0.45000000000000001))
        if hasattr(self, 'uniqueName'):
    ...
    def enterSleep(self, animMultiplier=1, ts=0, callback=None, extraArgs=[]):
        ...
        if self == base.localAvatar:
            ...
            taskMgr.doMethodLater(self.afkTimeout,
                                  self._Toon__handleAfkTimeout,
    ...
    def _Toon__handleAfkTimeout(self, task):
        ...
        self.b_setAnimState('TeleportOut', 1,
                            self._Toon__handleAfkExitTeleport, [0])
        return Task.done
    ...
    def exitSleep(self):
        ...
        if config.GetBool('stuck-sleep-fix', 1):
            doClear = SLEEP_STRING in (self.nametag.getChat(),
    ...
    def enterEmote(self, animMultiplier=1, ts=0, callback=None, extraArgs=[]):
        ...
        duration = 0
        (self.emoteTrack, duration) = Emote.globalEmote.doEmote(
            self, emoteIndex, ts)
        self.setActiveShadow(1)
    ...
    def enterSquish(self, animMultiplier=1, ts=0, callback=None, extraArgs=[]):
        ...
        self.track = Sequence(
            LerpScaleInterval(
                node,
                lerpTime,
                VBase3(2, 2, 0.025000000000000001),
            ...
            Parallel(
                Sequence(
                    ...
                    LerpScaleInterval(
                        node,
                        lerpTime,
                        VBase3(1.3999999999999999, 1.3999999999999999,
                               1.3999999999999999),
                        blendType='easeInOut'),
                    LerpScaleInterval(
                        node,
                        lerpTime / 2.0,
                        VBase3(0.80000000000000004, 0.80000000000000004,
                               0.80000000000000004),
                        blendType='easeInOut'),
                    LerpScaleInterval(
                        node, lerpTime / 3.0, origScale,
                        blendType='easeInOut')),
                ActorInterval(self, 'jump', startTime=0.20000000000000001),
                SoundInterval(sound)))
        self.track.start(ts)
        self.setActiveShadow(1)
    ...
    def enterFallDown(self,
        ...
        Emote.globalEmote.disableAll(self)
        self.track = Sequence(
            ActorInterval(self, 'slip-backward'), name='fallTrack')
        if callback:
            self.track.setDoneEvent(self.track.getName())
            self.acceptOnce(self.track.getName(), callback, extraArgs)
    ...
    def stunToon(self, ts=0, callback=None, knockdown=0):
        if not self.isStunned:
            ...
            lerpTime = 0.5
            down = self.doToonColorScale(
                VBase4(1, 1, 1, 0.59999999999999998), lerpTime)
            up = self.doToonColorScale(
                VBase4(1, 1, 1, 0.90000000000000002), lerpTime)
            clear = self.doToonColorScale(self.defaultColorScale, lerpTime)
            track = Sequence(
                Func(setStunned, 1), down, up, down, up, down, up, down, clear,
    ...
    def applyCheesyEffect(self, effect, lerpTime=0):
        ...
        if self.cheesyEffect != effect:
            ...
            if oldEffect == ToontownGlobals.CENormal:
                ...
                self.effectTrack = self._Toon__undoCheesyEffect(
                    oldEffect, lerpTime)
            else:
                self.effectTrack = Sequence(
                    self._Toon__undoCheesyEffect(oldEffect, lerpTime / 2.0),
                    self._Toon__doCheesyEffect(effect, lerpTime / 2.0))
    ...
    def reapplyCheesyEffect(self, lerpTime=0):
        ...
        self.effectTrack = Sequence(
            self._Toon__undoCheesyEffect(effect, 0),
            self._Toon__doCheesyEffect(effect, lerpTime))
        self.effectTrack.start()
    ...
    def _Toon__doHeadScale(self, scale, lerpTime):
        ...
        for hi in range(self.headParts.getNumPaths()):
            ...
            track.append(
                LerpScaleInterval(
                    head, lerpTime, scale, blendType='easeInOut'))
    ...
    def _Toon__doLegsScale(self, scale, lerpTime):
        ...
        for li in range(self.legsParts.getNumPaths()):
            ...
            track.append(
                LerpScaleInterval(
                    legs, lerpTime, scale, blendType='easeInOut'))
            track.append(
                LerpScaleInterval(
                    torso, lerpTime, invScale, blendType='easeInOut'))
    ...
    def _Toon__doToonScale(self, scale, lerpTime):
        ...
        track = Sequence(
            Parallel(
                LerpHprInterval(
                    node, lerpTime, Vec3(0.0, 0.0, 0.0),
                    blendType='easeInOut'),
                LerpScaleInterval(
                    node, lerpTime, scale, blendType='easeInOut')),
    ...
    def _Toon__doPumpkinHeadSwitch(self, lerpTime, toPumpkin):
        node = self.getGeomNode()
            ...
            def hideParts():
                ...
                for head in self.headParts:
                    for p in head.getChildren():
                        if hasattr(
                                self,
                                'pumpkins') and not self.pumpkins.hasPath(p):
                            p.hide()
        ...
        def showHiddenParts():
            ...
            for head in self.headParts:
                for p in head.getChildren():
                    if not self.pumpkins.hasPath(p) and p.getTag(
                            'pumpkin') == 'enabled':
                        p.show()
    ...
    def _Toon__doSnowManHeadSwitch(self, lerpTime, toSnowMan):
        node = self.getGeomNode()
        ...
        def showHiddenParts():
            ...
            for hi in range(self.headParts.getNumPaths()):
                ...
                for pi in range(parts.getNumPaths()):
                    p = parts[pi]
                    if not self.snowMen.hasPath(p) and p.getTag(
                            'snowman') == 'enabled':
                        p.show()
    ...
    def _Toon__doGreenToon(self, lerpTime, toGreen):
        track = Sequence()
        greenTrack = Parallel()
        ...
        if toGreen:
            ...
            greenTrack.append(self._Toon__colorToonSkin(skinGreen, lerpTime))
            greenTrack.append(
                self._Toon__colorToonEars(skinGreen, muzzleGreen, lerpTime))
            greenTrack.append(
                self._Toon__colorScaleToonMuzzle(muzzleGreen, lerpTime))
            greenTrack.append(
                self._Toon__colorToonGloves(gloveGreen, lerpTime))
        else:
            greenTrack.append(self._Toon__colorToonSkin(None, lerpTime))
            greenTrack.append(self._Toon__colorToonEars(None, None, lerpTime))
            greenTrack.append(self._Toon__colorScaleToonMuzzle(None, lerpTime))
            greenTrack.append(self._Toon__colorToonGloves(None, lerpTime))
        track.append(greenTrack)
        return track

    def _Toon__colorToonSkin(self, color, lerpTime):
        track = Sequence()
        colorTrack = Parallel()
    ...
    def _Toon__colorToonEars(self, color, colorScale, lerpTime):
        track = Sequence()
    ...
    def _Toon__colorScaleToonMuzzle(self, scale, lerpTime):
        track = Sequence()
        colorTrack = Parallel()
    ...
    def _Toon__colorToonGloves(self, color, lerpTime):
        track = Sequence()
        colorTrack = Parallel()
    ...
    def _Toon__doBigAndWhite(self, color, scale, lerpTime):
        track = Parallel()
        track.append(self._Toon__doToonColor(color, lerpTime))
        track.append(self._Toon__doToonScale(scale, lerpTime))
        return track

    def _Toon__doVirtual(self):
        track = Parallel()
        track.append(self._Toon__doToonColor(VBase4(0.25, 0.25, 1.0, 1), 0.0))
    ...
    def _Toon__doUnVirtual(self):
        track = Parallel()
        track.append(self._Toon__doToonColor(None, 0.0))
    ...
    def _Toon__doPartsColorScale(self, scale, lerpTime):
        ...
        for piece in pieces:
            ...
            p1.append(
                LerpColorScaleInterval(
                    piece, lerpTime, scale, blendType='easeInOut'))
    ...
    def _Toon__doCheesyEffect(self, effect, lerpTime):
        if effect == ToontownGlobals.CEBigHead:
            ...
            return self._Toon__doToonScale(ToontownGlobals.BigToonScale,
                                           lerpTime)
        elif effect == ToontownGlobals.CESmallToon:
            return self._Toon__doToonScale(ToontownGlobals.SmallToonScale,
                                           lerpTime)
        elif effect == ToontownGlobals.CEFlatPortrait:
            return self._Toon__doToonScale(
                VBase3(1, 0.050000000000000003, 1), lerpTime)
        elif effect == ToontownGlobals.CEFlatProfile:
            return self._Toon__doToonScale(
                VBase3(0.050000000000000003, 1, 1), lerpTime)
        elif effect == ToontownGlobals.CETransparent:
            return self.doToonColorScale(
                VBase4(1, 1, 1, 0.59999999999999998), lerpTime, keepDefault=1)
            ...
            return self._Toon__doPumpkinHeadSwitch(lerpTime, toPumpkin=True)
        elif effect == ToontownGlobals.CEBigWhite:
            return self._Toon__doBigAndWhite(
                VBase4(1, 1, 1, 1), ToontownGlobals.BigToonScale, lerpTime)
        elif effect == ToontownGlobals.CESnowMan:
            return self._Toon__doSnowManHeadSwitch(lerpTime, toSnowMan=True)
        elif effect == ToontownGlobals.CEGreenToon:
            return self._Toon__doGreenToon(lerpTime, toGreen=True)
        elif effect == ToontownGlobals.CEVirtual:
            return self._Toon__doVirtual()
            ...
            return Sequence(
                self._Toon__doToonGhostColorScale(
    ...
    def _Toon__undoCheesyEffect(self, effect, lerpTime):
        ...
        if effect == ToontownGlobals.CEBigLegs:
            ...
            return self._Toon__doPumpkinHeadSwitch(lerpTime, toPumpkin=False)
        elif effect == ToontownGlobals.CEBigWhite:
            return self._Toon__doBigAndWhite(None, None, lerpTime)
        elif effect == ToontownGlobals.CESnowMan:
            return self._Toon__doSnowManHeadSwitch(lerpTime, toSnowMan=False)
        elif effect == ToontownGlobals.CEGreenToon:
            return self._Toon__doGreenToon(lerpTime, toGreen=False)
        elif effect == ToontownGlobals.CEVirtual:
            return self._Toon__doUnVirtual()
        elif effect == ToontownGlobals.CEGhost:
            return Sequence(
                Func(self.nametag3d.show),
                self._Toon__doToonGhostColorScale(
    ...
    def putOnSuit(self, suitType, setDisplayName=True, rental=False):
        ...
        if self.isLocal():
            ...
            self.controlManager.disableAvatarJump()
            indices = range(OTPLocalizer.SCMenuCommonCogIndices[0],
    ...
    def getPresentPieInterval(self, x, y, z, h, p, r):
        ...
        track = Sequence(
            ...
            Parallel(
                pie.scaleInterval(
                    1, self.pieScale, startScale=MovieUtil.PNT3_NEARZERO),
    ...
    def getTossPieInterval(self,
        ...
        toss = Track((0,
                      Sequence(
                          ...
                          Func(pie.setPosHpr, 0, 0, 0, 0, 0, 0),
                          Parallel(
                              ActorInterval(self, 'throw', startFrame=48),
                              animPie), Func(self.loop, 'neutral'))),
        ...
        fly = Track(
            ...
            (16.0 / 24.0,
             Sequence(
                 ...
                 Func(flyPie.setPosHpr, self, 0.52000000000000002,
                      0.96999999999999997, 2.2400000000000002,
                      89.420000000000002, -10.56, 87.939999999999998),
                 beginFlyIval,
    ...
    def enterCogThiefRunning(self,
        ...
        self.playingAnim = None
        self.playingRate = None
        self.standWalkRunReverse = (('neutral', 1.0), ('run', 1.0),
                                    ('run', 1.0), ('run', -1.0))
        self.setSpeed(self.forwardSpeed, self.rotateSpeed)
        self.setActiveShadow(1)
    ...
    def enterScientistJealous(self,
                              animMultiplier=1,
                              ts=0,
                              callback=None,
                              extraArgs=[]):
    ...
    def enterScientistLessWork(self,
                               animMultiplier=1,
                               ts=0,
                               callback=None,
                               extraArgs=[]):
