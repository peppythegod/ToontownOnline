...
Phase4AnimList = (('sit', 'sit'), ('sit-start', 'intoSit'), ('swim', 'swim'), ('tug-o-war', 'tug-o-war'), ('sad-walk', 'losewalk'), ('sad-neutral', 'sad-neutral'), ('up', 'up'), ('down', 'down'), ('left', 'left'), ('right', 'right'), ('applause', 'applause'), ('confused', 'confused'), ('bow', 'bow'), ('curtsy', 'curtsy'), ('bored', 'bored'), ('think', 'think'), ('battlecast', 'fish'), ('cast', 'cast'), ('castlong', 'castlong'), ('fish-end', 'fishEND'), ('fish-neutral', 'fishneutral'), ('fish-again', 'fishAGAIN'), ('reel', 'reel'), ('reel-H', 'reelH'), ('reel-neutral', 'reelneutral'), ('pole', 'pole'), ('pole-neutral', 'poleneutral'), ('slip-forward', 'slip-forward'), ('slip-backward', 'slip-backward'), ('catch-neutral', 'gameneutral'), ('catch-run', 'gamerun'), ('catch-eatneutral', 'eat_neutral'), ('catch-eatnrun', 'eatnrun'), ('catch-intro-throw', 'gameThrow'), ('swing', 'swing'), ('pet-start', 'petin'), ('pet-loop', 'petloop'), ('pet-end', 'petend'), ('scientistJealous', 'scientistJealous'), ('scientistEmcee', 'scientistEmcee'), ('scientistWork', 'scientistWork'), ('scientistGame', 'scientistGame'))
Phase5AnimList = (('water-gun', 'water-gun'), ('hold-bottle', 'hold-bottle'), ('firehose', 'firehose'), ('spit', 'spit'), ('tickle', 'tickle'), ('smooch', 'smooch'), ('happy-dance', 'happy-dance'), ('sprinkle-dust', 'sprinkle-dust'), ('juggle', 'juggle'), ('climb', 'climb'), ('sound', 'shout'), ('toss', 'toss'), ('hold-magnet', 'hold-magnet'), ('hypnotize', 'hypnotize'), ('struggle', 'struggle'), ('lose', 'lose'), ('melt', 'melt'))
Phase5_5AnimList = (('takePhone', 'takePhone'), ('phoneNeutral', 'phoneNeutral'), ('phoneBack', 'phoneBack'), ('bank', 'jellybeanJar'), ('callPet', 'callPet'), ('feedPet', 'feedPet'), ('start-dig', 'into_dig'), ('loop-dig', 'loop_dig'), ('water', 'water'))
Phase6AnimList = (('headdown-putt', 'headdown-putt'), ('into-putt', 'into-putt'), ('loop-putt', 'loop-putt'), ('rotateL-putt', 'rotateL-putt'), ('rotateR-putt', 'rotateR-putt'), ('swing-putt', 'swing-putt'), ('look-putt', 'look-putt'), ('lookloop-putt', 'lookloop-putt'), ('bad-putt', 'bad-putt'), ('badloop-putt', 'badloop-putt'), ('good-putt', 'good-putt'))
...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def reapplyCheesyEffect(self, lerpTime = 0):
        ...
        self.effectTrack = Sequence(self._Toon__undoCheesyEffect(effect, 0), self._Toon__doCheesyEffect(effect, lerpTime))
        self.effectTrack.start()
    ...
    def _Toon__doGreenToon(self, lerpTime, toGreen):
        ...
        if toGreen:
            ...
            greenTrack.append(self._Toon__colorToonEars(skinGreen, muzzleGreen, lerpTime))
            greenTrack.append(self._Toon__colorScaleToonMuzzle(muzzleGreen, lerpTime))
            greenTrack.append(self._Toon__colorToonGloves(gloveGreen, lerpTime))
        else:
    ...
    def _Toon__doCheesyEffect(self, effect, lerpTime):
        if effect == ToontownGlobals.CEBigHead:
            ...
            return self._Toon__doBigAndWhite(VBase4(1, 1, 1, 1), ToontownGlobals.BigToonScale, lerpTime)
    ...
    def getTossPieInterval(self, x, y, z, h, p, r, power, beginFlyIval = Sequence()):
        ...
        fly = Track((14.0 / 24.0, SoundInterval(sound, node = self)), (16.0 / 24.0, Sequence(Func(flyPie.reparentTo, render), Func(flyPie.setScale, self.pieScale), Func(flyPie.setPosHpr, self, 0.52000000000000002, 0.96999999999999997, 2.2400000000000002, 89.420000000000002, -10.56, 87.939999999999998), beginFlyIval, ProjectileInterval(flyPie, startVel = getVelocity, duration = 3), Func(flyPie.detachNode))))
    ...
    def enterFlattened(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        ...
        self.track = Sequence(LerpScaleInterval(node, lerpTime, VBase3(2, 2, 0.025000000000000001), blendType = 'easeInOut'))
        self.track.start(ts)
        self.setActiveShadow(1)
