...
class ToonAvatarPanel(AvatarPanelBase.AvatarPanelBase):
    ...
    def __init__(self, avatar, playerId=None):
        ...
        self.text3Color = Vec4(0.59999999999999998, 0.59999999999999998,
        ...
        self.healthText = DirectLabel(
            parent=self.frame,
            text='',
            pos=(0.059999999999999998, 0, 0.20000000000000001),
            text_pos=(0, 0),
            text_scale=0.050000000000000003)
        self.healthText.hide()
        self.nameLabel = DirectLabel(
            parent=self.frame,
            pos=(0.012500000000000001, 0, 0.40000000000000002),
            relief=None,
            text=self.avName,
            text_font=avatar.getFont(),
            text_fg=Vec4(0, 0, 0, 1),
            text_pos=(0, 0),
            text_scale=0.042000000000000003,
            text_wordwrap=7.5,
            text_shadow=(1, 1, 1, 1))
        self.closeButton = DirectButton(
            ...
            command=self._ToonAvatarPanel__handleClose)
        self.friendButton = DirectButton(
            ...
            command=self._ToonAvatarPanel__handleFriend)
        if base.cr.playerFriendsManager.askTransientFriend(
        ...
        self.secretsButton = DirectButton(
            parent=self.frame,
            image=(gui.find('**/Amuse_Btn_UP'), gui.find('**/Amuse_Btn_DN'),
                   gui.find('**/Amuse_Btn_RLVR'), gui.find('**/Amuse_Btn_UP')),
            image3_color=self.disabledImageColor,
            image_scale=0.90000000000000002,
            relief=None,
        ...
        self.detailButton = DirectButton(
            ...
            text_shadow=(0, 0, 0, 1),
            text_scale=0.055,
            text_pos=(-0.074999999999999997, -0.01),
            text_align=TextNode.ARight,
            pos=(-0.133773, 0, -0.39500000000000002),
            command=self._ToonAvatarPanel__handleDetails)
        ...
        if self.avGenerateName:
            self.accept(self.avGenerateName,
                        self._ToonAvatarPanel__handleGenerateAvatar)
    ...
    def _ToonAvatarPanel__handleToPet(self):
        ...
        PetDetail.PetDetail(toonAvatar.getPetId(),
                            self._ToonAvatarPanel__petDetailsLoaded)

    def _ToonAvatarPanel__petDetailsLoaded(self, avatar):
        self.cleanup()
        if avatar:
            self.notify.debug(
                "Looking at someone's pet. pet doId = %s" % avatar.doId)
    ...
    def handleKick(self):
        if not base.cr.playGame.getPlace().getState() == 'elevator':
            self.confirmKickOutDialog = TTDialog.TTDialog(
                ...
                command=self._ToonAvatarPanel__confirmKickOutCallback)
    ...
    def _ToonAvatarPanel__checkGroupStatus(self):
        ...
        if hasattr(self, 'avatar'):
            if self.avatar and hasattr(self.avatar,
                                       'getZoneId') and localAvatar.getZoneId(
                                       ) == self.avatar.getZoneId():
                if localAvatar.boardingParty:
                    if self.avId in localAvatar.boardingParty.getGroupMemberList(
                        ...
                        if localAvatar.boardingParty.getGroupLeader(
                            ...
                            self.groupButton[
                                'image'] = self.inviteImageDisabled
                            self.groupButton['image_color'] = Vec4(
                                1, 1, 1, 0.40000000000000002)
                            self.groupButton['state'] = DGG.NORMAL
                    else:
                        self.groupButton['text'] = (
    ...
    def _ToonAvatarPanel__makePetGui(self, avatar):
        ...
        self.petButton = DirectButton(
            ...
            relief=None,
            pos=(0.22, -0.20000000000000001, -0.47499999999999998),
            text=('', TTLocalizer.AvatarPanelPet, TTLocalizer.AvatarPanelPet,
                  ''),
            text_fg=self.text2Color,
            text_shadow=(0, 0, 0, 1),
            text_scale=0.32500000000000001,
            text_pos=(-1.3, 0.050000000000000003),
    ...
    def _ToonAvatarPanel__makeBoardingGui(self):
        ...
        self.groupFrame = DirectFrame(
            ...
            text_pos=(0.01, 0.080000000000000002),
            pos=(0, 0, -0.60999999999999999))
        ...
        self.kickOutImageList = (
            ...
            groupInviteGui.find('**/tt_t_gui_brd_kickoutUp'))
        self.inviteImageDisabled = groupInviteGui.find(
            '**/tt_t_gui_brd_inviteDisabled')
        self.groupButton = DirectButton(
            parent=self.groupFrame,
            image=self.inviteImageList,
            image3_color=self.disabledImageColor,
            image_scale=0.84999999999999998,
            relief=None,
            text=('', TTLocalizer.AvatarPanelGroupInvite,
                  TTLocalizer.AvatarPanelGroupInvite),
            text0_fg=self.text0Color,
            text1_fg=self.text1Color,
            text2_fg=self.text2Color,
            ...
            pos=(0.01013, 0, -0.054640000000000001))
        ...
        self.boardingInfoButton = DirectButton(
            parent=self.groupFrame,
            relief=None,
            text_pos=(-0.050000000000000003, 0.050000000000000003),
            text_scale=0.059999999999999998,
            text_align=TextNode.ALeft,
            ...
            pos=(0.18290000000000001, 0, 0.024049999999999998))
        self.boardingInfoText = None
