...
class PlayerDetailPanel(DirectFrame):
    ...
    def __init__(self, avId, avName, playerId=None, parent=aspect2dp, **kw):
        ...
        self.dataText = DirectLabel(
            self,
            text='',
            text_scale=0.085000000000000006,
            text_align=TextNode.ALeft,
            text_wordwrap=15,
            relief=None,
            pos=(-0.84999999999999998, 0.0, 0.72499999999999998))
        if self.avId:
            self.avText = DirectLabel(
                ...
                text_wordwrap=15,
                relief=None,
                pos=(-0.84999999999999998, 0.0, 0.56000000000000005))
            ...
            self.gotoToonButton = DirectButton(
                ...
                text_pos=(0.0, -0.02),
                textMayChange=0,
                pos=(0.42999999999999999, 0, 0.41499999999999998),
        ...
        self.bCancel = DirectButton(
            ...
            text_pos=(0.12, -0.01),
            pos=(-0.86499999999999999, 0.0, -0.76500000000000001),
            scale=2.0,
            command=self._PlayerDetailPanel__handleCancel)
        self.bCancel.show()
