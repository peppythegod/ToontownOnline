...
class AvatarPanelBase(AvatarPanel.AvatarPanel):
    ...
    def handleIgnore(self):
        ...
        if isFriend:
            self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.CancelOnly, text = TTLocalizer.IgnorePanelAddFriendAvatar % self.avName, text_wordwrap = 18.5, text_scale = 0.059999999999999998, cancelButtonText = TTLocalizer.lCancel, doneEvent = 'IgnoreBlocked', command = self.freeLocalAvatar)
        else:
        ...
        DirectLabel(parent = self.dialog, relief = None, pos = (0, TTLocalizer.APBdirectLabelPosY, 0.125), text = TTLocalizer.IgnorePanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
    ...
    def handleIgnoreConfirm(self, value):
        ...
        self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.Acknowledge, text = TTLocalizer.IgnorePanelIgnore % self.avName, text_wordwrap = 18.5, text_scale = 0.059999999999999998, topPad = 0.10000000000000001, doneEvent = 'IgnoreComplete', command = self.handleDoneIgnoring)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, TTLocalizer.APBdirectLabelPosY, 0.14999999999999999), text = TTLocalizer.IgnorePanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
        self._AvatarPanelBase__acceptStoppedStateMsg()
        self.requestStopped()
    ...
    def handleStopIgnoringConfirm(self, value):
        ...
        self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.Acknowledge, text = TTLocalizer.IgnorePanelEndIgnore % self.avName, text_wordwrap = 18.5, text_scale = 0.059999999999999998, topPad = 0.10000000000000001, doneEvent = 'StopIgnoringComplete', command = self.handleDoneIgnoring)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, TTLocalizer.APBdirectLabelPosY, 0.14999999999999999), text = TTLocalizer.IgnorePanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
        self._AvatarPanelBase__acceptStoppedStateMsg()
        self.requestStopped()
    ...
    def confirmReport(self):
        ...
        self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.TwoChoice, text = string % self.avName, text_wordwrap = 18.5, text_scale = 0.059999999999999998, okButtonText = TTLocalizer.AvatarPanelReport, cancelButtonText = TTLocalizer.lCancel, doneEvent = 'ReportConfirm', command = self.handleReportConfirm)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, 0, titlePos), text = TTLocalizer.ReportPanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
        self._AvatarPanelBase__acceptStoppedStateMsg()
        self.requestStopped()
    ...
    def chooseReportCategory(self):
        self.dialog = TTDialog.TTGlobalDialog(pos = (0, 0, 0.40000000000000002), style = TTDialog.CancelOnly, text = TTLocalizer.ReportPanelCategoryBody % (self.avName, self.avName), text_wordwrap = 18.5, text_scale = 0.059999999999999998, topPad = 0.050000000000000003, midPad = 0.75, cancelButtonText = TTLocalizer.lCancel, doneEvent = 'ReportCategory', command = self.handleReportCategory)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, 0, 0.22500000000000001), text = TTLocalizer.ReportPanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        guiButton = loader.loadModel('phase_3/models/gui/quit_button')
        DirectButton(parent = self.dialog, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (2.125, 1.0, 1.0), text = TTLocalizer.ReportPanelCategoryLanguage, text_scale = 0.059999999999999998, text_pos = (0, -0.0124), pos = (0, 0, -0.29999999999999999), command = self.handleReportCategory, extraArgs = [
            0])
        DirectButton(parent = self.dialog, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (2.1499999999999999, 1.0, 1.0), text = TTLocalizer.ReportPanelCategoryPii, text_scale = 0.059999999999999998, text_pos = (0, -0.012500000000000001), pos = (0, 0, -0.42499999999999999), command = self.handleReportCategory, extraArgs = [
            1])
        DirectButton(parent = self.dialog, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (2.125, 1.0, 1.0), text = TTLocalizer.ReportPanelCategoryRude, text_scale = 0.059999999999999998, text_pos = (0, -0.012500000000000001), pos = (0, 0, -0.55000000000000004), command = self.handleReportCategory, extraArgs = [
            2])
        DirectButton(parent = self.dialog, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (2.125, 1.0, 1.0), text = TTLocalizer.ReportPanelCategoryName, text_scale = 0.059999999999999998, text_pos = (0, -0.012500000000000001), pos = (0, 0, -0.67500000000000004), command = self.handleReportCategory, extraArgs = [
            3])
        DirectButton(parent = self.dialog, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (2.125, 1.0, 1.0), text = TTLocalizer.ReportPanelCategoryHacking, text_scale = 0.059999999999999998, text_pos = (0, -0.012500000000000001), pos = (0, 0, -0.80000000000000004), command = self.handleReportCategory, extraArgs = [
            4])
    ...
    def confirmReportCategory(self, category):
        ...
        self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.TwoChoice, text = string % self.avName, text_wordwrap = 18.5, text_scale = 0.059999999999999998, topPad = 0.10000000000000001, okButtonText = TTLocalizer.AvatarPanelReport, cancelButtonText = TTLocalizer.lCancel, doneEvent = 'ReportConfirmCategory', command = self.handleReportCategoryConfirm)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, 0, 0.5), text = TTLocalizer.ReportPanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
        self._AvatarPanelBase__acceptStoppedStateMsg()
    ...
    def reportComplete(self, removed, isPlayer):
        ...
        self.dialog = TTDialog.TTGlobalDialog(style = TTDialog.Acknowledge, text = string, text_wordwrap = 18.5, text_scale = 0.059999999999999998, topPad = 0.10000000000000001, doneEvent = 'ReportComplete', command = self.handleReportComplete)
        DirectLabel(parent = self.dialog, relief = None, pos = (0, 0, titlePos), text = TTLocalizer.ReportPanelTitle, textMayChange = 0, text_scale = 0.080000000000000002)
        self.dialog.show()
        self._AvatarPanelBase__acceptStoppedStateMsg()
