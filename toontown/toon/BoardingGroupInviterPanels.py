...
class BoardingGroupInviterPanels:
    ...
    def createInvitingPanel(self, boardingParty, inviteeId, **kw):
        ...
        self._BoardingGroupInviterPanels__invitingPanel = BoardingGroupInvitingPanel(boardingParty, inviteeId, **None)
    ...
    def createInvitationRejectedPanel(self, boardingParty, inviteeId, **kw):
        ...
        self._BoardingGroupInviterPanels__invitationRejectedPanel = BoardingGroupInvitationRejectedPanel(boardingParty, inviteeId, **None)
...
class BoardingGroupInviterPanelBase(ToonHeadDialog.ToonHeadDialog):
    ...
    def __init__(self, boardingParty, inviteeId, **kw):
        ...
        optiondefs = (('dialogName', self.dialogName, None), ('text', self.inviterText, None), ('style', self.panelStyle, None), ('buttonTextList', self.buttonTextList, None), ('command', command, None), ('image_color', (1.0, 0.89000000000000001, 0.77000000000000002, 1.0), None), ('geom_scale', 0.20000000000000001, None), ('geom_pos', (-0.10000000000000001, 0, -0.025000000000000001), None), ('pad', (0.074999999999999997, 0.074999999999999997), None), ('topPad', 0, None), ('midPad', 0, None), ('pos', (0.45000000000000001, 0, 0.75), None), ('scale', 0.75, None))
...
class BoardingGroupInvitingPanel(BoardingGroupInviterPanelBase):
    ...
    def __init__(self, boardingParty, inviteeId, **kw):
        BoardingGroupInviterPanelBase.__init__(self, boardingParty, inviteeId, **None)
    ...
    def defineParams(self):
        ...
        self.buttonTextList = [
            OTPLocalizer.GuildInviterCancel]
