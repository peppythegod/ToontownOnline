...
class ToonHeadFrame(DirectFrame):
    ...
    def __init__(self, av, color = ToontownGlobals.GlobalDialogColor, g = DGG.getDefaultDialogGeom()):
        ...
        self.extraData = DirectLabel(parent = self, relief = None, pos = (0.0, 0.0, 0.059999999999999998), scale = 1.0, text = '', text0_fg = (0.29999999999999999, 0.20000000000000001, 1, 1), text_scale = (0.14000000000000001, 0.059999999999999998), text_pos = (0, -0.01))
        self.extraData.hide()
