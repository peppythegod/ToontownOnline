...
class DistributedNPCScientist(DistributedNPCToonBase.DistributedNPCToonBase):
    def __init__(self, cr):
        ...
        ) or base.cr.newsManager and base.cr.newsManager.isHolidayRunning(
    ...
    def generateToon(self):
        ...
        self.torsoParts = []
        self.legsParts = []
        self._DistributedNPCScientist__bookActors = []
        self._DistributedNPCScientist__holeActors = []
        self.setupToonNodes()
        if self.style.getTorsoSize() == 'short' and self.style.getAnimal(
        ) == 'duck':
            ...
            for rHand in self.getRightHands():
                ...
                placeholder.setPos(0, 0, 0.10000000000000001)

        elif (self.style.getTorsoSize() == 'long'
              or self.style.getAnimal() == 'monkey'
    ...
    def scientistPlay(self):
        ...
        elif self.style.getTorsoSize() == 'long' and self.style.getAnimal(
        ) == 'monkey':
