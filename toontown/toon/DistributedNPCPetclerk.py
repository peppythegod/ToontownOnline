...
class DistributedNPCPetclerk(DistributedNPCToonBase):
        ...
        if mode == NPCToons.SELL_MOVIE_TIMEOUT:
            ...
            if self.av is None:
                ...
                self.accept(
                    ...
                    self._DistributedNPCPetclerk__handleUnexpectedExit)
    ...
    def popupPetshopGUI(self, task):
        ...
        self.acceptOnce(self.eventDict['guiDone'],
                        self._DistributedNPCPetclerk__handleGUIDone)
        self.acceptOnce(self.eventDict['petAdopted'],
                        self._DistributedNPCPetclerk__handlePetAdopted)
        self.acceptOnce(self.eventDict['petReturned'],
                        self._DistributedNPCPetclerk__handlePetReturned)
        self.acceptOnce(self.eventDict['fishSold'],
                        self._DistributedNPCPetclerk__handleFishSold)
