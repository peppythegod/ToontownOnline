...
class ToonTeleportPanel(DirectFrame):
    ...
    def __init__(self, avId, avName, avDisableName):
        DirectFrame.__init__(
            ...
            text_pos=(0.0, 0.17999999999999999))
        ...
        self.bOk = DirectButton(
            ...
            command=self._ToonTeleportPanel__handleOk)
        self.bOk.hide()
        self.bCancel = DirectButton(
            ...
            text_pos=(0.0, -0.10000000000000001),
            pos=(0.0, 0.0, -0.10000000000000001),
            command=self._ToonTeleportPanel__handleCancel)
        self.bCancel.hide()
        self.bYes = DirectButton(
            ...
            text_scale=0.050000000000000003,
            text_pos=(0.0, -0.10000000000000001),
            pos=(-0.14999999999999999, 0.0, -0.14999999999999999),
            command=self._ToonTeleportPanel__handleYes)
        self.bYes.hide()
        self.bNo = DirectButton(
            ...
            text_pos=(0.0, -0.10000000000000001),
            pos=(0.14999999999999999, 0.0, -0.14999999999999999),
            command=self._ToonTeleportPanel__handleNo)
        self.bNo.hide()
        buttons.removeNode()
        self.accept(self.avDisableName,
                    self._ToonTeleportPanel__handleDisableAvatar)
        self.show()
    ...
    def enterBegin(self):
        ...
        elif hasManager and base.cr.playerFriendsManager.getAvHandleFromId(
                self.avId):
    ...
    def enterCheckAvailability(self):
        ...
        self.accept('teleportResponse',
                    self._ToonTeleportPanel__teleportResponse)
        self.bCancel.show()
    ...
    def enterUnknownHood(self, hoodId):
        self[
            'text'] = TTLocalizer.TeleportPanelUnknownHood % base.cr.hoodMgr.getFullnameFromId(
                hoodId)
        self.bOk.show()
    ...
    def enterUnavailableHood(self, hoodId):
        self[
            'text'] = TTLocalizer.TeleportPanelUnavailableHood % base.cr.hoodMgr.getFullnameFromId(
                hoodId)
        self.bOk.show()
    ...
    def enterOtherShard(self, shardId, hoodId, zoneId):
        ...
        if pop and pop > localAvatar.shardPage.midPop:
            self.notify.warning(
                'Entering full shard: issuing performance warning')
    ...
    def _ToonTeleportPanel__teleportResponse(self, avId, available, shardId,
                                             hoodId, zoneId):
