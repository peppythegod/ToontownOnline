...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    NoncreditPressableImageColor = Vec4(
        0.29999999999999999, 0.59999999999999998, 0.59999999999999998, 1)
    PropBonusNoncreditPressableImageColor = Vec4(
        0.59999999999999998, 0.59999999999999998, 0.29999999999999999, 1)
    DeletePressableImageColor = Vec4(0.69999999999999996, 0.10000000000000001,
    ...
    UnpressableImageColor = Vec4(0.29999999999999999, 0.29999999999999999,
    ...
    BookUnpressableImage2Color = Vec4(0.10000000000000001, 0.69999999999999996,
                                      1, 1)
    ...
    def updateTotalPropsText(self):
        textTotal = TTLocalizer.InventoryTotalGags % (self.totalProps,
    ...
    def load(self):
        ...
        self.deleteEnterButton = DirectButton(
            ...
            text=('', TTLocalizer.InventoryDelete,
        ...
        self.deleteHelpText = DirectLabel(
            parent=self.invFrame,
            relief=None,
            pos=(0.27200000000000002, 0.29999999999999999,
                 -0.90700000000000003),
        ...
        self.detailFrame = DirectFrame(
            parent=self.invFrame,
            relief=None,
            pos=(1.05, 0, -0.080000000000000002))
        ...
        self.detailAmountLabel = DirectLabel(
            ...
            pos=(0.16, 0, -0.17499999999999999),
            text_font=getInterfaceFont(),
        ...
        self.detailDataLabel = DirectLabel(
            ...
            text_fg=(0.050000000000000003, 0.14000000000000001,
                     0.40000000000000002, 1),
            scale=0.040000000000000001,
            pos=(-0.22, 0, -0.23999999999999999),
            text_font=getInterfaceFont(),
        ...
        self.detailCreditLabel = DirectLabel(
            ...
            text_fg=(0.050000000000000003, 0.14000000000000001,
                     0.40000000000000002, 1),
            scale=0.040000000000000001,
            pos=(-0.22, 0, -0.36499999999999999),
            text_font=getInterfaceFont(),
            text_align=TextNode.ALeft,
            relief=None)
        ...
        for track in range(0, len(Tracks)):
            trackFrame = DirectFrame(
                parent=self.invFrame,
                image=self.rowModel,
                scale=(1.0, 1.0, 1.1000000000000001),
                pos=(0, 0.29999999999999999,
                     self.TrackYOffset + track * self.TrackYSpacing),
                image_color=(TrackColors[track][0], TrackColors[track][1],
                             TrackColors[track][2], 1),
                state=DGG.NORMAL,
                relief=None)
            trackFrame.bind(
                DGG.WITHIN, self.enterTrackFrame, extraArgs=[track])
            trackFrame.bind(
                DGG.WITHOUT, self.exitTrackFrame, extraArgs=[track])
            ...
            self.trackNameLabels.append(
                DirectLabel(
                    ...
                    pos=(-0.71999999999999997 + adjustLeft,
                         -0.10000000000000001, 0.01),
                    scale=TTLocalizer.INtrackNameLabels,
                    relief=None,
                    text_fg=(0.20000000000000001, 0.20000000000000001,
            ...
            self.trackBars.append(
                DirectWaitBar(
                    parent=self.trackRows[track],
                    pos=(-0.57999999999999996 + adjustLeft,
                    ...
                    scale=0.25,
                    frameColor=(TrackColors[track][0] * 0.59999999999999998,
                                TrackColors[track][1] * 0.59999999999999998,
                                TrackColors[track][2] * 0.59999999999999998,
                                1),
                    barColor=(TrackColors[track][0] * 0.90000000000000002,
                              TrackColors[track][1] * 0.90000000000000002,
                              TrackColors[track][2] * 0.90000000000000002, 1),
                    text='0 / 0',
                    text_scale=0.16,
                    text_fg=(0, 0, 0, 0.80000000000000004),
            ...
            for item in range(0, len(Levels[track])):
                button = DirectButton(
                    ...
                    text_align=TextNode.ARight,
                    geom_scale=0.69999999999999996,
                    geom_pos=(-0.01, -0.10000000000000001, 0),
                    text_fg=Vec4(1, 1, 1, 1),
                    text_pos=(0.070000000000000007, -0.040000000000000001),
                    textMayChange=1,
                    relief=None,
                    image_color=(0, 0.59999999999999998, 1, 1),
                    pos=(self.ButtonXOffset + item * self.ButtonXSpacing +
                         adjustLeft, -0.10000000000000001, 0),
                    command=self._InventoryNew__handleSelection,
                    extraArgs=[track, item])
                button.bind(
                    DGG.ENTER, self.showDetail, extraArgs=[track, item])
    ...
    def setDetailCredit(self, track, credit):
        ...
        if credit != None:
            self.detailCreditLabel[
                'text'] = TTLocalizer.InventorySkillCredit % credit
            if self.detailCredit == None:
                self.detailCreditLabel['text_fg'] = (0.050000000000000003,
                                                     0.14000000000000001,
                                                     0.40000000000000002, 1)
    ...
    def setActivateModeBroke(self):
        if self.activateMode == 'storePurchase':
            ...
            self.notify.error('Unexpected mode in setActivateModeBroke(): %s' %
                              self.activateMode)
        self.enableUberGags()
    ...
    def showTrack(self, trackIndex):
        ...
        if curExp >= UnpaidMaxSkills[trackIndex] and self.toon.getGameAccess(
            ...
            self.trackBars[trackIndex][
                'text'] = TTLocalizer.InventoryUberTrackExp % {
                    'nextExp': MaxSkill - curExp
                }
        else:
            self.trackBars[trackIndex]['range'] = nextExp
            self.trackBars[trackIndex][
                'text'] = TTLocalizer.InventoryTrackExp % {
                    'curExp': curExp,
                    'nextExp': nextExp
                }
    ...
    def buttonBoing(self, track, level):
        ...
        s = Sequence(
            button.scaleInterval(
                0.10000000000000001, oldScale * 1.333, blendType='easeOut'),
            button.scaleInterval(
                0.10000000000000001, oldScale, blendType='easeIn'),
    ...
    def updateGUI(self, track=None, level=None):
        ...
        if track == None and level == None:
            for track in range(len(Tracks)):
                ...
                if curExp >= UnpaidMaxSkills[track] and self.toon.getGameAccess(
                ) != OTPGlobals.AccessFull:
                    self.trackBars[track]['range'] = nextExp
                    self.trackBars[track][
                        'text'] = TTLocalizer.InventoryGuestExp
                elif curExp >= regMaxSkill:
                    self.trackBars[track][
                        'text'] = TTLocalizer.InventoryUberTrackExp % {
                            'nextExp': MaxSkill - curExp
    ...
    def loadBattleFrame(self):
        ...
        self.runButton = DirectButton(
            ...
            relief=None,
            pos=(0.72999999999999998, 0, -0.39800000000000002),
            ...
            image_scale=1.05,
            image_color=(0, 0.59999999999999998, 1, 1),
            command=self._InventoryNew__handleRun)
        self.sosButton = DirectButton(
            parent=self.battleFrame,
            relief=None,
            pos=(0.95999999999999996, 0, -0.39800000000000002),
            ...
            image_scale=1.05,
            image_color=(0, 0.59999999999999998, 1, 1),
            command=self._InventoryNew__handleSOS)
        self.passButton = DirectButton(
            parent=self.battleFrame,
            relief=None,
            pos=(0.95999999999999996, 0, -0.24199999999999999),
            ...
            image_scale=1.05,
            image_color=(0, 0.59999999999999998, 1, 1),
            command=self._InventoryNew__handlePass)
        self.fireButton = DirectButton(
            parent=self.battleFrame,
            relief=None,
            pos=(0.72999999999999998, 0, -0.24199999999999999),
            ...
            image_scale=1.05,
            image_color=(0, 0.59999999999999998, 1, 1),
            command=self._InventoryNew__handleFire)
        self.tutText = DirectFrame(
            parent=self.battleFrame,
            relief=None,
            pos=(0.050000000000000003, 0, -0.1133),
            scale=0.14299999999999999,
            image=DGG.getDefaultDialogGeom(),
            image_scale=5.125,
            image_pos=(0, 0, -0.65000000000000002),
    ...
    def loadPurchaseFrame(self):
        ...
        self.purchaseFrame = DirectFrame(
            ...
            image_pos=(-0.20999999999999999, 0, 0.080000000000000002),
            parent=self)
    ...
    def loadStorePurchaseFrame(self):
        ...
        self.storePurchaseFrame = DirectFrame(
            ...
            image_pos=(-0.20999999999999999, 0, 0.17999999999999999),
            parent=self)
        self.storePurchaseFrame.hide()
    ...
    def addToPropBonusIval(self, button):
        ...
        goDark = LerpColorScaleInterval(
            flashObject,
            0.5,
            Point4(0.10000000000000001, 0.10000000000000001,
