...
QuestsDefaultReject = (
    ...
    Cog +
    ' buildings are dangerous places! Do not go in alone!',
    'When you lose a battle, the ' +
    Cogs +
    ' take all your gags.',
    ...
    'If you win a battle, you get ToonTask credit for every ' +
    Cog +
    ' defeated.',
    'If you recapture a ' +
    Cog +
...
QuestsItemDict = {
    ...
    5012: [
        ...
        'a '],
    5013: [
        lSellbotHQ + ' Blueprints',
        lSellbotHQ + ' HQ Blueprints',
        'some '],
    5014: [
        lSellbotHQ + ' Memo',
        lSellbotHQ + ' Memos',
...
QuestDialogDict = {
    ...
    1062: {
        QUEST: "Great - thanks for the ink!\x7You know what, maybe if you cleared away some of those Bloodsuckers...\x7I wouldn't run out of ink again so quickly.\x7Defeat 6 Bloodsuckers in " + lToontownCentral + ' for your reward.',
        LEAVING: '',
        COMPLETE: 'Thanks!  Let me reward you for your help.',
    ...
    1081: {
        QUEST: '_toNpcName_ appears to be in a sticky situation. He sure could use a hand._where_'},
    1082: {
    ...
    401: {
        GREETING: '',
        QUEST: 'Now you get to choose the next gag track you want to learn.\x7Take your time deciding, and come back here when you are ready to choose.',
    ...
    2204: {
        QUEST: "Welcome aboard, matey.\x7Argh! Those rapscallion Cogs smashed my monocle and I can't sort me change without it.\x7Be a good landlubber and take this prescription to _toNpcName_ and fetch me a new one._where_",
        GREETING: '',
        LEAVING: ''},
    2205: {
    ...
    2921: {
        QUEST: "Hmmm, I suppose I could give up a weight.\x7I'd feel a lot better about it if there weren't so many Bossbot Cogs creeping around.\x7Defeat six and then come see me.",
    ...
    3247: {
        QUEST: "We've been getting complaints from the residents lately about all of the Bloodsuckers.\x7See if you can defeat 20 Bloodsuckers to help out your fellow Toons in " + lDaisyGardens + '.'},
    3210: {
    ...
    4210: {
        GREETING: '',
        QUEST: "Thank you. That's a big help.\x7Let's see...Fiddles: 2\x7All done! Off you go!_where_",
    ...
    5284: {
        ...
        INCOMPLETE_PROGRESS: "I can't perform barefoot, can I?"},
    5255: {
        QUEST: 'You look like you could use more Laff points.\x7Maybe _toNpcName_ could sort you out._where_'},
    5256: {
        GREETING: '',
        LEAVING: '',
    ...
    5301: {
        QUEST: "I can't help you with Laff points, but maybe _toNpcName_ will cut you a deal.\x7He's a little on tempermental side though..._where_"},
    5302: {
        GREETING: '',
        LEAVING: '',
        COMPLETE: "I told you what?!?!\x7Thanks a bunch! Here's your Laff point!",
        INCOMPLETE_PROGRESS: 'Hi!\x7What are you doing in here again!',
        QUEST: 'A Laff point? I dont think so!\x7Sure, but only if you clear out some of these pesky Lawbots first.'},
    5303: {
        QUEST: lTheBrrrgh + " is teeming with very dangerous Cogs.\x7If I were you, I'd carry more gags around here.\x7I hear _toNpcName_ can make you a large bag if you are willing to do the legwork._where_"},
    5304: {
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'There should be plenty of Lawbots out there.\x7So get to it!',
        QUEST: "A bigger bag?\x7I could probably whip one up for ya.\x7I'll need some yarn though.\x7Some Lawbots made off with mine yesterday morning."},
    5305: {
        GREETING: 'Howdy!',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Go get some more cogs.\x7This color hasn't taken yet.",
        QUEST: "That there's some fine yarn!\x7Not my first choice of color though.\x7Tell you what...\x7You go out there and beat up some of the tougher cogs...\x7And I'll get to work dyeing this yarn."},
    5306: {
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'They gotta be down there somewhere...',
        QUEST: "Well, the yarn is all dyed. But we've got a small problem.\x7I can't find my knitting needles anywhere.\x7Last place I saw them was down at the pond."},
    5307: {
        GREETING: '',
        LEAVING: 'Much obliged!',
        INCOMPLETE_PROGRESS: "Rome wasn't knit in a day!",
        QUEST: "Those are my needles alright.\x7While I'm knitting, why don't you go clear some of them big buildings?",
        COMPLETE: "Great work!\x7And speaking of great work...\x7Here's your new bag!"},
    5308: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'I hear _toNpcName_ is having some legal troubles.\x7Can you stop by and check it out?_where_'},
    5309: {
        GREETING: "I'm glad you're here...",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Please hurry! The street is crawling with them!',
        QUEST: "The Lawbots have really taken over out there.\x7I'm afraid they are going to take me to court.\x7Do you think you could help get them off of this street?"},
    5310: {
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'I think I hear them coming for me...',
        QUEST: "Thanks. I feel a little better now.\x7 But there is one more thing...\x7Could you drop by _toNpcName_'s and get me an alibi?_where_"},
    5311: {
        GREETING: 'WHAAAA!!!!',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I can't help him if you can't find it!",
        QUEST: "Alibi?! Why that's a great idea!\x7You'd better make it two!\x7I bet a Legal Eagle would have some..."},
    5312: {
        GREETING: 'Finally!',
        LEAVING: '',
        INCOMPLETE_PROGRESS: '',
        COMPLETE: "Whew! Am I ever relieved to have this.\x7Here's your reward...",
    ...
    6292: {
        QUEST: 'Oh those darn Cashbot Cogs! They stole my reading lamps!\x7I need them back right away. Can you go look for them?\x7If you can get my reading lamps, I might be able to help you get into see the C.F.O.\x7Hurry!',
    ...
    11000: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'If you are interested in Lawbot disguise parts you should visit _toNpcName_.\x7I hear he could use some help with his weather research._where_'},
    11001: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Yes, yes. I have Lawbot disguise parts.\x7But they are of no interest to me.\x7The focus of my research is fluctuations in the ambient temperature of Toontown.\x7I will gladly trade you disguise parts for cog temperature sensors.\x7You can start on %s.' % GlobalStreetNames[2100][-1],
        INCOMPLETE_PROGRESS: 'Have you tried looking on %s?' % GlobalStreetNames[2100][-1],
        COMPLETE: 'Ah, excellent!\x7Just as I feared...\x7Oh, yes! Here is your disguise part.'},
    11002: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'For more Lawbot disguise parts you should visit _toNpcName_ again.\x7I hear he needs more research assistants._where_'},
    11003: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'More Lawbot disguise parts?\x7Well, if you insist...\x7but I will require another cog temperature sensor.\x7This time look on %s.' % GlobalStreetNames[2200][-1],
        INCOMPLETE_PROGRESS: 'You are looking on %s, right?' % GlobalStreetNames[2200][-1],
        COMPLETE: 'Thank you!\x7And here is your disguise part.'},
    11004: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'If you need more Lawbot disguise parts you should return to _toNpcName_.\x7I hear he still needs help with his weather reasearch._where_'},
    11005: {
        GREETING: '',
        LEAVING: '',
        QUEST: "You're proving yourself quite useful!\x7Can you take a look on %s?" % GlobalStreetNames[2300][-1],
        INCOMPLETE_PROGRESS: "Are you sure you're looking on %s?" % GlobalStreetNames[2300][-1],
        COMPLETE: "Hmmm, I don't like the looks of this...\x7but here is your disguise part..."},
    11006: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'You-know-who needs more temperature readings.\x7Stop by if you would like another disguise part._where_'},
    11007: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Back again?\x7You are very dedicated...\x7The next stop is %s.' % GlobalStreetNames[1100][-1],
        INCOMPLETE_PROGRESS: 'Have you tried looking on %s?' % GlobalStreetNames[1100][-1],
        COMPLETE: 'Good! You seem to be getting the hang of this!\x7Your disguise part...'},
    11008: {
        GREETING: '',
        LEAVING: '',
    ...
    11009: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Fancy seeing you here!\x7Now I need readings on %s.' % GlobalStreetNames[1200][-1],
        INCOMPLETE_PROGRESS: 'You are looking on %s, right?' % GlobalStreetNames[1200][-1],
        COMPLETE: 'Thank you very much.\x7Your disguise must be getting close...'},
    11010: {
        GREETING: '',
        LEAVING: '',
    ...
    11011: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Good to see you again, _avName_!\x7Can you get a reading on %s, please?' % GlobalStreetNames[1300][-1],
        INCOMPLETE_PROGRESS: 'Have you tried looking on %s?' % GlobalStreetNames[1300][-1],
        COMPLETE: "Great work!\x7Here's your well earned reward!"},
    11012: {
        GREETING: '',
        LEAVING: '',
    ...
    11013: {
        GREETING: '',
        LEAVING: '',
        QUEST: '_avName_, my dear friend!\x7Can you go to %s and find another temperature sensor?' % GlobalStreetNames[5100][-1],
        INCOMPLETE_PROGRESS: "Are you sure you're looking on %s?" % GlobalStreetNames[5100][-1],
        COMPLETE: "Excellent!\x7With your help my research is coming quickly!\x7Here's your reward."},
    11014: {
        GREETING: '',
        LEAVING: '',
        QUEST: "_toNpcName_ was asking for you by name.\x7It appears you've made quite an impression!_where_"},
    11015: {
        GREETING: '',
        LEAVING: '',
        QUEST: "Welcome back!\x7I've been waiting for you.\x7The next reading I need is on %s." % GlobalStreetNames[5200][-1],
        INCOMPLETE_PROGRESS: 'You are looking on %s, right?' % GlobalStreetNames[5200][-1],
        COMPLETE: "Thanks!\x7Here's your reward."},
    11016: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'If you need to finish your Lawbot disguise...\x7_toNpcName_ can help you out._where_'},
    11017: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Hello, Junior Research Scientist!\x7We still need readings from %s.' % GlobalStreetNames[5300][-1],
        INCOMPLETE_PROGRESS: 'Have you tried looking on %s?' % GlobalStreetNames[5300][-1],
        COMPLETE: 'Excellent job!\x7Here is your Lawbot thingy...'},
    11018: {
        GREETING: '',
        LEAVING: '',
        QUEST: "_toNpcName_ has another job for you.\x7If you're not sick of him yet..._where_"},
    11019: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Well, then.\x7Are you ready for another recovery?\x7This time try %s.' % GlobalStreetNames[4100][-1],
        INCOMPLETE_PROGRESS: "Are you sure you're looking on %s?" % GlobalStreetNames[4100][-1],
        COMPLETE: 'Another one!\x7My you are the picture of efficiency!'},
    11020: {
        GREETING: '',
        LEAVING: '',
    ...
    11021: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'You could probably guess by now...\x7but I need readings from %s.' % GlobalStreetNames[4200][-1],
        INCOMPLETE_PROGRESS: 'You are looking on %s, right?' % GlobalStreetNames[4200][-1],
        COMPLETE: 'Almost there!\x7Here you go...'},
    11022: {
        GREETING: '',
        LEAVING: '',
    ...
    11025: {
        ...
        COMPLETE: 'Good work!\x7I think we are getting very close...'},
    11026: {
        GREETING: '',
        LEAVING: '',
    ...
    11027: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Back so soon?\x7The final reading is on %s.' % GlobalStreetNames[9200][-1],
        INCOMPLETE_PROGRESS: 'You are looking on %s, right?' % GlobalStreetNames[9200][-1],
        COMPLETE: "You're all done!\x7Now you are ready to infiltrate the District Attorney's Office and collect Jury Notices.\x7Good luck and thanks for all your help!"},
    12000: {
        GREETING: '',
        LEAVING: '',
    ...
    12001: {
        GREETING: '',
        LEAVING: '',
        QUEST: "Yes, I can get you Bossbot parts.\x7But I'll need you to help me complete my Bossbot collection.\x7Go out there and defeat a Flunky.",
        INCOMPLETE_PROGRESS: "You can't find a Flunky? For shame...",
        COMPLETE: "You didn't flunk that, now did you?\x7Here's your first disguise part."},
    12002: {
        GREETING: '',
        LEAVING: '',
    ...
    12003: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'Another disguise part?\x7Certainly...\x7but only if you defeat a Pencil Pusher.',
    ...
    12007: {
        ...
        COMPLETE: "You managed that quite well!\x7Here's your fourth disguise part."},
    12008: {
        GREETING: '',
        LEAVING: '',
    ...
    12009: {
        ...
        COMPLETE: "He went down hard!\x7Here's your fifth disguise part."},
    12010: {
        GREETING: '',
        LEAVING: '',
    ...
    12011: {
        ...
        COMPLETE: "I see you had no problem hunting one down.\x7Here's your sixth disguise part."},
    12012: {
        GREETING: '',
        LEAVING: '',
    ...
    12013: {
        ...
        INCOMPLETE_PROGRESS: 'You might have better luck looking buildings.',
        COMPLETE: "You're quite the little raider yourself!\x7Here's your seventh disguise part."},
    12014: {
        GREETING: '',
        LEAVING: '',
    ...
    12015: {
        ...
        COMPLETE: "I knew I could count on you to cut...\x7Ah, never mind.\x7Here's your next disguise part."},
    12016: {
        GREETING: '',
        LEAVING: '',
    ...
    12017: {
        ...
        INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
        COMPLETE: 'They are tougher than they look, huh?\x7I guess I owe you a disguise part.'},
    12018: {
        GREETING: '',
        LEAVING: '',
    ...
    12019: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'These Version 2.0 Cogs are very interesting.\x7Please go defeat another one.',
        INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
    ...
    12023: {
        ...
        INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
        COMPLETE: 'Hmmm, I guess they are Bossbots after all.\x7Help yourself to another part.'},
    12024: {
        GREETING: '',
        LEAVING: '',
    ...
    12029: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'I am still quite baffled by these new cogs.\x7Could you go defeat another, please?',
        INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
        COMPLETE: 'Fascinating. Simply fascinating.\x7A disguise part for your troubles.'},
    12030: {
        GREETING: '',
        LEAVING: '',
    ...
    12031: {
        GREETING: '',
        LEAVING: '',
        QUEST: "I've almost determined what these new Cogs are.\x7Just one more...",
        INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
        COMPLETE: "Yes, I think I'm onto something.\x7Oh, yes.\x7This is for you..."},
    12032: {
        GREETING: '',
        LEAVING: '',
        QUEST: 'You need to go tell Flippy about this...',
        INCOMPLETE_PROGRESS: 'Flippy can be found in Toon Hall',
        COMPLETE: 'A new type of Cog!\x7Good work!\x7Here is your final disguise part.'}}
ChatGarblerDog = [
    'woof',
    'arf',
    'rruff']
...
MovieHealLaughterMisses = (
    'hmm',
    'heh',
    'ha',
    'harr harr')
MovieHealLaughterHits1 = (
    'Ha Ha Ha',
    'Hee Hee',
    'Tee Hee',
    'Ha Ha')
...
for accessoryId in CatalogAccessoryItemGlobals.AccessoryTypes.keys():
    ...
    if accessoryInfo[3]:
        AwardManagerAccessoryNames[accessoryId] = AccessoryNamePrefix[accessoryInfo[0]
...
TipDict = {
    ...
    TIP_COGHQ: (
        ...
        'You must defeat the ' +
        Foreman +
        ' to recover a Sellbot Cog Disguise part.',
...
def getRecipeBeanText(beanTuple):
    ...
    if allTheSame:
        if len(beanTuple) > 1:
            retval = '%d %s jellybeans' % (
                len(beanTuple), BeanColorWords[beanTuple[0]])
        else:
