...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.map = DirectFrame(
            ...
            image_scale=(1.8, 1, 1.3500000000000001),
            scale=0.96999999999999997,
            pos=(0, 0, 0.077499999999999999))
        mapModel.removeNode()
        self.allZones = []
        for hood in ToontownGlobals.Hoods:
            if hood not in [
                    ToontownGlobals.GolfZone, ToontownGlobals.FunnyFarm
            ]:
                self.allZones.append(hood)

        self.cloudScaleList = (((0.55000000000000004, 0, 0.40000000000000002),
                                (0.34999999999999998, 0,
                                 0.25)), (), ((0.45000000000000001, 0,
                                               0.45000000000000001),
                                              (0.5, 0, 0.40000000000000002)),
                               ((0.69999999999999996, 0,
                                 0.45000000000000001), ),
                               ((0.55000000000000004, 0,
                                 0.40000000000000002), ),
                               ((0.59999999999999998, 0, 0.40000000000000002),
                                (0.53320000000000001, 0, 0.32000000000000001)),
                               ((0.69999999999999996, 0, 0.45000000000000001),
                                (0.69999999999999996, 0, 0.45000000000000001)),
                               ((0.79979999999999996, 0,
                                 0.39000000000000001), ),
                               ((0.5, 0, 0.40000000000000002), ),
                               ((-0.45000000000000001, 0,
                                 0.40000000000000002), ),
                               ((-0.45000000000000001, 0,
                                 0.34999999999999998), ),
                               ((0.5, 0, 0.34999999999999998), ),
                               ((0.5, 0, 0.34999999999999998), ))
        self.cloudPosList = (((0.57499999999999996, 0.0,
                               -0.040000000000000001),
                              (0.45000000000000001, 0.0,
                               -0.25)), (), ((0.375, 0.0, 0.40000000000000002),
                                             (0.5625, 0.0,
                                              0.20000000000000001)),
                             ((-0.02, 0.0, 0.23000000000000001), ),
                             ((-0.29999999999999999, 0.0,
                               -0.40000000000000002), ),
                             ((0.25, 0.0, -0.42499999999999999),
                              (0.125, 0.0, -0.35999999999999999)),
                             ((-0.5625, 0.0, -0.070000000000000007),
                              (-0.45000000000000001, 0.0,
                               0.21249999999999999)), ((-0.125, 0.0, 0.5), ),
                             ((0.66000000000000003, 0.0,
                               -0.40000000000000002), ),
                             ((-0.68000000000000005, 0.0,
                               -0.44400000000000001), ),
                             ((-0.59999999999999998, 0.0,
                               0.45000000000000001), ), ((0.66000000000000003,
                                                          0.0, 0.5), ),
                             ((0.40000000000000002, 0.0,
                               -0.34999999999999998), ))
        self.labelPosList = ((0.59399999999999997, 0.0,
                              -0.074999999999999997), (0.0, 0.0,
                                                       -0.10000000000000001),
                             (0.47499999999999998, 0.0,
                              0.25), (0.10000000000000001, 0.0,
                                      0.14999999999999999),
                             (-0.29999999999999999, 0.0,
                              -0.375), (0.20000000000000001, 0.0,
                                        -0.45000000000000001),
                             (-0.55000000000000004, 0.0,
                              0.0), (-0.087999999999999995, 0.0,
                                     0.46999999999999997),
                             (0.69999999999999996, 0.0,
                              -0.5), (-0.69999999999999996, 0.0,
                                      -0.5), (-0.69999999999999996, 0.0, 0.5),
                             (0.69999999999999996, 0.0,
                              0.5), (0.45000000000000001, 0.0,
                                     -0.45000000000000001))
        self.labels = []
        self.clouds = []
        ...
        self.safeZoneButton = DirectButton(
            ...
            image_scale=(1.3, 1.1000000000000001, 1.1000000000000001),
            pos=buttonLoc,
        ...
        self.goHomeButton = DirectButton(
            ...
            image=(guiButton.find('**/QuitBtn_UP'),
                   guiButton.find('**/QuitBtn_DN'),
                   guiButton.find('**/QuitBtn_RLVR')),
            image_scale=(0.66000000000000003, 1.1000000000000001,
                         1.1000000000000001),
            pos=(0.14999999999999999, 0, -0.73999999999999999),
        ...
        self.hoodLabel = DirectLabel(
            parent=self.map,
            relief=None,
            pos=(-0.42999999999999999, 0, -0.72599999999999998),
            text='',
        ...
        for hood in self.allZones:
            ...
            label = DirectButton(
                ...
                pad=(0.20000000000000001, 0.16),
                text=('', fullname, fullname),
                text_bg=Vec4(1, 1, 1, 0.40000000000000002),
                text_scale=0.055,
                text_wordwrap=8,
                rolloverSound=None,
                clickSound=None,
            ...
            label.bind(
                DGG.WITHIN,
                self._MapPage__hoverCallback,
                extraArgs=[1, hoodIndex])
            label.bind(
                DGG.WITHOUT,
                self._MapPage__hoverCallback,
                extraArgs=[0, hoodIndex])
    ...
    def enter(self):
        ...
        ) == ToontownGlobals.MyEstate or base.cr.playGame.hood.loader.atMyEstate(
