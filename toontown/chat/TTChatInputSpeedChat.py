...
scStructure = [
    ...
    [
        ...
        [OTPLocalizer.SCMenuFriendlyILike, 700, 701, 702, 703, 704,
         705], 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 515, 511,
        512, 513, 514
    ],
    [
        OTPLocalizer.SCMenuSorry, 801, 800, 802, 803, 804, 811, 814, 815, 817,
        812, 813, 818, 805, 806, 807, 816, 808, {
            809: 5
        }, 810
    ],
    [
    ...
    [
        ...
        [
            OTPLocalizer.SCMenuPlacesPlayground, 1100, 1101, 1105, 1106, 1107,
            1108, 1109, 1110, 1111, 1117, 1125, 1126
        ],
        [
            OTPLocalizer.SCMenuPlacesCogs, 1102, 1103, 1104, 1114, 1115, 1116,
        ...
        [
            OTPLocalizer.SCMenuPlacesWait, 1015, 1007, 1008, 1010, 1011, 1014,
            1017
    ...
    [
        ...
        [
            OTPLocalizer.SCMenuToontasksYouShouldChoose, 1300, 1301, 1302,
            1303, 1304
        ],
        [
            OTPLocalizer.SCMenuToontasksINeedMore, 1206, 1210, 1211, 1212,
            1207, 1213, 1214, 1215
    ...
    [
        ...
        [
            OTPLocalizer.SCMenuBattleGags, 1500, 1501, 1502, 1503, 1504, 1505,
            1506, 1401, 1402, 1413
        ],
        [
            OTPLocalizer.SCMenuBattleTaunts, 1403, 1406, 1520, 1521, 1522,
            1523, 1524, 1525, 1526, 1407, 1408
        ],
        [
            OTPLocalizer.SCMenuBattleStrategy, 1414, 1550, 1551, 1552, 1415,
...
if hasattr(base, 'wantPets') and base.wantPets:
    scPetMenuStructure = [[
        ...
        [TTSCPetTrickMenu, OTPLocalizer.SCMenuPetTricks], 21000, 21001, 21002,
        21003, 21004, 21005, 21006
    ]]

cfoMenuStructure = [[
    OTPLocalizer.SCMenuCFOBattleCranes, 2100, 2101, 2102, 2103, 2104, 2105,
    ...
    def handleToontaskMsg(self, taskId, toNpcId, toonProgress, msgIndex):
        if self.whisperAvatarId is None:
            ...
            self.chatMgr.sendSCToontaskWhisperMessage(
                taskId, toNpcId, toonProgress, msgIndex, self.whisperAvatarId,
                self.toPlayer)
        self.toPlayer = 0
