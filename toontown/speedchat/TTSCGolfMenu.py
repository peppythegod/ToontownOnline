...
GolfMenuGuide = [(OTPLocalizer.GolfMenuSections[1],
...
class TTSCGolfMenu(SCMenu):
    def __init__(self):
        ...
        self.accept('golfMessagesChanged',
                    self._TTSCGolfMenu__golfMessagesChanged)
        self._TTSCGolfMenu__golfMessagesChanged()
        submenus = []
    ...
    def _TTSCGolfMenu__golfMessagesChanged(self):
        self.clearMenu()
