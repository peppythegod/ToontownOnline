...
SillyPhaseFiveMenu = [(OTPLocalizer.SillyHolidayMenuSections[1],
                       [30325, 30326, 30327]),
...
class TTSCSillyPhaseFiveMenu(SCMenu):
    def __init__(self):
        ...
        self._TTSCSillyPhaseFiveMenu__SillyPhaseFiveMessagesChanged()
        submenus = []
    ...
    def _TTSCSillyPhaseFiveMenu__SillyPhaseFiveMessagesChanged(self):
        self.clearMenu()
