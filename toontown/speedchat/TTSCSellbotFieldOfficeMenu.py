...
class TTSCSellbotFieldOfficeMenu(SCMenu):
    def __init__(self):
        ...
        self.accept('sellbotFieldOfficeChanged',
                    self._TTSCSellbotFieldOfficeMenu__messagesChanged)
    ...
    def _TTSCSellbotFieldOfficeMenu__messagesChanged(self,
                                                     inSellbotFieldOffice):
        self.clearMenu()
