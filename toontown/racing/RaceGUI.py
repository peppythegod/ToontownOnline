...
class RaceGUI:
    ...
    def __init__(self, distRace):
        ...
        if hasattr(self.gagCycleSound, 'setPlayRate'):
            self.gagCycleSound.setPlayRate(0.20000000000000001)
    ...
    def initRaceMode(self):
        ...
        self.mapScene.setPos(1.1000000000000001, 0, 0.75)
        ...
        self.mapLines.setScale(0.00025000000000000001 *
                               RaceGlobals.TrackDict[self.race.trackId][6])
        self.mapLines.setP(90)
        self.faceStartPos = Vec3(-0.80000000000000004, 0, 0.93000000000000005)
        self.faceEndPos = Vec3(0.80000000000000004, 0, 0.93000000000000005)
    ...
    def update(self, time):
        ...
        for key in self.racerDict.keys():
            ...
            faceX = self.faceStartPos[0] * \
                (1 - lapT) + self.faceEndPos[0] * lapT
    ...
    def racerEntered(self, avId):
        ...
        for (key, i) in zip(self.racerDict.keys(),
            ...
            face.setY(-1 - 5 * (i + 1))
            face.setScale(0.14999999999999999)
            mapspot.getChild(0).setY((-5 - 5 * (i + 1)) * 1000)
            mapspot.setScale(self.mapScene, 0.14999999999999999)
