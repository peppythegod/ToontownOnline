...
class DistributedLeaderBoard(DistributedObject.DistributedObject):
    ...
    def buildTrackRow(self):
        ...
        namePath = row.attachNewNode(nameText)
        namePath.setScale(0.55000000000000004)
        namePath.setDepthWrite(0)
        return (row, nameText)
    ...
    def buildLeaderRow(self):
        ...
        nameText.setText('-')
        namePath = row.attachNewNode(nameText)
        namePath.setPos(1.1000000000000001, 0, 0)
        namePath.setScale(0.23000000000000001)
        namePath.setDepthWrite(0)
        ...
        timePath.setScale(0.23000000000000001)
        ...
        placeText.setTextColor(1, 1, 0.10000000000000001, 1)
        placeText.setText('-')
        placePath = row.attachNewNode(placeText)
        placePath.setPos(-0.10000000000000001, 0, -0.050000000000000003)
        placePath.setScale(0.29999999999999999)
