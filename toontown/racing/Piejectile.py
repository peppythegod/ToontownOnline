...
class Piejectile(DirectObject, FlyingGag):
    ...
    def __init__(self, sourceId, targetId, type, name):
        ...
        self._Piejectile__setupCollisions()
        self.setupPhysics()
        self._Piejectile__enableCollisions()
    ...
    def _Piejectile__updatePhysics(self, task):
        if self.deleting:
            return Task.done
    ...
    def _Piejectile__setupCollisions(self):
    ...
    def _Piejectile__undoCollisions(self):
        base.cTrav.removeCollider(self.cRayNodePath)

    def _Piejectile__enableCollisions(self):
        self.cQueue = []
