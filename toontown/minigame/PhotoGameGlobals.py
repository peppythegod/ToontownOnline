...
AREA_DATA[ToontownGlobals.DonaldsDock]['ANIMATIONS'] = ([
    ('wave', 2.0),
    (None, 1.0)], [
    ('slip-forward', 2.0),
    (None, 1.0),
    ...
    (None, 1.0)], [
    (None, 1.0)])
AREA_DATA[ToontownGlobals.DonaldsDock]['MOVEMODES'] = ([
    ('walk', 1.0)], [
    ('run', 0.40000000000000002)], [
    ('walk', 1.0),
    ('sad-walk', 2.5)], [
...
AREA_DATA[ToontownGlobals.DaisyGardens]['ANIMATIONS'] = ([
    ('wave', 2.0),
    (None, 1.0)], [
    ('jump', 2.0),
    (None, 1.0),
...
AREA_DATA[ToontownGlobals.MinniesMelodyland]['ANIMATIONS'] = ([
    ('wave', 2.0),
    (None, 1.0)], [
    ('jump', 2.0),
    ('slip-forward', 2.0),
...
AREA_DATA[ToontownGlobals.TheBrrrgh]['ANIMATIONS'] = ([
    ('wave', 2.0),
    (None, 1.0)], [
    ('applause', 2.0),
    ('slip-forward', 2.0),
...
AREA_DATA[ToontownGlobals.TheBrrrgh]['MOVEMODES'] = ([
    ('walk', 1.0),
    ('running-jump', 0.40000000000000002)], [
    ('run', 0.40000000000000002)], [
    ('walk', 1.0),
    ('sad-walk', 2.5)])
