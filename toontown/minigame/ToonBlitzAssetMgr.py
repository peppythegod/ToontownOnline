...
class ToonBlitzAssetMgr(DirectObject):
    ...
    def __init__(self, game):
        self._ToonBlitzAssetMgr__defineConstants()
        self.game = game
        self.load()

    def _ToonBlitzAssetMgr__defineConstants(self):
        pass
    ...
    def load(self):
        ...
        self.faceStartPos = Vec3(-0.80000000000000004, 0, -0.87)
        self.faceEndPos = Vec3(0.80000000000000004, 0, -0.87)
    ...
    def onstage(self):
        ...
        base.playMusic(self.gameMusic, looping=1, volume=0.90000000000000002)
