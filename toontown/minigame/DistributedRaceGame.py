...
class DistributedRaceGame(DistributedMinigame):
    def __init__(self, cr):
        ...
        self.posHprArray = (
            ((-9.0299999999999994, 0.059999999999999998, 0.025000000000000001,
              -152.90000000000001), (-7.4299999999999997, -2.7599999999999998,
                                     0.025000000000000001,
                                     -152.68000000000001),
             (-6.0199999999999996, -5.4800000000000004, 0.025000000000000001,
              -157.53999999999999), (-5.0099999999999998, -8.3200000000000003,
                                     0.025000000000000001, -160.66),
             (-4.0499999999999998, -11.359999999999999, 0.025000000000000001,
              -170.22), (-3.4900000000000002, -14.18, 0.025000000000000001,
                         -175.75999999999999),
             (-3.1200000000000001, -17.149999999999999, 0.025000000000000001,
              -177.72999999999999), (-3.0, -20.32, 0.025000000000000001,
                                     178.49000000000001),
             (-3.0899999999999999, -23.440000000000001, 0.025000000000000001,
              176.59), (-3.4300000000000002, -26.539999999999999,
                        0.025000000000000001,
                        171.44), (-4.0700000000000003, -29.440000000000001,
                                  0.025000000000000001, 163.75),
             (-5.0899999999999999, -32.270000000000003, 0.025000000000000001,
              158.19999999999999), (-6.1100000000000003, -35.159999999999997,
                                    0.025000000000000001, 154.97999999999999),
             (-7.5700000000000003, -37.780000000000001, 0.025000000000000001,
              154.97999999999999), (-9.2799999999999994, -40.649999999999999,
                                    0.025000000000000001, 150.41)),
            ((-6.1200000000000001, 1.6200000000000001, 0.025000000000000001,
              -152.90000000000001),
             (-4.3799999999999999, -1.3500000000000001, 0.025000000000000001,
              -150.91999999999999), (-3.0800000000000001, -4.2999999999999998,
                                     0.025000000000000001,
                                     -157.90000000000001),
             (-1.8500000000000001, -7.2599999999999998, 0.025000000000000001,
              -162.53999999999999), (-0.93000000000000005, -10.49,
                                     0.025000000000000001,
                                     -167.71000000000001),
             (-0.20999999999999999, -13.710000000000001, 0.025000000000000001,
              -171.78999999999999), (0.20999999999999999, -17.079999999999998,
                                     0.025000000000000001,
                                     -174.91999999999999),
             (0.31, -20.199999999999999, 0.025000000000000001,
              177.09999999999999), (0.17000000000000001, -23.66,
                                    0.025000000000000001, 174.81999999999999),
             (-0.23000000000000001, -26.91, 0.025000000000000001,
              170.50999999999999), (-0.98999999999999999, -30.199999999999999,
                                    0.025000000000000001, 162.53999999999999),
             (-2.02, -33.280000000000001, 0.025000000000000001,
              160.47999999999999), (-3.2799999999999998, -36.380000000000003,
                                    0.025000000000000001, 157.96000000000001),
             (-4.6699999999999999, -39.170000000000002, 0.025000000000000001,
              154.13), (-6.3099999999999996, -42.149999999999999,
                        0.025000000000000001, 154.13)),
            ((-2.9900000000000002, 3.0899999999999999, 0.025000000000000001,
              -154.37), (-1.3799999999999999, -0.050000000000000003,
                         0.025000000000000001, -154.75),
             (-0.19, -3.29, 0.025000000000000001,
              -159.22), (1.1699999999999999, -6.5099999999999998,
                         0.025000000000000001, -162.74000000000001),
             (2.2799999999999998, -9.8000000000000007, 0.025000000000000001,
              -168.72999999999999), (3.0899999999999999, -13.279999999999999,
                                     0.025000000000000001,
                                     -173.49000000000001),
             (3.46, -16.629999999999999, 0.025000000000000001,
              -176.81), (3.6899999999999999, -20.379999999999999,
                         0.025000000000000001, 179.13999999999999),
             (3.6099999999999999, -24.120000000000001, 0.025000000000000001,
              175.78), (3.0, -27.550000000000001, 0.025000000000000001,
                        170.87), (2.1499999999999999, -30.719999999999999,
                                  0.025000000000000001, 167.41),
             (1.04, -34.259999999999998, 0.025000000000000001,
              162.11000000000001), (-0.14999999999999999, -37.439999999999998,
                                    0.025000000000000001, 158.59),
             (-1.6399999999999999, -40.520000000000003, 0.025000000000000001,
              153.88999999999999), (-3.4199999999999999, -43.630000000000003,
                                    0.025000000000000001, 153.88999999999999)),
            ((0.0, 4.3499999999999996, 0.025000000000000001,
              -154.37), (1.52, 1.3, 0.025000000000000001, -155.66999999999999),
             (3.1699999999999999, -2.0699999999999998, 0.025000000000000001,
              -155.66999999999999), (4.4699999999999998, -5.4100000000000001,
                                     0.025000000000000001, -163.0),
             (5.5599999999999996, -9.1899999999999995, 0.025000000000000001,
              -168.88999999999999),
             (6.2199999999999998, -12.66, 0.025000000000000001,
              -171.66999999999999), (6.6699999999999999, -16.559999999999999,
                                     0.025000000000000001, -176.53),
             (6.9299999999999997, -20.329999999999998, 0.025000000000000001,
              179.87), (6.8099999999999996, -24.32, 0.025000000000000001,
                        175.19), (6.2199999999999998, -27.969999999999999,
                                  0.025000000000000001,
                                  170.81), (5.5899999999999999, -31.73,
                                            0.025000000000000001,
                                            167.53999999999999),
             (4.4800000000000004, -35.420000000000002, 0.025000000000000001,
              161.91999999999999), (3.0600000000000001, -38.82,
                                    0.025000000000000001, 158.56),
             (1.3999999999999999, -42.0, 0.025000000000000001,
              154.31999999999999), (-0.70999999999999996, -45.170000000000002,
                                    0.025000000000000001, 153.27000000000001)))
        self.avatarPositions = {}
        self.modelCount = 8
        self.cameraTopView = (-22.780000000000001, -41.649999999999999,
                              31.530000000000001, -51.549999999999997, -42.68,
                              -2.96)
        self.timer = None
    ...
    def load(self):
        ...
        for i in range(1, 5):
            ...
            diceButton = DirectButton(
                ...
                relief=None,
                pos=(-0.90000000000000002 + (i - 1) * 0.20000000000000001, 0.0,
                     -0.84999999999999998),
                scale=0.25,
    ...
    def showMatches(self, task):
        ...
        for i in range(len(task.choiceList)):
            ...
            if choice != 0:
                ...
                if freq == 1:
                    diceInstance.setColor(0.20000000000000001, 1,
                                          0.20000000000000001, 1)
                    if avId == self.localAvId:
                        base.playSfx(self.posBuzzer)

                else:
                    diceInstance.setColor(1, 0.20000000000000001,
                                          0.20000000000000001, 1)
                    if avId == self.localAvId:
    ...
    def showChanceRewards(self):
        ...
        for reward in self.rewardList:
            ...
            if reward != -1:
                ...
                task = Task.sequence(hcc, sct, Task.pause(1.0), stt,
                                     Task.pause(3.0), rct, Task.pause(0.25))
                tasks.append(task)
                continue
    ...
    def moveCamera(self):
        ...
        camera_lookat_idx = min(RaceGameGlobals.NumberToWin - 6,
                                localToonPosition)
        ...
        camera.lerpPosHpr(CamPos[0], CamPos[1], CamPos[2], CamHpr[0],
                          CamHpr[1], CamHpr[2], 0.75)
                ...
                if not chance and task.choiceList.count(choice) != 1:
                    ...
                    if avatar:
                        ...
                        if squares_walked > 4:
                            ...
                            avatar.setPlayRate(-1.0, 'walk')
                        self.walkInPlace(avatar, i, position,
                                         self.getWalkDuration(squares_walked))
    ...
    def positionInPlace(self, avatar, lane, place):
        ...
        avatar.setPosHpr(self.raceBoard, posH[0], posH[1], posH[2], posH[3], 0,
                         0)
    ...
    def setAvatarChose(self, avId):
        ...
        self.notify.debug('setAvatarChose: avatar: ' + str(avId) +
                          ' choose a number')
    ...
    def setChancePositions(self, positions):
        ...
        for pos in positions:
            ...
            marker.setPosHpr(self.raceBoard, posHpr[0], posHpr[1], posHpr[2],
                             posHpr[3] + 180, 0, 0.025000000000000001)
