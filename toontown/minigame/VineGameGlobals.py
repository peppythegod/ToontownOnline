...
VineStartingT = 0.25
VineFellDownT = 0.10000000000000001
EndlessGame = False
BonusPerSecondLeft = 0.40000000000000002
JumpTimeBuffer = 0.5
...
CourseSections = (((20, 30, 4, 0), (19, 39, 3.1000000000000001, 0),
                   (18, 41, 4, 0), (19, 38, 3.2000000000000002, 0), (20, 30, 6,
                                                                     0)),
                  ((20, 30, 3, 0), (18, 40, 4.0999999999999996,
                                    0), (19, 31, 5.0999999999999996,
                                         0), (18, 41, 4.2000000000000002, 0),
                   (20, 30, 5,
                    0)), ((20, 30, 3, 0), (15, 39, 4.0999999999999996, 0),
                          (19, 29, 5, 0), (16, 38, 4.2000000000000002,
                                           0), (20, 30, 5, 0)),
                  ((20, 30, 3, 0), (18, 36, 4.0999999999999996, 0),
                   (19, 30, 5, 9), (18, 38, 4.2000000000000002, 0),
                   (20, 30, 5,
                    0)), ((20, 30, 3, 0), (18, 15, 4.0999999999999996, 0),
                          (19, 30, 5, 11), (18, 16, 4.2000000000000002,
                                            0), (20, 30, 5, 0)),
                  ((20, 30, 3, 0), (18, 11, 4.0999999999999996, 0),
                   (15, 12, 5, 0), (18, 16, 4.2000000000000002, 0),
                   (20, 30, 5,
                    0)), ((20, 30, 3, 0), (15, 39, 4.0999999999999996, 13),
                          (19, 29, 5, 0), (16, 38, 4.2000000000000002,
                                           0), (20, 30, 5, 0)),
                  ((20, 30, 3, 0), (18, 26, 4.0999999999999996, 9),
                   (19, 30, 5, 0), (18, 28, 4.2000000000000002, 12),
                   (20, 30, 5,
                    0)), ((20, 30, 3, 0), (15, 26, 4.0999999999999996, 9),
                          (19, 30, 5, 0), (15, 28, 4.2000000000000002, 12),
                          (20, 30, 5, 0)), ((15, 50, 4,
                                             0), (15, 40, 4.0999999999999996,
                                                  0), (19, 40, 5, 0),
                                            (19, 28, 4.2000000000000002,
                                             0), (20, 30, 5, 0)))
CourseWeights = {
    ...
    ToontownGlobals.DonaldsDreamland: ((4, 20), (5, 20), (6, 20), (7, 20),
                                       (8, 20))
}
BaseBonusOnEndVine = {
...
BatInfo = {
    ToontownGlobals.ToontownCentral: ((60, 0, 0.34999999999999998), ),
