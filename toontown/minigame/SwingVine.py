...
class SwingVine(NodePath.NodePath):
    ...
    def setupCable(self):
        ...
        for linkNum in xrange(self.numLinks):
            anchor = self._SwingVine__makeLink(anchor, linkNum)
        ...
        if self.cableTex:
            ...
            self.rope.setTexScale(ts, 1.0, 0.14999999999999999)
    ...
    def setupStaticPart(self, vineTexture):
        cm = CardMaker('card')
        cm.setFrame(-0.5, 0.5, -0.10000000000000001, 8)
    ...
    def _SwingVine__makeLink(self, anchor, linkNum):
    ...
    def changeAttachedToonFacing(self, toonId, facing):
        if toonId in self.attachedToons:
            ...
            self.notify.warning(
                'changeAttachedToonFacing avId %d was not in the dict' %
                toonId)
    ...
    def calcTFromTubeHit(self, colEntry):
        ...
        if parts[0] == 'StaticVine':
            ...
            u = (P3.getX() - P1.getX()) * (P2.getX() - P1.getX()) + \
                (P3.getZ() - P1.getZ()) * (P2.getZ() - P1.getZ())
    ...
    def setupSwingAnimFull(self, av, avId):
        ...
        if (self.swingingForward or facingRight
            ...
            if framesToChopOff < numFirstHalfFrames:
                ...
                swing1Dur = (
                    1 - framesToChopOff / numFirstHalfFrames) * halfDur
