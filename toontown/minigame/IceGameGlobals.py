...
ExpandFeetPerSec = 5
ScoreCountUpRate = 0.14999999999999999
...
Obstacles = {
    ...
    ToontownGlobals.MinniesMelodyland: ((0, MinWall[1] / 2), (0,
                                                              MaxWall[1] / 2)),
    ToontownGlobals.TheBrrrgh: ((MinWall[0] / 2, 0), (MaxWall[0] / 2, 0),
                                (0, MinWall[1] / 2), (0, MaxWall[1] / 2)),
    ToontownGlobals.DonaldsDreamland:
    ((MinWall[0] / 2, MinWall[1] / 2), (MinWall[0] / 2, MaxWall[1] / 2),
     (MaxWall[0] / 2, MinWall[1] / 2), (MaxWall[0] / 2, MaxWall[1] / 2))
}
ObstacleShapes = {
