...
class DivingFishSpawn(DirectObject):
    ...
    def createFish(self, fishcode):
        ...
        if fish.name == 'clown':
            ...
            fish.setScale(2)
            cSphere = CollisionSphere(0.0, 0.0, 0.0, 0.20000000000000001)
        elif fish.name == 'bear':
            fish.setH(90 * self.direction)
            cSphere = CollisionSphere(0.0, -1.0, 3.5, 3.0)
            fish.loop('anim')
            fish.setScale(0.40000000000000002, 1.7, 1.7)
            ...
            fish.loop('anim')
            fish.setScale(1.3999999999999999)
        ...
        self.accept('into-' + 'fc' + str(fish.code),
