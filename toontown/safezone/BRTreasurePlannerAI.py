...
class BRTreasurePlannerAI(RegenTreasurePlannerAI.RegenTreasurePlannerAI):
    def __init__(self, zoneId):
        ...
        RegenTreasurePlannerAI.RegenTreasurePlannerAI.__init__(
            self, zoneId, DistributedBRTreasureAI.DistributedBRTreasureAI,
            'BRTreasurePlanner', 20, 2)

    def initSpawnPoints(self):
        self.spawnPoints = [(-108, 46, 6.2000000000000002),
                            (-111, 74, 6.2000000000000002),
                            (-126, 81, 6.2000000000000002), (-74, -75, 3.0),
                            (-136, -51, 3.0), (-20, 35, 6.2000000000000002),
