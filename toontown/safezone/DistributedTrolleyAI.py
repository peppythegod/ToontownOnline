...
class DistributedTrolleyAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def trolleyLeft(self):
        ...
        if numPlayers > 0:
            ...
            trolleyHoliday = simbase.air.holidayManager and simbase.air.holidayManager.isHolidayRunning(TROLLEY_HOLIDAY) or\
                simbase.air.holidayManager and simbase.air.holidayManager.isHolidayRunning(SILLY_SATURDAY_TROLLEY)
            trolleyWeekend = simbase.air.holidayManager and simbase.air.holidayManager.isHolidayRunning(TROLLEY_WEEKEND)
