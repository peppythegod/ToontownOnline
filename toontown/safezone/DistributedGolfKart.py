...
class DistributedGolfKart(DistributedObject.DistributedObject):
    ...
    SeatOffsets = ((0.5, -0.5, 0), (-0.5, -0.5, 0), (0.5, 0.5, 0), (-0.5, 0.5,
                                                                    0))
    ...
    def announceGenerate(self):
        ...
        wheelAngle = (
            dist / 4.7999999999999998 * 1.3999999999999999 * math.pi) * 360
    ...
    def _DistributedGolfKart__enableCollisions(self):
        ...
        self.accept('entergolfkart_sphere_%d' % self.getDoId(),
                    self.handleEnterGolfKartSphere)
        self.accept('enterGolfKartOK_%d' % self.getDoId(),
