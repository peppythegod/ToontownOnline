...
class GameMenu(DirectFrame):
    ...
    def __init__(self, picnicFunction, menuType):
        ...
        self.chineseText = OnscreenText(
            text='Chinese Checkers', pos=(
                0, 0.56000000000000005, -0.80000000000000004), scale=0.14999999999999999, fg=Vec4(
                1, 1, 1, 1), align=TextNode.ACenter, font=ToontownGlobals.getMinnieFont(), wordwrap=7, shadow=(
                0, 0, 0, 0.80000000000000004), shadowOffset=(
                    -0.10000000000000001, -0.10000000000000001), mayChange=True)
        self.chineseText.setR(-8)
        self.checkersText = OnscreenText(
            text='Checkers', pos=(
                0.81000000000000005, -0.10000000000000001, -0.80000000000000004), scale=0.14999999999999999, fg=Vec4(
                1, 1, 1, 1), align=TextNode.ACenter, font=ToontownGlobals.getMinnieFont(), wordwrap=7, shadow=(
                0, 0, 0, 0.80000000000000004), shadowOffset=(
                    0.10000000000000001, -0.10000000000000001), mayChange=True)
        self.findFourText = OnscreenText(
            text='Find Four', pos=(
                -0.81000000000000005, -0.080000000000000002, -0.80000000000000004), scale=0.14999999999999999, fg=Vec4(
                1, 1, 1, 1), align=TextNode.ACenter, font=ToontownGlobals.getMinnieFont(), wordwrap=8, shadow=(
                0, 0, 0, 0.80000000000000004), shadowOffset=(
                    -0.10000000000000001, -0.10000000000000001), mayChange=True)
