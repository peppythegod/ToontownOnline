...
class ChineseTutorial(DirectFrame, FSM.FSM):
    def __init__(self, doneFunction, doneEvent=None, callback=None):
        ...
        DirectFrame.__init__(
            self,
            pos=(-0.69999999999999996, 0.0, 0.0),
        ...
        self.title = DirectLabel(
            ...
            relief=None,
            text='',
            text_pos=(0.0, 0.40000000000000002),
            text_fg=(1, 0, 0, 1),
            text_scale=0.13,
        ...
        self.iPage1.setPos(0.42999999999999999, -0.10000000000000001, 0.0)
        self.iPage1.setScale(13.949999999999999)
        ...
        self.iPage2.setPos(0.42999999999999999, -0.10000000000000001, 0.5)
        self.iPage2.setScale(13.949999999999999)
        self.iPage2.setTransparency(1)
        self.iPage2.hide()
        self.iPage3 = images.find('**/tutorialPage2*')
        self.iPage3.reparentTo(aspect2d)
        self.iPage3.setPos(0.42999999999999999, -0.10000000000000001, -0.5)
        self.iPage3.setScale(13.949999999999999)
        ...
        self.bNext = DirectButton(
            ...
            pos=(0.34999999999999998, -0.29999999999999999,
                 -0.33000000000000002),
        ...
        self.bQuit = DirectButton(
            ...
            text_scale=0.050000000000000003,
            text_pos=(0.0, -0.10000000000000001),
            pos=(0.0, -0.29999999999999999, -0.33000000000000002),
    ...
    def enterPage1(self, *args):
        ...
        self['text_pos'] = (0.0, 0.23000000000000001)
        ...
        self.blinker.append(
            LerpColorInterval(
                obj, 0.5, Vec4(0.5, 0.5, 0, 0.0),
                Vec4(0.20000000000000001, 0.20000000000000001,
                     0.20000000000000001, 1)))
        self.blinker.append(
            LerpColorInterval(
                obj, 0.5,
                Vec4(0.20000000000000001, 0.20000000000000001,
                     0.20000000000000001, 1), Vec4(0.5, 0.5, 0, 0.0)))
        self.blinker.loop()
    ...
    def enterPage2(self, *args):
        ...
        self['text_pos'] = (0.0, 0.28000000000000003)
...
class CheckersTutorial(DirectFrame, FSM.FSM):
    def __init__(self, doneFunction, doneEvent=None, callback=None):
        ...
        self.iPage1.reparentTo(aspect2d)
        self.iPage1.setPos(0.42999999999999999, -0.10000000000000001, 0.0)
        self.iPage1.setScale(0.40000000000000002)
        self.iPage1.setTransparency(1)
        self.iPage1.hide()
        self.iPage2 = images.find('**/tutorialPage2*')
        self.iPage2.reparentTo(aspect2d)
        self.iPage2.setPos(0.42999999999999999, -0.10000000000000001, 0.0)
        self.iPage2.setScale(0.40000000000000002)
        self.iPage2.setTransparency(1)
        self.iPage2.hide()
        self.iPage3 = images.find('**/tutorialPage3*')
        self.iPage3.reparentTo(aspect2d)
        self.iPage3.setPos(0.59999999999999998, -0.10000000000000001, 0.5)
        self.iPage3.setScale(0.40000000000000002)
        self.iPage3.setTransparency(1)
        self.obj = self.iPage3.find('**/king*')
        self.iPage3.hide()
        self.iPage4 = images.find('**/tutorialPage4*')
        self.iPage4.reparentTo(aspect2d)
        self.iPage4.setPos(0.59999999999999998, -0.10000000000000001, -0.5)
        self.iPage4.setScale(0.40000000000000002)
    ...
    def enterPage1(self, *args):
        ...
        self['text_pos'] = (0.0, 0.23000000000000001)
        self['text_wordwrap'] = 13.5
        self['text_scale'] = 0.059999999999999998
        self.bPrev['state'] = DGG.DISABLED
        self.bPrev.hide()
        self.bNext['state'] = DGG.NORMAL
        self.iPage1.show()
    ...
    def enterPage3(self, *args):
        ...
        self['text_pos'] = (0.0, 0.32000000000000001)
        self['text_wordwrap'] = 19
        self['text_scale'] = 0.050000000000000003
        self.bNext['state'] = DGG.DISABLED
        self.blinker = Sequence()
        self.blinker.append(
            LerpColorInterval(
                self.obj, 0.5, Vec4(0.5, 0.5, 0, 0.0),
