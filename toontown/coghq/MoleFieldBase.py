...
class MoleFieldBase:
    WHACKED = 1
    MoveUpTimeMax = 1
    MoveUpTimeMultiplier = 0.94999999999999996
    MoveUpTimeMin = 0.5
    StayUpTimeMax = 7
    StayUpTimeMultiplier = 0.94999999999999996
    StayUpTimeMin = 3
    MoveDownTimeMax = 1
    MoveDownTimeMultiplier = 0.94999999999999996
    MoveDownTimeMin = 0.5
    TimeBetweenPopupMax = 1.5
    TimeBetweenPopupMultiplier = 0.94999999999999996
    ...
    def scheduleMoles(self):
        ...
        while self.endingTime < self.GameDuration:
            ...
            self.schedule.append((curTime, moleIndex, curMoveUpTime,
                                  curStayUpTime, curMoveDownTime, moleType))
        ...
        self.notify.debug('schedule length = %d, endingTime=%f' % (len(
            self.schedule), self.endingTime))
