...
class DistributedLawbotChairAI(DistributedObjectAI.DistributedObjectAI,
                               FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory(
        'DistributedLawbotChairAI')
    ...
    def __init__(self, air, boss, index):
        ...
        self.goonShield.setPosHpr(
            *ToontownGlobals.LawbotBossChairPosHprs[self.index])
        self.avId = 0
        self.objectId = 0
    ...
    def requestControl(self):
        ...
        if avId in self.boss.involvedToons and self.avId == 0:
            craneId = self._DistributedLawbotChairAI__getCraneId(avId)
            if craneId == 0:
    ...
    def _DistributedLawbotChairAI__getCraneId(self, avId):
    ...
    def enterStopCogs(self):
        self._DistributedLawbotChairAI__stopCogs()
