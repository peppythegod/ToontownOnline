...
class DistributedCashbotBossObject(
    ...
    def _DistributedCashbotBossObject__hitFloor(self, entry):
        if self.state == 'Dropped' or self.state == 'LocalDropped':
            self.d_hitFloor()
            self.demand('SlidingFloor', localAvatar.doId)

    def _DistributedCashbotBossObject__hitGoon(self, entry):
        if self.state == 'Dropped' or self.state == 'LocalDropped':
    ...
    def _DistributedCashbotBossObject__hitDropPlane(self, entry):
