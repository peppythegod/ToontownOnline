...
class DistributedCashbotBossObjectAI(
    ...
    def _DistributedCashbotBossObjectAI__getCraneAndObject(self, avId):
    ...
    def _DistributedCashbotBossObjectAI__setCraneObject(
            self, craneId, objectId):
        if self.air:
    ...
    def enterGrabbed(self, avId, craneId):
        ...
        self._DistributedCashbotBossObjectAI__setCraneObject(
            self.craneId, self.doId)
        self.d_setObjectState('G', avId, craneId)

    def exitGrabbed(self):
        self._DistributedCashbotBossObjectAI__setCraneObject(self.craneId, 0)
