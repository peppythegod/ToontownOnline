...
class DistributedGolfGreenGameAI(
    ...
    def _DistributedGolfGreenGameAI__handleTimeOut(self, task=None):
        taskMgr.remove(self.taskName('GolfGreenGameTimeout'))
        self._DistributedGolfGreenGameAI__handleFinsihed(0)
        return task.done
    ...
    def requestBoard(self, boardVerify):
        ...
        if boardIndex is None:
            self._DistributedGolfGreenGameAI__handleFinsihed(1)
        else:
    ...
    def _DistributedGolfGreenGameAI__detect(self, task):
    ...
    def _DistributedGolfGreenGameAI__run(self):
        pass
