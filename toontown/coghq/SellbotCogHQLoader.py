...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        self.fsm.addState(
            State.State('factoryInterior', self.enterFactoryInterior,
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            fdSign.setPosHprScale(62.740000000000002, -87.989999999999995,
                                  17.260000000000002, 2.7200000000000002, 0.0,
                                  0.0, elevatorSignSF, elevatorSignSF,
            ...
            sdSign.setPosHprScale(
                -164.78, 26.280000000000001, 17.25, -89.890000000000001, 0.0,
                0.0, elevatorSignSF, elevatorSignSF, elevatorSignSF * aspectSF)
