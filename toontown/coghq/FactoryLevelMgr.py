...
class FactoryLevelMgr(LevelMgr.LevelMgr):
    ...
    def __init__(self, level, entId):
        ...
        oilRoomFloor = self.geom.find(
            '**/oilroom/room/geometry_oilroom/*platform')
        if oilRoomOil and not oilRoomOil.isEmpty(
        ) and oilRoomFloor and not oilRoomFloor.isEmpty():
