...
class DistributedCountryClub(DistributedObject.DistributedObject):
    ...
    def generate(self):
        ...
        self._DistributedCountryClub__setupHighSky()
    ...
    def _DistributedCountryClub__setupHighSky(self):
        self.startSky()
        sky = self.sky
        sky.setH(150)
        sky.setZ(-100)

    def _DistributedCountryClub__cleanupHighSky(self):
        sky = self.sky
        sky.setH(0)
        sky.setZ(0)
        self.stopSky()
    ...
    def disable(self):
        ...
        self.titleSequence = None
        self._DistributedCountryClub__cleanupHighSky()
        self.ignoreAll()
