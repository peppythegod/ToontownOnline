...
class ToonHood(Hood.Hood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Hood', [
            ...
            State.State('suitInterior', self.enterSuitInterior, self.exitSuitInterior, [
                ...
                'townLoader',
                'safeZoneLoader']),
            State.State('cogdoInterior', self.enterCogdoInterior, self.exitCogdoInterior, [
                'quietZone',
                'townLoader',
                'safeZoneLoader']),
    ...
    def handleTownLoaderDone(self):
        ...
        teleportDebug(
            doneStatus, 'handleTownLoaderDone, doneStatus=%s' %
            (doneStatus,))
    ...
    def enterSuitInterior(self, requestStatus=None):
        ...
        self.place = SuitInterior.SuitInterior(
    ...
    def enterCogdoInterior(self, requestStatus=None):
        ...
        self.place = CogdoInterior.CogdoInterior(
            self, self.fsm, self.placeDoneEvent)
        self.place.load()
        self.place.enter(requestStatus)
        base.cr.playGame.setPlace(self.place)
