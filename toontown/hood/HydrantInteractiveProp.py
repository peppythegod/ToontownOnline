...
class HydrantInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {
        ...
        ToontownGlobals.TheBrrrgh: (
            ('tt_a_ara_tbr_hydrant_idleShiver1',
             1,
             1,
             None,
             3,
    ...
    def hasOverrideIval(self, origAnimName):
        result = False
        if ('fightBoost' in origAnimName or 'fightCheer' in origAnimName) and not (
                self.hoodId == ToontownGlobals.TheBrrrgh):
            result = True
