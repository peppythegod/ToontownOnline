...
class MailboxOneAnimatedProp(ZeroAnimatedProp.ZeroAnimatedProp):
    ...
    def __init__(self, node):
        ZeroAnimatedProp.ZeroAnimatedProp.__init__(
            self, node, 'mailbox', self.PhaseInfo,
