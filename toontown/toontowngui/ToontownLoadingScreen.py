...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.waitBar = DirectWaitBar(
            guiId='ToontownLoadingScreenWaitBar', parent=self.gui, frameSize=(
                -1.0600000000000001, 1.0600000000000001, -0.029999999999999999, 0.029999999999999999), pos=(
                0, 0, -0.84999999999999998), text='')
    ...
    def end(self):
        ...
        self.gui.reparentTo(hidden)
        return (
            self._ToontownLoadingScreen__expectedCount,
