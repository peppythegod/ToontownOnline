...
class ToontownLoadingScreen:
    def __init__(self):
        ...
        self.banner = loader.loadModel('phase_3/models/gui/toon_council').find(
            '**/scroll')
        self.banner.reparentTo(self.gui)
        self.banner.setScale(0.40000000000000002, 0.40000000000000002,
                             0.40000000000000002)
        self.tip = DirectLabel(
            ...
            textMayChange=1,
            pos=(-1.2, 0.0, 0.10000000000000001),
            text_fg=(0.40000000000000002, 0.29999999999999999,
        ...
        self.title = DirectLabel(
            ...
            parent=self.gui,
            relief=None,
            pos=(-1.0600000000000001, 0, -0.77000000000000002),
            text='',
            textMayChange=1,
        ...
        self.waitBar = DirectWaitBar(
            ...
            parent=self.gui,
            frameSize=(-1.0600000000000001, 1.0600000000000001,
                       -0.029999999999999999, 0.029999999999999999),
            pos=(0, 0, -0.84999999999999998),
            text='')
    ...
    def end(self):
        ...
        self.title.reparentTo(self.gui)
        self.gui.reparentTo(hidden)
        return (self._ToontownLoadingScreen__expectedCount,
                self._ToontownLoadingScreen__count)
