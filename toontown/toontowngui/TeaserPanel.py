...
class TeaserPanel(DirectObject):
    ...
    def _TeaserPanel__handleDone(self, choice=0):
        self.cleanup()
        self.unload()
        if choice == 1:
    ...
    def _TeaserPanel__handlePay(self):
        if base.cr.isWebPlayToken() or __dev__:
            ...
            self.notify.error(
                'You should not have a TeaserPanel without a PlayToken')
    ...
    def showPage(self, pageName):
        ...
        self.accept('stoppedAsleep', self._TeaserPanel__handleDone)
...
class FeatureBrowser(DirectScrolledList):
    ...
    def load(self):
        ...
        JoinUs.setPos(0, 0, -0.025000000000000001)
