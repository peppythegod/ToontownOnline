...
class GolfScoreBoard:
    ...
    def setup(self):
        ...
        self.playaTop = 0.12
        horzOffset = 0.12
        holeTop = 0.29999999999999999
        self.vCenter = 0.025000000000000001
        totScore = 0
        totPar = 0
        self.lineVStart = -0.46500000000000002
        self.lineHStart = 0.17000000000000001
        self.lineHorOffset = 0.13
        self.lineVertOffset = 0.125
        self.lineVCenter = 0.025000000000000001
        ...
        for avId in self.avIdList:
            ...
            if not playerExited:
                for holeIndex in range(self.golfCourse.numHoles):
                    ...
                    self.golfCourse.isGameDone() == False
