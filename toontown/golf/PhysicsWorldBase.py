...
class PhysicsWorldBase:
    ...
    def setupSimulation(self):
        ...
        self.world.setAutoDisableLinearThreshold(0.14999999999999999)
        self.world.setAutoDisableAngularThreshold(0.14999999999999999)
        ...
        self.world.setSurfaceEntry(
            ...
            pos2=1,
            mu=80,
            bounce=0.14999999999999999,
            bounce_vel=0.10000000000000001,
        ...
        if self.canRender:
            for count in range(self.jointMarkerCount):
                ...
                ballmodel.setScale(0.10000000000000001)
    ...
    def getCycleTime(self, doprint=0):
        cycleTime = (globalClock.getRealTime() +
    ...
    def startSim(self):
        taskMgr.add(self._PhysicsWorldBase__simulationTask, 'simulation task')

    def stopSim(self):
        taskMgr.remove('simulation task')

    def _PhysicsWorldBase__simulationTask(self, task):
    ...
    def useCommonObjectData(self, objectData, enable=1):
        ...
        for dataIndex in range(1, len(objectData)):
            ...
            commonObject[2].setQuaternion(
                Quat(data[5], data[6], data[7], data[8]))
    ...
    def createBox(self, world, space, density, lx, ly, lz, colOnlyBall=0):
        ...
        M = OdeMass()
        M.setSphere(density, 0.29999999999999999 * (lx + ly + lz))
        body.setMass(M)
