...
class CogdoMazeDrop(NodePath, DirectObject):
    def __init__(self, game, id, x, y):
        ...
        self.drop = drop
        self._dropSfx = base.cogdoGameAudioMgr.createSfxIval(
            'drop', volume=0.59999999999999998)
...
class CogdoMazeWaterCooler(NodePath, DirectObject):
    ...
    def __init__(self, serialNum, model):
        ...
        self._initArrow()
        self._update = None
        self._CogdoMazeWaterCooler__startUpdateTask()

    def destroy(self):
        self.ignoreAll()
        self._CogdoMazeWaterCooler__stopUpdateTask()
        self.collNodePath.removeNode()
        self.removeNode()
    ...
    def _CogdoMazeWaterCooler__startUpdateTask(self):
        self._CogdoMazeWaterCooler__stopUpdateTask()
        self._update = taskMgr.add(self._updateTask, self.UpdateTaskName, 45)

    def _CogdoMazeWaterCooler__stopUpdateTask(self):
