...
class CogdoMazeMapGui(MazeMapGui):
    ...
    def _initModel(self):
        ...
        self._entrance.setScale(0.34999999999999998)
        self._entrance.hide()
        self._exit = NodePath('exit')
        self._exit.setScale(0.34999999999999998)
        ...
        self._suitMarkerTemplate.setScale(0.22500000000000001)
        self._waterCoolerTemplate = cardModel.find(baseName + 'waterDrop')
        self._waterCoolerTemplate.detachNode()
        self._waterCoolerTemplate.setScale(0.22500000000000001)
        self._exit.hide()
    ...
    def placeExit(self, tX, tY):
        ...
        self._exit.setZ(self._exit, 0.29999999999999999)

    def placeEntrance(self, tX, tY):
        (x, y) = self.tile2gui(tX, tY)
        self._entrance.setPos(*self.gui2pos(x, y))
        self._entrance.setZ(self._entrance, -0.34999999999999998)
        self._entrance.show()
...
class CogdoMazeHud:
    ...
    def destroy(self):
        self._CogdoMazeHud__stopUpdateTask()
    ...
    def showQuestArrow(self, parent, nodeToPoint, offset=Point3(0, 0, 0)):
        ...
        self._CogdoMazeHud__startUpdateTask()
    ...
    def _CogdoMazeHud__startUpdateTask(self):
        self._CogdoMazeHud__stopUpdateTask()
        self._update = taskMgr.add(self._updateTask, 'CogdoMazeHud_Update', 45)

    def _CogdoMazeHud__stopUpdateTask(self):
