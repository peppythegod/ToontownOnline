...
class CogdoCraneGameSettings(Entity):
    ...
    attribs = (('GameDuration', 180.0, 'float'), ('EmptyFrictionCoef', 0.10000000000000001, 'float'), ('Gravity', -32, 'int'),
               ('RopeLinkMass', 1.0, 'float'), ('MagnetMass', 1.0, 'float'), ('MoneyBagGrabHeight', -8.1999999999999993, 'float'))
