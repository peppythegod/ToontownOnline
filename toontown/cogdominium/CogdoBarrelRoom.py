...
class CogdoBarrelRoom:
    ...
    def showBattleAreaLight(self, visible=True):
        ...
        if lightConeNode is not None and not lightConeNode.isEmpty():
            if visible:
                lightConeNode.show()
            else:
                lightConeNode.hide()
    ...
    def _CogdoBarrelRoom__rewardUiTimeout(self, callback):
        self.hideRewardUi()
    ...
    def showRewardUi(self, results, callback=None):
        (track, trackName) = self._CogdoBarrelRoom__rewardCamera()
        ...
        taskMgr.doMethodLater(
            ...
            self._CogdoBarrelRoom__rewardUiTimeout,
