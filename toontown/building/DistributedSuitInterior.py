...
class DistributedSuitInterior(DistributedObject.DistributedObject):
    ...
    def enterElevator(self, ts=0):
        ...
        self._DistributedSuitInterior__playElevator(
            ts, self.elevatorName, self._DistributedSuitInterior__handleElevatorDone)
    ...
    def _DistributedSuitInterior__playReservesJoining(
    ...
    def enterReservesJoining(self, ts=0):
        self._DistributedSuitInterior__playReservesJoining(ts, self.uniqueName(
            'reserves-joining'), self._DistributedSuitInterior__handleReserveJoinDone)
