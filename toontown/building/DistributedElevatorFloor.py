...
class DistributedElevatorFloor(DistributedElevatorFSM.DistributedElevatorFSM):
    ...
    def _DistributedElevatorFloor__placeElevator(self):
    ...
    def enterClosed(self, ts):
        ...
        self._DistributedElevatorFloor__doorsClosed(self.getZoneId())
    ...
    def _DistributedElevatorFloor__doorsClosed(self, zoneId):
        pass
