...
class SuitPlannerInteriorAI:
    ...
    def _SuitPlannerInteriorAI__genLevelList(
            self, bldgLevel, currFloor, numFloors):
        bldgInfo = SuitBuildingGlobals.SuitBuildingInfo[bldgLevel]
    ...
    def _SuitPlannerInteriorAI__setupSuitInfo(
    ...
    def _SuitPlannerInteriorAI__genSuitObject(
