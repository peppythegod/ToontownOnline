...
FurnitureTypes = {
    ...
    504: ('phase_5.5/models/estate/closetBoy', None, None, 500, FLCloset, 1.1499999999999999),
    ...
    514: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset, 1.1499999999999999),
    ...
    680: ('phase_5.5/models/estate/tt_m_ara_int_candlestick', None, {
        ...
        6: (('**/candlestick/candlestick', furnitureColors[0]),)}, 20, FLOnTable),
    681: ('phase_5.5/models/estate/tt_m_ara_int_candlestickLit', None, {
        ...
        6: (('**/candlestickLit/candlestick', furnitureColors[0]),)}, 25, FLOnTable),
    ...
    1450: ('phase_5.5/models/estate/tt_m_prp_int_painting_valentine', None, None, 425, FLPainting),
    ...
    1670: ('phase_5.5/models/estate/tt_m_prp_int_roseVase_valentine', None, None, 200, FLOnTable),
    1680: ('phase_5.5/models/estate/tt_m_prp_int_roseWatercan_valentine', None, None, 200, FLOnTable),
    ...
    4000: ('phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkBoy', None, None, 5, FLTrunk, 0.90000000000000002),
    4010: ('phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkGirl', None, None, 5, FLTrunk, 0.90000000000000002),
    ...
    10020: ('phase_5.5/models/estate/tt_m_prp_int_winter_tree', None, None, 500, None, None, 0.10000000000000001),
    10030: ('phase_5.5/models/estate/tt_m_prp_int_winter_wreath', None, None, 200, FLPainting)}
...
class CatalogFurnitureItem(CatalogAtticItem.CatalogAtticItem):
    ...
    def output(self, store=-1):
        return 'CatalogFurnitureItem(%s%s)' % (
            self.furnitureType, self.formatOptionalData(store))
