...
FLBillboard = 128
FLTrunk = 256
furnitureColors = [(0.79200000000000004, 0.35299999999999998,
                    0.28999999999999998, 1.0),
                   (0.17599999999999999, 0.59199999999999997, 0.439, 1.0),
                   (0.439, 0.42399999999999999, 0.68200000000000005, 1.0),
                   (0.32500000000000001, 0.57999999999999996,
                    0.83499999999999996, 1.0),
                   (0.753, 0.34499999999999997, 0.55700000000000005, 1.0),
                   (0.99199999999999999, 0.84299999999999997,
                    0.39200000000000002, 1.0)]
woodColors = [(0.93300000000000005, 0.77300000000000002, 0.56899999999999995,
               1.0), (0.93330000000000002, 0.67849999999999999, 0.055, 1.0),
              (0.54500000000000004, 0.45100000000000001, 0.33300000000000002,
               1.0), (0.54100000000000004, 0.0, 0.0, 1.0),
              (0.54510000000000003, 0.27060000000000001, 0.074499999999999997,
               1.0), (0.54510000000000003, 0.4118, 0.4118, 1.0)]
BankToMoney = {
    1300: 12000,
    1310: 12000,
    1320: 12000,
...
FurnitureTypes = {
    ...
    105: ('phase_5.5/models/estate/chairAdesat', None, {
        0: (('**/cushion*', furnitureColors[0]), ('**/arm*',
                                                  furnitureColors[0])),
        1: (('**/cushion*', furnitureColors[1]), ('**/arm*',
                                                  furnitureColors[1])),
        2: (('**/cushion*', furnitureColors[2]), ('**/arm*',
                                                  furnitureColors[2])),
        3: (('**/cushion*', furnitureColors[3]), ('**/arm*',
                                                  furnitureColors[3])),
        4: (('**/cushion*', furnitureColors[4]), ('**/arm*',
                                                  furnitureColors[4])),
        5: (('**/cushion*', furnitureColors[5]), ('**/arm*',
                                                  furnitureColors[5]))
    }, 160),
    ...
    205: ('phase_5.5/models/estate/regular_bed_desat', None, {
        0: (('**/bar*', woodColors[0]), ('**/post*', woodColors[0]),
            ('**/*support', woodColors[0]), ('**/top', woodColors[0]),
            ('**/bottom', woodColors[0]), ('**/pPlane*', woodColors[0])),
        1: (('**/bar*', woodColors[1]), ('**/post*', woodColors[1]),
            ('**/*support', woodColors[1]), ('**/top', woodColors[1]),
            ('**/bottom', woodColors[1]), ('**/pPlane*', woodColors[1])),
        2: (('**/bar*', woodColors[2]), ('**/post*', woodColors[2]),
            ('**/*support', woodColors[2]), ('**/top', woodColors[2]),
            ('**/bottom', woodColors[2]), ('**/pPlane*', woodColors[2])),
        3: (('**/bar*', woodColors[3]), ('**/post*', woodColors[3]),
            ('**/*support', woodColors[3]), ('**/top', woodColors[3]),
            ('**/bottom', woodColors[3]), ('**/pPlane*', woodColors[3])),
        4: (('**/bar*', woodColors[4]), ('**/post*', woodColors[4]),
            ('**/*support', woodColors[4]), ('**/top', woodColors[4]),
            ('**/bottom', woodColors[4]), ('**/pPlane*', woodColors[4])),
        5: (('**/bar*', woodColors[5]), ('**/post*', woodColors[5]),
            ('**/*support', woodColors[5]), ('**/top', woodColors[5]),
            ('**/bottom', woodColors[5]), ('**/pPlane*', woodColors[5]))
    }, 800),
    ...
    270: ('phase_5.5/models/estate/trolley_bed', None, None, 1200, None, None,
          0.25),
    ...
    460: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_coral', None, None,
          1250, None, None, 0.5),
    470: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_square', None, None,
          1100, None, None, 0.5),
    480: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_round', None, None,
          1100, None, None, 0.5),
    490: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_girlee', None, None,
          1100, None, None, 0.5),
    491: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_bugRoom', None, None,
          1100, None, None, 0.5),
    492: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_caramelApple', None,
          None, 1100, None, None, 0.5),
    ...
    504: ('phase_5.5/models/estate/closetBoy', None, None, 500, FLCloset,
          1.1499999999999999),
    ...
    510: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          0.84999999999999998),
    512: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          1.0),
    514: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          1.1499999999999999),
    516: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          1.3),
    518: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          1.3),
    ...
    650: ('phase_5.5/models/estate/UWlamp_jellyfish', None, None, 55,
          FLOnTable),
    660: ('phase_5.5/models/estate/UWlamps_jellyfishB', None, None, 55,
          FLOnTable),
    670: ('phase_5.5/models/estate/West_cowboyLamp', None, None, 55,
          FLOnTable),
    680: ('phase_5.5/models/estate/tt_m_ara_int_candlestick', None, {
    ...
    681: ('phase_5.5/models/estate/tt_m_ara_int_candlestickLit', None, {
        0: (('**/candlestick/candlestick', (1.0, 1.0, 1.0, 1.0)), ),
    ...
    800: ('phase_3.5/models/modules/desk_only_wo_phone', None, None, 65,
          FLIsTable),
    ...
    1130: ('phase_3.5/models/modules/bookcase_low', None, None, 650,
           FLIsTable),
    ...
    1210: ('phase_5.5/models/estate/table_radio', None, None, 60, FLIsTable,
           50.0),
    ...
    1220: ('phase_5.5/models/estate/coffeetableSq', None, None, 180,
           FLIsTable),
    1230: ('phase_5.5/models/estate/coffeetableSq_BW', None, None, 180,
           FLIsTable),
    ...
    1300: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1310: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1320: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1330: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1340: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1350: ('phase_5.5/models/estate/jellybeanBank', None, None, 0, FLBank,
           1.0),
    1399: ('phase_5.5/models/estate/prop_phone-mod', None, None, 0, FLPhone),
    1400: ('phase_5.5/models/estate/cezanne_toon', None, None, 425, FLPainting,
           2.0),
    1410: ('phase_5.5/models/estate/flowers', None, None, 425, FLPainting,
           2.0),
    1420: ('phase_5.5/models/estate/modernistMickey', None, None, 425,
           FLPainting, 2.0),
    1430: ('phase_5.5/models/estate/rembrandt_toon', None, None, 425,
           FLPainting, 2.0),
    1440: ('phase_5.5/models/estate/landscape', None, None, 425, FLPainting,
           100.0),
    1441: ('phase_5.5/models/estate/whistler-horse', None, None, 425,
           FLPainting, 2.0),
    1442: ('phase_5.5/models/estate/degasHorseStar', None, None, 425,
           FLPainting, 2.5),
    1443: ('phase_5.5/models/estate/MagPie', None, None, 425, FLPainting, 2.0),
    1450: ('phase_5.5/models/estate/tt_m_prp_int_painting_valentine', None,
           None, 425, FLPainting),
    ...
    1660: ('phase_5.5/models/estate/UWcoralVase', None, None, 120,
           FLOnTable | FLBillboard),
    1661: ('phase_5.5/models/estate/UWshellVase', None, None, 120,
           FLOnTable | FLBillboard),
    1670: ('phase_5.5/models/estate/tt_m_prp_int_roseVase_valentine', None,
           None, 200, FLOnTable),
    1680: ('phase_5.5/models/estate/tt_m_prp_int_roseWatercan_valentine', None,
           None, 200, FLOnTable),
    ...
    1900: ('phase_5.5/models/estate/UWswordFish', None, None, 425, FLPainting,
           0.5),
    1910: ('phase_5.5/models/estate/UWhammerhead', None, None, 425,
           FLPainting),
    1920: ('phase_5.5/models/estate/West_hangingHorns', None, None, 475,
           FLPainting),
    1930: ('phase_5.5/models/estate/West_Sombrero', None, None, 425,
           FLPainting),
    1940: ('phase_5.5/models/estate/West_fancySombrero', None, None, 450,
           FLPainting),
    1950: ('phase_5.5/models/estate/West_CoyotePawdecor', None, None, 475,
           FLPainting),
    1960: ('phase_5.5/models/estate/West_Horseshoe', None, None, 475,
           FLPainting),
    1970: ('phase_5.5/models/estate/West_bisonPortrait', None, None, 475,
           FLPainting),
    ...
    4000: ('phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkBoy', None,
           None, 5, FLTrunk, 0.90000000000000002),
    4010: ('phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkGirl', None,
           None, 5, FLTrunk, 0.90000000000000002),
    ...
    10020: ('phase_5.5/models/estate/tt_m_prp_int_winter_tree', None, None,
            500, None, None, 0.10000000000000001),
    10030: ('phase_5.5/models/estate/tt_m_prp_int_winter_wreath', None, None,
            200, FLPainting)
}
...
class CatalogFurnitureItem(CatalogAtticItem.CatalogAtticItem):
    ...
    def output(self, store=-1):
        return 'CatalogFurnitureItem(%s%s)' % (self.furnitureType,
