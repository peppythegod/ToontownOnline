...
class FireworksGui(DirectFrame):
    ...
    def __init__(self, doneEvent, shootEvent):
        DirectFrame.__init__(
            self, relief=None, geom=DGG.getDefaultDialogGeom(), geom_color=(
                0, 0.5, 1, 1), geom_scale=(
                0.42999999999999999, 1, 1.3999999999999999), pos=(
    ...
    def load(self):
        ...
        self.cancelButton = DirectButton(
            parent=self, relief=None, image=cancelImageList, pos=(
                0.14999999999999999, 0, -0.62), text_scale=0.059999999999999998, text_pos=(
                0, -0.10000000000000001), command=self._FireworksGui__cancel)
        buttons.removeNode()
