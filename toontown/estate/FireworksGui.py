...
class FireworksGui(DirectFrame):
    ...
    def __init__(self, doneEvent, shootEvent):
        DirectFrame.__init__(
            ...
            geom_scale=(0.42999999999999999, 1, 1.3999999999999999),
            pos=(1.1000000000000001, 0, 0))
    ...
    def load(self):
        ...
        self.panelPicker = DirectScrolledList(
            ...
            incButton_pos=(0, 0, -1.0800000000000001),
            incButton_image3_color=Vec4(1, 1, 1, 0.29999999999999999),
            ...
            decButton_pos=(0, 0, 0.20000000000000001),
            decButton_image3_color=Vec4(1, 1, 1, 0.29999999999999999))
        ...
        self.cancelButton = DirectButton(
            ...
            pos=(0.14999999999999999, 0, -0.62),
            text_scale=0.059999999999999998,
            text_pos=(0, -0.10000000000000001),
            command=self._FireworksGui__cancel)
        buttons.removeNode()
        ...
        for i in Fireworks.colors.keys():
            ...
            buttonBg = DirectFrame(
                ...
                pos=(0.14999999999999999, 0,
                     0.5 - (paddedHeight + 0.025000000000000001) * i),
                relief=None)
            ...
            button = DirectButton(
                ...
                relief=None,
                command=self._FireworksGui__handleColor,
                extraArgs=[i])
    ...
    def _FireworksGui__handleColor(self, index):
        ...
        if index == self.curColor:
            ...
            self.fadeColor = 0
        self.colorButtons[index][1]['geom_color'] = Fireworks.colors[
            self.fadeColor]
        self.curColor = index
