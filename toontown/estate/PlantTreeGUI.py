...
class PlantTreeGUI(StateData.StateData):
    ...
    def __init__(self, doneEvent):
        ...
        self.accept('inventory-selection', self._PlantTreeGUI__handleInventory)
        self.accept('inventory-pass', self._PlantTreeGUI__handleCancel)
    ...
    def _PlantTreeGUI__handleInventory(self, track, level):
