...
class DistributedFurnitureItem(
    ...
    def generate(self):
        ...
        self._DistributedFurnitureItem__taskName = self.taskName(
            'sendRequestPosHpr')
    ...
    def startAdjustPosHpr(self):
        ...
        taskMgr.doMethodLater(
            self._DistributedFurnitureItem__broadcastFrequency,
            self._DistributedFurnitureItem__posHprBroadcast,
            self._DistributedFurnitureItem__taskName)
