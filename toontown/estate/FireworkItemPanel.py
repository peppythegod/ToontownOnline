...
class FireworkItemPanel(DirectFrame):
    ...
    def __init__(self, itemName, itemNum, *extraArgs):
        ...
        DirectFrame.__init__(
            self, image=DGG.getDefaultDialogGeom(), image_color=(
                0.75, 0.75, 0.75, 1), image_scale=(
                0.25, 0, 0.25), relief=None)
    ...
    def load(self):
        self.picture = DirectButton(
            ...
            image=(
                ...
                DGG.getDefaultDialogGeom()),
            relief=None,
            command=self._FireworkItemPanel__launchFirework,
            extraArgs=[
                self.type],
            image_color=(
                0.80000000000000004,
        ...
        self.quantityLabel = DirectLabel(
            parent=self.picture, relief=None, pos=(
                0, 0, 0.0), scale=0.45000000000000001, text=self.name, text_scale=0.59999999999999998, text_fg=(
                0, 0, 0, 1), text_pos=(
                0, -0.14000000000000001, 0), text_font=nameFont, text_wordwrap=panelWidth)
    ...
    def _FireworkItemPanel__dimSky(self):
        ...
        base.cr.playGame.hood.loader.sky.setColorScale(
