...
class Estate(Place.Place):
    ...
    def load(self):
        ...
        taskMgr.add(self._Estate__checkCameraUnderwater,
    ...
    def startAprilFoolsControls(self):
        if isinstance(base.localAvatar.controlManager.currentControls,
                      GravityWalker):
    ...
    def exitPetTutorial(self):
        ...
        if hasattr(self, 'fsm'):
            taskMgr.add(self._Estate__checkToonUnderwater,
    ...
    def _teleportToHouse(self, requestStatus):
        ...
        taskMgr.remove('estate-check-toon-underwater')
        if base.wantPets:
            if base.localAvatar.hasPet() and not (
                    base.localAvatar.bPetTutorialDone):
    ...
    def _Estate__submergeToon(self):
        ...
        base.localAvatar.d_playSplashEffect(pos[0], pos[1],
                                            -2.2999999999999998)
        self.toonSubmerged = 1
