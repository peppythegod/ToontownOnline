...
class BankGui(DirectFrame):
    ...
    def __init__(self, doneEvent, allowWithdraw=1):
        DirectFrame.__init__(
            ...
            geom_scale=(1.3300000000000001, 1, 1.1000000000000001),
            pos=(0, 0, 0))
        ...
        self.cancelButton = DirectButton(
            ...
            pos=(-0.20000000000000001, 0, -0.40000000000000002),
        ...
        self.bankDisplay = DirectLabel(
            ...
            text_pos=(0, -0.10000000000000001, 0),
            geom=bankModel,
            geom_scale=0.080000000000000002,
            geom_pos=(0, 10, -0.26000000000000001),
            geom_hpr=(0, 0, 0),
            text_font=ToontownGlobals.getSignFont())
        self.depositArrow = DirectButton(
            ...
            image3_color=Vec4(0.59999999999999998, 0.59999999999999998,
                              0.59999999999999998, 0.25),
            pos=(0.01, 0, 0.14999999999999999))
        ...
        self.accept(
            localAvatar.uniqueName('moneyChange'), self._BankGui__moneyChange)
        self.accept(
    ...
    def _BankGui__requestTransaction(self):
        messenger.send(self.doneEvent, [self._BankGui__transactionAmount])
    ...
    def _BankGui__updateTransaction(self, amount):
        ...
        self._BankGui__transactionAmount = min(
            self._BankGui__transactionAmount, maxBankMoney - bankMoney)
        ...
        return (hitLimit, newJarMoney, newBankMoney,
                self._BankGui__transactionAmount)
