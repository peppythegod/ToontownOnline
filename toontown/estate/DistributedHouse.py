...
class DistributedHouse(DistributedObject.DistributedObject):
    ...
    def load(self):
        ...
        if not self.house_loaded:
            ...
            if houseModelIndex == HouseGlobals.HOUSE_DEFAULT:
                ...
                self._DistributedHouse__setupDoorCustom()
    ...
    def _DistributedHouse__setupDoorCustom(self):
        self.randomGenerator = random.Random()
        self.randomGenerator.seed(self.doId)
        ...
        self._DistributedHouse__setupFloorMat(changeColor=False)
        self._DistributedHouse__setupNametag()
        self._DistributedHouse__setupNamePlateCustom()
