...
class DistributedGagTree(DistributedPlantBase.DistributedPlantBase):
    ...
    def __init__(self, cr):
        ...
        base.tree = self
        self.collSphereRadius = 4.2000000000000002
    ...
    def loadModel(self):
        ...
        self.signModel.setPos(3.5, 0, 0.025000000000000001)
        ...
        self.prop.setPos(0.10000000000000001, -0.17000000000000001,
                         1.6299999999999999)
        self.prop.reparentTo(self.signModel)
        self.prop2.setPos(0.14999999999999999, 0.17000000000000001,
                          1.6299999999999999)
    ...
    def adjustGrowth(self):
        ...
        if DIRT_AS_WATER_INDICATOR:
            ...
            self.dirtMound.setScale(dirtMoundScale, dirtMoundScale,
                                    dirtMoundDepth)
            self.sandMound.setScale(dirtMoundScale, dirtMoundScale,
                                    dirtMoundDepth)
            self.adjustWaterIndicator()
    ...
    def doHarvestTrack(self, avId):
        ...
        self.movie = Sequence(
            self.startCamIval(avId), moveTrack, harvestTrack,
    ...
    def adjustWaterIndicator(self):
        ...
        if self.dirtMound:
            ...
            if curWaterLevel > 0:
                darkestColorScale = 0.40000000000000002
    ...
    def stickParts(self):
        ...
        testPath.setPos(
            self.signModel.getX(render), self.signModel.getY(render), 0)
    ...
    def doResultDialog(self):
        self.startInteraction()
        (curTrack,
         curLevel) = GardenGlobals.getTreeTrackAndLevel(self.typeIndex)
    ...
    def unlockPick(self):
        ...
        if load >= maxCarry and not (
                self.gagLevel > ToontownBattleGlobals.LAST_REGULAR_GAG_LEVEL):
            retval = False
