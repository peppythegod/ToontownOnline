...
class DistributedTarget(DistributedObject.DistributedObject):
    ...
    def disable(self):
        ...
        self._DistributedTarget__clearOnscreenMessage()
    ...
    def load(self):
        ...
        self.timer.setPos(1.1000000000000001, 0, -0.14999999999999999)
        self.timer.hide()
        ...
        self.scoreNode.setPos(0, 0, 0.34999999999999998)
        ...
        self.curPinballScoreNode.setPos(0.5, 0.5, 0.29999999999999999)
        ...
        if self.enabled != enabled:
            ...
            if enabled:
                self.fadeTrack = Sequence(
                    ...
                    Func(self.geom.colorScaleInterval, 1.0, Vec4(1.0, 1.0, 1.0, 0.0)), Wait(1),
                    Func(base.localAvatar.setSystemMessage, 0,
                         TTLocalizer.EstateTargetGameInst))
            else:
                self.fadeTrack = Sequence(
                    Func(self.geom.colorScaleInterval, 1.0, Vec4(1.0, 1.0, 1.0, 1.0)), Func(self.geom.stash),
                    Func(self.hideTimer),
                    Func(base.localAvatar.setSystemMessage, 0,
    ...
    def showScore(self):
        ...
        self._DistributedTarget__showOnscreenMessage(titleText, scoreText)
    ...
    def _DistributedTarget__clearOnscreenMessage(self):
