...
FlowerColors = [(0.80400000000000005, 0.20000000000000001,
                 0.20000000000000001),
                (0.92200000000000004, 0.46300000000000002, 0.0),
                (0.5, 0.20000000000000001, 1.0),
                (0.40000000000000002, 0.40000000000000002, 1.0),
                (0.95299999999999996, 0.54500000000000004,
                 0.75700000000000001),
                (0.99199999999999999, 0.84299999999999997,
                 0.39200000000000002), (1.0, 1.0, 1.0),
                (0.5, 0.80000000000000004, 0.5)]
FLOWER_RED = 0
FLOWER_ORANGE = 1
FLOWER_VIOLET = 2
FLOWER_BLUE = 3
...
PlantAttributes = {
    49: {
        'name':
        TTLocalizer.FlowerSpeciesNames[49],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        getMaxWateringCanPower(),
        'minWaterLevel':
        -2,
        'seedlingModel':
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/daisy.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/daisy.bam',
        'photoPos': (0.0, -0.34999999999999998, -0.36188199999999998),
        'photoScale':
        1,
        'photoHeading':
        0,
        ...
        35,
        'varieties':
        ((10, FLOWER_YELLOW, 1), (11, FLOWER_PINK, 2), (12, FLOWER_WHITE, 3),
         (13, FLOWER_RED, 4), (14, FLOWER_ORANGE, 5), (15, FLOWER_BLUE, 6),
         (16, FLOWER_GREEN, 7), (17, FLOWER_VIOLET, 8))
    },
    50: {
        'name':
        TTLocalizer.FlowerSpeciesNames[50],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/tulip.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/tulip.bam',
        'photoPos': (0.0, -0.34999999999999998, -0.34999999999999998),
        'photoScale':
        1,
        'photoHeading':
        0,
        'photoPitch':
        35,
        'varieties': ((20, FLOWER_VIOLET, 5), (21, FLOWER_RED, 6),
                      (22, FLOWER_YELLOW, 8))
    },
    51: {
        'name':
        TTLocalizer.FlowerSpeciesNames[51],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/carnation.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/carnation.bam',
        'photoPos': (0.0, -0.34999999999999998, -0.40000000000000002),
        'photoScale':
        1,
        'photoHeading':
        0,
        'photoPitch':
        35,
        'varieties': ((30, FLOWER_PINK, 1), (31, FLOWER_YELLOW, 2),
                      (32, FLOWER_RED, 3), (33, FLOWER_WHITE,
                                            5), (34, FLOWER_GREEN, 7))
    },
    52: {
        'name':
        TTLocalizer.FlowerSpeciesNames[52],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/lily.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/lily.bam',
        'photoPos': (0.0174745, -0.050000000000000003, -0.67051300000000003),
        'photoScale':
        1,
        'photoHeading':
        0,
        ...
        35,
        'varieties':
        ((40, FLOWER_WHITE, 1), (41, FLOWER_GREEN, 2), (42, FLOWER_ORANGE, 3),
         (43, FLOWER_PINK, 4), (44, FLOWER_RED, 5), (45, FLOWER_VIOLET, 6),
         (46, FLOWER_BLUE, 7), (47, FLOWER_YELLOW, 8))
    },
    53: {
        'name':
        TTLocalizer.FlowerSpeciesNames[53],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/narcissi.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/narcissi.bam',
        'photoPos': (-0.040317499999999999, 0.060933000000000001,
                     -0.54836799999999997),
        'photoScale':
        1,
        'photoHeading':
        ...
        'photoPitch':
        0,
        'varieties': ((50, FLOWER_GREEN, 1), (51, FLOWER_WHITE, 2),
                      (52, FLOWER_YELLOW, 4), (53, FLOWER_PINK, 5))
    },
    54: {
        'name':
        TTLocalizer.FlowerSpeciesNames[54],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/pansy.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/pansy.bam',
        'photoScale':
        2.5,
        ...
        'photoPitch':
        0,
        'varieties': ((60, FLOWER_ORANGE, 1), (61, FLOWER_WHITE, 2),
                      (62, FLOWER_RED, 3), (63, FLOWER_YELLOW,
                                            4), (64, FLOWER_PINK, 6))
    },
    55: {
        ...
        'photoPos': (0.02, -0.032458500000000001, -0.167735),
        'photoScale': 1.5,
        'photoHeading': -20,
        'photoPitch': 35,
    ...
    56: {
        'name':
        TTLocalizer.FlowerSpeciesNames[56],
        'plantType':
        FLOWER_TYPE,
        'growthThresholds': (1, 1, 1),
        'maxWaterLevel':
        ...
        'phase_5.5/models/estate/seedling.bam',
        'establishedModel':
        'phase_5.5/models/estate/rose.bam',
        'fullGrownModel':
        'phase_5.5/models/estate/rose.bam',
        'photoPos': (0.043959999999999999, 0.12479700000000001,
                     -0.87729100000000004),
        'photoScale':
        1,
        'photoHeading':
        ...
        'photoPitch':
        35,
        'varieties': ((0, FLOWER_RED, 3), (1, FLOWER_YELLOW, 4),
                      (2, FLOWER_PINK, 6), (3, FLOWER_WHITE,
                                            7), (4, FLOWER_BLUE, 8))
    },
    200: {
        ...
        'worldScale': 0.050000000000000003,
        'varieties': ((1000, 1, 0), ),
        'pinballScore': (10, 1)
    },
    201: {
...
for i in range(NUM_GAGS):
    ...
    if level <= 6:
        name = TTLocalizer.BattleGlobalAvPropStrings[track][level] + \
...
BeanColors = [(255, 0, 0), (0, 255, 0), (255, 165, 0), (148, 0, 211),
              (0, 0, 255), (255, 192, 203), (255, 255, 0), (0, 255, 255),
              (192, 192, 192)]
...
def validateRecipes(notify):
    ...
    for key in Recipes.keys():
        ...
        if len(beans) > numBoxes:
            notify.warning('numBoxes=%d beans=%s, truncating to %s' %
...
def validatePlantAttributes(notify):
        ...
        if plant['plantType'] in (STATUARY_TYPE, FLOWER_TYPE):
            ...
            for variety in varieties:
                ...
                if plant['plantType'] == FLOWER_TYPE:
                    ...
                    newInfo = (getFlowerVarietyName(
                        key,
                        list(varieties).index(variety)),
    ...
    for numBeans in range(len(flowerRecipeDistribution)):
        notify.debug('%d flowers with %d beans' % (len(
            flowerRecipeDistribution[numBeans]), numBeans))
        for flower in flowerRecipeDistribution[numBeans]:
            notify.debug('    %s,  beans = %s, color=%s' %
                         (flower[0], flower[1], flower[2]))

    notify.debug('plant attributes are ok')


plots0 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0,
                                                               FLOWER_TYPE),
          (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0,
                                                               FLOWER_TYPE),
          (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0,
                                                               FLOWER_TYPE),
          (4, 1, 0.0, FLOWER_TYPE), (-54, -13.5, 276.0, GAG_TREE_TYPE),
          (-7, -48, 343.0,
           GAG_TREE_TYPE), (-40, -75, 27.0,
                            GAG_TREE_TYPE), (-78, -44, 309.0,
                                             GAG_TREE_TYPE), (-72, -15, 260.0,
                                                              GAG_TREE_TYPE),
          (-24, -19, 294.0,
           GAG_TREE_TYPE), (11, -26, 0.0,
                            GAG_TREE_TYPE), (-92, -4, 0.0,
                                             GAG_TREE_TYPE), (-100, -43, -90.0,
                                                              STATUARY_TYPE))
plots1 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE),
          (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0,
                                                               FLOWER_TYPE),
          (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0,
                                                               FLOWER_TYPE),
          (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (62, -81, 194.0,
                                                               GAG_TREE_TYPE),
          (101, -52, 250.0,
           GAG_TREE_TYPE), (93, -104, 214.0,
                            GAG_TREE_TYPE), (69, -122, 188.0,
                                             GAG_TREE_TYPE), (92, -120, 184.0,
                                                              GAG_TREE_TYPE),
          (113, -29, 250.0,
           GAG_TREE_TYPE), (125, -57, 0.0,
                            GAG_TREE_TYPE), (114, -40, 0.0,
                                             GAG_TREE_TYPE), (47, -82, -30.0,
                                                              STATUARY_TYPE))
plots2 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0,
                                                               FLOWER_TYPE),
          (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0,
                                                               FLOWER_TYPE),
          (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0,
                                                               FLOWER_TYPE),
          (4, 1, 0.0, FLOWER_TYPE), (-40, -114, 176.0, GAG_TREE_TYPE),
          (-44, -148, 162.0,
           GAG_TREE_TYPE), (-97, -99, 138.0,
                            GAG_TREE_TYPE), (-82, -94, 134.0,
                                             GAG_TREE_TYPE), (-27, -106, 195.0,
                                                              GAG_TREE_TYPE),
          (-76, -147, 110.0,
           GAG_TREE_TYPE), (-29, -164, 0.0,
                            GAG_TREE_TYPE), (-107, -94, 0.0,
                                             GAG_TREE_TYPE), (-97, -114, -60.0,
                                                              STATUARY_TYPE))
plots3 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE),
          (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0,
                                                               FLOWER_TYPE),
          (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0,
                                                               FLOWER_TYPE),
          (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (59, 35, 187.0,
                                                               GAG_TREE_TYPE),
          (87, 28, 114.0,
           GAG_TREE_TYPE), (67, -16, 78.0,
                            GAG_TREE_TYPE), (24, 19, 155.0,
                                             GAG_TREE_TYPE), (18, 31, 172.0,
                                                              GAG_TREE_TYPE),
          (74, 36, 133.0,
           GAG_TREE_TYPE), (35, -34, 0.0,
                            GAG_TREE_TYPE), (116, 17, 0.0,
                                             GAG_TREE_TYPE), (117, 27, 102.0,
                                                              STATUARY_TYPE))
plots4 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE),
          (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0,
                                                               FLOWER_TYPE),
          (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0,
                                                               FLOWER_TYPE),
          (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (37, 101, 350.0,
                                                               GAG_TREE_TYPE),
          (15, 100, 342.0,
           GAG_TREE_TYPE), (73, 92, 0.0,
                            GAG_TREE_TYPE), (74, 69, 347.0,
                                             GAG_TREE_TYPE), (102, 62, 334.0,
                                                              GAG_TREE_TYPE),
          (86, 76, 350.0,
           GAG_TREE_TYPE), (100, 78, 327.0,
                            GAG_TREE_TYPE), (15, 73, 50.0,
                                             GAG_TREE_TYPE), (16, 87, -140.0,
                                                              STATUARY_TYPE))
plots5 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0,
                                                               FLOWER_TYPE),
          (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0,
                                                               FLOWER_TYPE),
          (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0,
                                                               FLOWER_TYPE),
          (4, 1, 0.0, FLOWER_TYPE), (-26, 92, 41.0,
                                     GAG_TREE_TYPE), (-71, 58, 37.0,
                                                      GAG_TREE_TYPE),
          (-67, 21, 243.0,
           GAG_TREE_TYPE), (-10, -2.6000000000000001, 178.0,
                            GAG_TREE_TYPE), (-60, 13.699999999999999, 250.0,
                                             GAG_TREE_TYPE), (-13, 84, 2.0,
                                                              GAG_TREE_TYPE),
          (-62, 65, 0.0,
           GAG_TREE_TYPE), (-16.600000000000001, 52.700000000000003, 0.0,
                            GAG_TREE_TYPE), (-55, 70, 213.0, STATUARY_TYPE))
estatePlots = (plots0, plots1, plots2, plots3, plots4, plots5)
BOX_ONE = 1
BOX_TWO = 2
BOX_THREE = 3
flowerBoxes0 = ((-62.5, -52.5, 182.0, BOX_ONE), (-52, -52, 182, BOX_ONE),
                (-64.5, -42, 92.0, BOX_THREE), (-49, -43, 266.0, BOX_THREE),
                (-57, -33, 0.0, BOX_TWO))
flowerBoxes1 = ((85.0, -67.0, 26.0, BOX_ONE), (75, -72, 26.0, BOX_ONE),
                (91.0, -74.0, -63.0, BOX_THREE), (77, -81, 117.0, BOX_THREE),
                (88, -86, 206.0, BOX_TWO))
flowerBoxes2 = ((-62, -112, 350.0, BOX_ONE), (-72, -110, 350.0, BOX_ONE),
                (-62, -122, 257.0, BOX_THREE), (-76, -118, 79.0, BOX_THREE),
                (-71, -129, 169.0, BOX_TWO))
flowerBoxes3 = ((72, 5, 265.0, BOX_ONE), (72.5, 16, 265.0,
                                          BOX_ONE), (63, 3, 178.0, BOX_THREE),
                (64, 19, 355.0, BOX_THREE), (54, 12, 86.0, BOX_TWO))
flowerBoxes4 = ((35.5, 70, 152.0, BOX_ONE), (46, 66, 152.0, BOX_ONE),
                (36.5, 79.5, 71.0, BOX_THREE), (51.5, 74, 247.0, BOX_THREE),
                (47, 86, -19.0, BOX_TWO))
flowerBoxes5 = ((-26.5, 37.5, 318.0, BOX_ONE), (-33, 46, 318.0, BOX_ONE),
                (-32, 30, 217.0, BOX_THREE), (-42, 42, 37.0, BOX_THREE),
                (-45, 31, 124.0, BOX_TWO))
estateBoxes = (flowerBoxes0, flowerBoxes1, flowerBoxes2, flowerBoxes3,
               flowerBoxes4, flowerBoxes5)


def whatCanBePlanted(plotIndex, hardPointIndex):
    retval = INVALID_TYPE
    if plotIndex < len(estatePlots) and plotIndex >= 0:
        if hardPointIndex < len(
                estatePlots[plotIndex]) and hardPointIndex >= 0:
...
Specials = {
    0: {
        ...
        'photoScale': 0.10000000000000001,
        'photoPos': (0, 0, -1),
    ...
    100: {
        ...
        'photoScale': 0.040000000000000001,
        'photoPos': (0, 0, -1),
    ...
    101: {
        ...
        'photoScale': 0.025000000000000001,
        'photoPos': (0, 0, -1.05),
    ...
    135: {
        ...
        'photoScale': 1.25,
        'photoPos': (0, 0, -0.040000000000000001),
...
for specialKey in Specials.keys():
    ...
    if not (recipeKey == -1):
        ...
        if specialKey == GardenAcceleratorSpecial:
            if ACCELERATOR_USED_FROM_SHTIKER_BOOK:
                Specials[specialKey][
                    'description'] = TTLocalizer.UseFromSpecialsTab
