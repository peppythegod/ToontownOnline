...
FlowerColors = [
    (0.80400000000000005, 0.20000000000000001, 0.20000000000000001),
    (0.92200000000000004, 0.46300000000000002, 0.0),
    (0.5, 0.20000000000000001, 1.0),
    (0.40000000000000002, 0.40000000000000002, 1.0),
    (0.95299999999999996, 0.54500000000000004, 0.75700000000000001),
    (0.99199999999999999, 0.84299999999999997, 0.39200000000000002),
    (1.0, 1.0, 1.0),
...
PlantAttributes = {
    49: {
        ...
        'photoHeading': 0,
        'photoPitch': 35,
        'varieties': ((10, FLOWER_YELLOW, 1), (11, FLOWER_PINK, 2), (12, FLOWER_WHITE, 3), (13, FLOWER_RED, 4), (14, FLOWER_ORANGE, 5), (15, FLOWER_BLUE, 6), (16, FLOWER_GREEN, 7), (17, FLOWER_VIOLET, 8))},
    50: {
    ...
    51: {
        ...
        'photoHeading': 0,
        'photoPitch': 35,
        'varieties': ((30, FLOWER_PINK, 1), (31, FLOWER_YELLOW, 2), (32, FLOWER_RED, 3), (33, FLOWER_WHITE, 5), (34, FLOWER_GREEN, 7))},
    52: {
        ...
        'photoHeading': 0,
        'photoPitch': 35,
        'varieties': ((40, FLOWER_WHITE, 1), (41, FLOWER_GREEN, 2), (42, FLOWER_ORANGE, 3), (43, FLOWER_PINK, 4), (44, FLOWER_RED, 5), (45, FLOWER_VIOLET, 6), (46, FLOWER_BLUE, 7), (47, FLOWER_YELLOW, 8))},
    53: {
        ...
        'photoPos': (-0.040317499999999999, 0.060933000000000001, -0.54836799999999997),
        'photoScale': 1,
        'photoHeading': 20,
        'photoPitch': 0,
        'varieties': ((50, FLOWER_GREEN, 1), (51, FLOWER_WHITE, 2), (52, FLOWER_YELLOW, 4), (53, FLOWER_PINK, 5))},
    54: {
        ...
        'photoHeading': 0,
        'photoPitch': 0,
        'varieties': ((60, FLOWER_ORANGE, 1), (61, FLOWER_WHITE, 2), (62, FLOWER_RED, 3), (63, FLOWER_YELLOW, 4), (64, FLOWER_PINK, 6))},
    55: {
    ...
    56: {
        ...
        'photoPos': (0.043959999999999999, 0.12479700000000001, -0.87729100000000004),
        'photoScale': 1,
        'photoHeading': 0,
        'photoPitch': 35,
        'varieties': ((0, FLOWER_RED, 3), (1, FLOWER_YELLOW, 4), (2, FLOWER_PINK, 6), (3, FLOWER_WHITE, 7), (4, FLOWER_BLUE, 8))},
    200: {
...
def getFlowerVarietyName(species, variety):
    ...
    if species in PlantAttributes.keys():
        ...
        if variety < len(attrib['varieties']):
            ...
            gardenNotify.warning(
                'warning unknown species=%d variety= %d' %
                (species, variety))
    else:
...
def validatePlantAttributes(notify):
        ...
        if plant['plantType'] in (STATUARY_TYPE, FLOWER_TYPE):
            ...
            for variety in varieties:
                ...
                if plant['plantType'] == FLOWER_TYPE:
                    ...
                    newInfo = (getFlowerVarietyName(key,
    ...
    for numBeans in range(len(flowerRecipeDistribution)):
        notify.debug('%d flowers with %d beans' %
...
plots0 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (-54, -13.5, 276.0,
                                                                                                                                                                                                                                                                               GAG_TREE_TYPE), (-7, -48, 343.0, GAG_TREE_TYPE), (-40, -75, 27.0, GAG_TREE_TYPE), (-78, -44, 309.0, GAG_TREE_TYPE), (-72, -15, 260.0, GAG_TREE_TYPE), (-24, -19, 294.0, GAG_TREE_TYPE), (11, -26, 0.0, GAG_TREE_TYPE), (-92, -4, 0.0, GAG_TREE_TYPE), (-100, -43, -90.0, STATUARY_TYPE))
plots1 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (62, -81, 194.0,
                                                                                                                                                                                                                                                                               GAG_TREE_TYPE), (101, -52, 250.0, GAG_TREE_TYPE), (93, -104, 214.0, GAG_TREE_TYPE), (69, -122, 188.0, GAG_TREE_TYPE), (92, -120, 184.0, GAG_TREE_TYPE), (113, -29, 250.0, GAG_TREE_TYPE), (125, -57, 0.0, GAG_TREE_TYPE), (114, -40, 0.0, GAG_TREE_TYPE), (47, -82, -30.0, STATUARY_TYPE))
plots2 = ((0, 0, 0.0, FLOWER_TYPE), (1, 0, 0.0, FLOWER_TYPE), (2, 0, 0.0, FLOWER_TYPE), (2, 1, 0.0, FLOWER_TYPE), (2, 2, 0.0, FLOWER_TYPE), (3, 0, 0.0, FLOWER_TYPE), (3, 1, 0.0, FLOWER_TYPE), (3, 2, 0.0, FLOWER_TYPE), (4, 0, 0.0, FLOWER_TYPE), (4, 1, 0.0, FLOWER_TYPE), (-40, -114, 176.0,
                                                                                                                                                                                                                                                                               GAG_TREE_TYPE), (-44, -148, 162.0, GAG_TREE_TYPE), (-97, -99, 138.0, GAG_TREE_TYPE), (-82, -94, 134.0, GAG_TREE_TYPE), (-27, -106, 195.0, GAG_TREE_TYPE), (-76, -147, 110.0, GAG_TREE_TYPE), (-29, -164, 0.0, GAG_TREE_TYPE), (-107, -94, 0.0, GAG_TREE_TYPE), (-97, -114, -60.0, STATUARY_TYPE))
plots3 = (
    (0,
     0,
     0.0,
...
BOX_TWO = 2
BOX_THREE = 3
flowerBoxes0 = ((-62.5, -52.5, 182.0, BOX_ONE), (-52, -52, 182, BOX_ONE), (-64.5, -42,
                                                                           92.0, BOX_THREE), (-49, -43, 266.0, BOX_THREE), (-57, -33, 0.0, BOX_TWO))
flowerBoxes1 = ((85.0, -
                 67.0, 26.0, BOX_ONE), (75, -
                                        72, 26.0, BOX_ONE), (91.0, -
                                                             74.0, -
                                                             63.0, BOX_THREE), (77, -
                                                                                81, 117.0, BOX_THREE), (88, -
                                                                                                        86, 206.0, BOX_TWO))
flowerBoxes2 = ((-62, -112, 350.0, BOX_ONE), (-72, -110, 350.0, BOX_ONE), (-62, -
                                                                           122, 257.0, BOX_THREE), (-76, -118, 79.0, BOX_THREE), (-71, -129, 169.0, BOX_TWO))
flowerBoxes3 = ((72, 5, 265.0, BOX_ONE), (72.5, 16, 265.0, BOX_ONE), (63,
                                                                      3, 178.0, BOX_THREE), (64, 19, 355.0, BOX_THREE), (54, 12, 86.0, BOX_TWO))
flowerBoxes4 = ((35.5, 70, 152.0, BOX_ONE), (46, 66, 152.0, BOX_ONE), (36.5,
                                                                       79.5, 71.0, BOX_THREE), (51.5, 74, 247.0, BOX_THREE), (47, 86, -19.0, BOX_TWO))
flowerBoxes5 = ((-26.5, 37.5, 318.0, BOX_ONE), (-33, 46, 318.0, BOX_ONE), (-32,
                                                                           30, 217.0, BOX_THREE), (-42, 42, 37.0, BOX_THREE), (-45, 31, 124.0, BOX_TWO))
estateBoxes = (
    flowerBoxes0,
    flowerBoxes1,
    flowerBoxes2,
