...
class DistributedFireworksCannon(
    ...
    def announceGenerate(self):
        ...
        self.accept(self.fireworksSphereEnterEvent,
                    self._DistributedFireworksCannon__handleEnterSphere)
    ...
    def _DistributedFireworksCannon__handleEnterSphere(self, collEntry):
        self.notify.debug('handleEnterSphere()')
        self.ignore(self.fireworksSphereEnterEvent)
        self.sendUpdate('avatarEnter', [])

    def _DistributedFireworksCannon__handleFireworksDone(self):
        self.ignore(self.fireworksGuiDoneEvent)
        self.ignore(self.shootEvent)
        ...
        if mode == FIREWORKS_MOVIE_CLEAR:
            ...
            if isLocalToon:
                ...
                self.accept(
                    ...
                    self._DistributedFireworksCannon__handleFireworksDone)
