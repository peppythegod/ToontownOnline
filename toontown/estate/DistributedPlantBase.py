...
class DistributedPlantBase(DistributedLawnDecor.DistributedLawnDecor):
    ...
    def handleEnterPlot(self, colEntry=None):
        ...
        self.accept('water-plant', self._DistributedPlantBase__handleWatering)
    ...
    def _DistributedPlantBase__handleWatering(self, plantToWaterId):
    ...
    def adjustWaterIndicator(self):
        if self.model:
            ...
            if color < 0.20000000000000001:
                color = 0.20000000000000001
