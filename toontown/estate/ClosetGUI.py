...
class ClosetGUI(ClothesGUI.ClothesGUI):
    ...
    def load(self):
        ...
        self.cancelButton = DirectButton(
            ...
            command=self._ClosetGUI__handleCancel,
        ...
        if self.isOwner:
            ...
            self.trashPanel = DirectFrame(
                ...
                image_scale=(0.35999999999999999, 0, 0.75),
                pos=(-0.85999999999999999, 0, -0.050000000000000003),
                relief=None)
            self.topTrashButton = DirectButton(
                parent=self.trashPanel,
                image=trashImage,
                relief=None,
                pos=(-0.089999999999999997, 0, 0.20000000000000001),
                command=self._ClosetGUI__handleDelete,
            ...
            self.button = DirectButton(
                ...
                pos=(-0.14999999999999999, 0, -0.84999999999999998),
                command=self._ClosetGUI__handleButton,
    ...
    def setupScrollInterface(self):
        ...
        self.tops = []
        self.bottoms = []
        self.tops.append((self.dna.topTex, self.dna.topTexColor,
                          self.dna.sleeveTex, self.dna.sleeveTexColor))
        self.bottoms.append((self.dna.botTex, self.dna.botTexColor))
        i = 0
        while i < len(self.topsList):
            self.tops.append((self.topsList[i], self.topsList[i + 1],
                              self.topsList[i + 2], self.topsList[i + 3]))
            i = i + 4
        i = 0
    ...
    def _ClosetGUI__handleDelete(self, t_or_b):
        ...
        self.accept('verifyDone',
                    Functor(self._ClosetGUI__handleVerifyDelete, t_or_b))
        messenger.send('wakeup')
