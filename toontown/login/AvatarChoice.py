...
NAME_POSITIONS = (
    ...
    (0,
     0,
     0.26000000000000001))
DELETE_POSITIONS = ((0.187, 0, -
                     0.26000000000000001), (0.31, 0, -
                                            0.16700000000000001), (0.23100000000000001, 0, -
                                                                   0.24099999999999999), (0.314, 0, -
                                                                                          0.186), (0.24299999999999999, 0, -
                                                                                                   0.23300000000000001), (0.28000000000000003, 0, -
                                                                                                                          0.20699999999999999))
...
class AvatarChoice(DirectButton):
    ...
    def __init__(self, av=None, position=0, paid=0, okToLockout=1):
        ...
        if self.mode is AvatarChoice.MODE_LOCKED:
            ...
            logo = DirectFrame(
                state=DGG.DISABLED, parent=self, relief=None, image=upsellTex, image_scale=(
                    0.90000000000000002, 0, 0.90000000000000002), image_pos=(
                    0, 0, 0), scale=0.45000000000000001)
            ...
            self.head.setPosHprScale(0, 5, -0.10000000000000001, 180, 0, 0,
                                     0.23999999999999999, 0.23999999999999999, 0.23999999999999999)
    ...
    def _AvatarChoice__handleDelete(self):
        ...
        self.verify = TTDialog.TTGlobalDialog(
            ...
            message=TTLocalizer.AvatarChoiceDeleteConfirm %
            self.name,
    ...
    def verifyDeleteWithPassword(self):
        ...
        if self.deleteWithPasswordFrame is None:
            ...
            if self.deleteWithPassword:
                ...
                DirectButton(parent=self.deleteWithPasswordFrame,
                             image=okButtonImage,
                             relief=None,
    ...
    def _AvatarChoice__handleDeleteWithPasswordOK(self, *args):
        ...
        if okFlag:
            ...
            self.notify.warning(
                'authenticateDelete returned unexpected error: %s' %
                errorMsg)
    ...
    def _AvatarChoice__handleDeleteWithConfirmOK(self, *args):
        ...
        if password == passwordMatch:
            ...
            self.deleteWithPasswordFrame['text'] = TTLocalizer.AvatarChoiceDeleteWrongConfirm % {
                'name': self.name, 'confirm': TTLocalizer.AvatarChoiceDeleteConfirmUserTypes}
            self.passwordEntry['focus'] = 1
            self.passwordEntry.enterText('')
