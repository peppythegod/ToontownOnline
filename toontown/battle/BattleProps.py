...
class PropPool:
    ...
    def makeVariant(self, name):
        if name == 'tart':
            ...
            tie = self.props[name]
            tie.getChild(0).setHpr(23.859999999999999, -
                                   16.030000000000001, 9.1799999999999997)
        elif name == 'small-magnet':
            self.props[name].setScale(0.5)
        elif name == 'shredder-paper':
            paper = self.props[name]
            paper.setPosHpr(2.2200000000000002, -
                            0.94999999999999996, 1.1599999999999999, -
                            48.609999999999999, 26.57, -
                            111.51000000000001)
            paper.flattenMedium()
        elif name == 'lips':
