...
colors = {
    WHITE: Vec4(1, 1, 1, 1),
    RED: Vec4(1, 0.20000000000000001, 0.20000000000000001, 1),
    BLUE: Vec4(0.20000000000000001, 0.20000000000000001, 1, 1),
...
def shootFireworkCircleSprite(x, y, z, color, texture, amp):
    ...
    p0.renderer.setFinalXScale(0.47999999999999998)
    p0.renderer.setInitialYScale(0.12)
    p0.renderer.setFinalYScale(0.47999999999999998)
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitudeSpread(0.10000000000000001)
    p0.emitter.setAmplitude(amp)
    p0.emitter.setRadius(0.10000000000000001)
