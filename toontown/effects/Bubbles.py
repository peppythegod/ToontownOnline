...
class Bubbles(NodePath):
    ...
    def __init__(self, parent, renderParent):
        ...
        p0.renderer.setInitialXScale(0.070000000000000007)
        p0.renderer.setFinalXScale(0.20000000000000001)
        p0.renderer.setInitialYScale(0.070000000000000007)
        p0.renderer.setFinalYScale(0.20000000000000001)
