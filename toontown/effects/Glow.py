...
class Glow(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        pulseIval = Sequence(
            ...
            Wait(0.10000000000000001),
            Func(self.effectModel.setColorScale,
                 Vec4(1, 1, 1, 0.69999999999999996)))
        self.startEffect = Sequence(
            Func(self.effectModel.show), Func(pulseIval.loop))
        self.endEffect = Sequence(
            Func(pulseIval.finish), Func(self.cleanUpEffect))
