...
ms = (('effort', 'effort', 5), ('throw-paper', 'throw-paper', 5),
...
def cogExists(filePrefix):
    ...
    if AppRunnerGlobal.appRunner:
        searchPath.appendDirectory(
            Filename.expandFrom('$TT_3_5_ROOT/phase_3.5'))
...
class Suit(Avatar.Avatar):
    ...
    def reseatHealthBarForSkele(self):
        self.healthBar.setPos(0.0, 0.10000000000000001, 0.0)
    ...
    def makeSkeleton(self):
        model = 'phase_5/models/char/cog' + \
            string.upper(self.style.body) + '_robot-zero'
