...
class DistributedBossbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self._DistributedBossbotBoss__makeResistanceToon()
        ...
        self.warningSfx = loader.loadSfx(
            'phase_5/audio/sfx/Skel_COG_VO_grunt.mp3')
    ...
    def disable(self):
        ...
        self._DistributedBossbotBoss__cleanupResistanceToon()
    ...
    def loadEnvironment(self):
        ...
        self.geom = loader.loadModel(
            'phase_12/models/bossbotHQ/BanquetInterior_1')
        self.elevatorEntrance = self.geom.find('**/elevator_origin')
        elevatorModel = loader.loadModel(
            'phase_12/models/bossbotHQ/BB_Inside_Elevator')
    ...
    def _DistributedBossbotBoss__makeResistanceToon(self):
    ...
    def _DistributedBossbotBoss__cleanupResistanceToon(self):
    ...
    def _DistributedBossbotBoss__showResistanceToon(self, withSuit):
    ...
    def _DistributedBossbotBoss__hideResistanceToon(self):
    ...
    def enterElevator(self):
        ...
        self.resistanceToon.removeActive()
        self._DistributedBossbotBoss__showResistanceToon(True)
    ...
    def _DistributedBossbotBoss__onToBattleTwo(self, elapsedTime=0):
    ...
    def _DistributedBossbotBoss__arrangeToonsAroundResistanceToon(self):
        radius = 9
    ...
    def putFoodOnToon(self, avId, beltIndex, foodNum):
        ...
        if av:
            ...
            foodModel.setHpr(52.196100000000001, 180.4983, -4.2881999999999998)
    ...
    def _DistributedBossbotBoss__onToBattleThree(self, elapsedTime=0):
    ...
    def enterEpilogue(self):
        ...
        self.stopAnimate()
        self.controlToons()
        self._DistributedBossbotBoss__showResistanceToon(False)
    ...
    def _DistributedBossbotBoss__talkAboutPromotion(self, speech):
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            ...
            speech += TTLocalizer.BossbotRTMaxed % (
                ToontownGlobals.MaxCogSuitLevel + 1)
        return speech

    def _DistributedBossbotBoss__arrangeToonsAroundResistanceToonForReward(
            self):
        radius = 7
        numToons = len(self.involvedToons)
        center = (numToons - 1) / 2.0
    ...
    def doDirectedAttack(self, avId, attackCode):
        ...
        if toon:
            ...
            gearRoot = self.rotateNode.attachNewNode(
                'gearRoot-atk%d' % self.numAttacks)
            gearRoot.setZ(10)
    ...
    def setAttackCode(self, attackCode, avId=0):
        ...
        if attackCode == ToontownGlobals.BossCogMoveAttack:
            ...
            self.setDizzy(0)
            self.doAnimate('frontAttack', now=1)
        elif attackCode == ToontownGlobals.BossCogDirectedAttack and attackCode == ToontownGlobals.BossCogSlowDirectedAttack or attackCode == ToontownGlobals.BossCogGearDirectedAttack:
            self.interruptMove()
            self.setDizzy(0)
    ...
    def _DistributedBossbotBoss__recoverSpeedDamage(self, task):
    ...
    def doZapToon(self, toon, pos=None, hpr=None, ts=0, fling=1, shake=1):
        ...
        if toon == localAvatar:
            ...
            if currentState in ('BattleFour', 'BattleTwo'):
                ...
                self.notify.warning(
                    'doZapToon going to walkMode, how did this happen?')
