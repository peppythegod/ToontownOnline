...
class SuitAvatarPanel(AvatarPanel.AvatarPanel):
    ...
    def __init__(self, avatar):
        ...
        self.frame = DirectFrame(
            ...
            geom_scale=0.20999999999999999,
            geom_pos=(
                0,
                0,
                0.02),
        ...
        self.levelLabel = DirectLabel(
            parent=self.frame, pos=(
                0, 0, -0.10000000000000001), relief=None, text=TTLocalizer.AvatarPanelCogLevel %
            level, text_font=avatar.getFont(), text_align=TextNode.ACenter, text_fg=Vec4(
                0, 0, 0, 1), text_pos=(
                0, 0), text_scale=0.050000000000000003, text_wordwrap=8.0)
        ...
        self.corpIcon = DirectLabel(
            parent=self.frame, geom=corpIcon, geom_scale=0.13, pos=(
                0, 0, -0.17499999999999999), relief=None)
        corpIcon.removeNode()
        ...
        self.closeButton = DirectButton(
            ...
            text_pos=(
                ...
                0),
            text_scale=0.050000000000000003,
            command=self._SuitAvatarPanel__handleClose)
        gui.removeNode()
