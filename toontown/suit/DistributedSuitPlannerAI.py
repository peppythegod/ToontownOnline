...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    def __init__(self, air, zoneId):
        ...
        if simbase.air.wantCogdominiums: ## TODO!!
    ...
    def upkeepSuitPopulation(self, task):
        ...
        print "b deficit %d is %d" %(self.zoneId, buildingDeficit)
        ...
        if self.buildingMgr:
            ...
            if timeout != None:
                ...
                if oldestAge > timeout:
                    ...
                    oldest.toonTakeOver()
        print "street %d has now %d suits" %(self.zoneId, self.numFlyInSuits + self.numBuildingSuits)
