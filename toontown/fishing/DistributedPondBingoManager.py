...
class DistributedPondBingoManager(DistributedObject.DistributedObject,
    ...
    def _DistributedPondBingoManager__generateCard(self):
        self.notify.debug('__generateCard: %s' % self.typeId)
        if self.card.getGame():
            self.card.removeGame()

        game = self._DistributedPondBingoManager__cardChoice()
    ...
    def _DistributedPondBingoManager__cardChoice(self):
    ...
    def filterOff(self, request, args):
        if request == 'Intro':
            ...
            self._DistributedPondBingoManager__generateCard()
