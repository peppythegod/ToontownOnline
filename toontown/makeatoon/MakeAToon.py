...
class MakeAToon(StateData.StateData):
    ...
    def __init__(self, parentFSM, avList, doneEvent, index, isPaid):
        ...
        self.dna = None
        self.progressing = 0
        self.toonPosition = Point3(-1.6200000000000001, -3.4900000000000002, 0)
    ...
    def enter(self):
        ...
        camera.setPosHpr(-5.7000000000000002, -12.350099999999999,
                         2.1499999999999999, -24.849900000000002, 2.73, 0)
        if self.warp:
    ...
    def load(self):
        ...
        self.spotlight.setColor(1, 1, 1, 0.29999999999999999)
        self.spotlight.setPos(1.1799999999999999, -1.27, 0.40999999999999998)
        self.spotlight.setScale(2.6000000000000001)
    ...
    def enterBodyShop(self):
        ...
        self.guiTopBar['text_fg'] = (0.0, 0.97999999999999998, 0.5, 1)
    ...
    def enterNameShop(self):
        ...
        self.spotlight.setPos(2, -1.95, 0.40999999999999998)
        self.spotlight.setScale(2.2999999999999998)
    ...
    def _MakeAToon__handleSkipTutorial(self):
    ...
    def create3DGui(self):
        ...
        self.proto.setScale(0.20000000000000001)
