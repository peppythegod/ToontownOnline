...
class Cannon:
    ...
    def __init__(self, parent, pos=Point3(0, 0, 0)):
        self._Cannon__previousRotation = 0.0
        self._Cannon__previousAngle = 0.0
        self._rotation = 0.0
        self._angle = 0.0
        self._position = pos
        self._parent = parent
    ...
    def unload(self):
        self._Cannon__cleanupToonInside()
        if self.cannonNode:
    ...
    def placeToonInside(self, toon):
        self._Cannon__setToonInside(toon)
        self._Cannon__createToonHead(toon)
        self._Cannon__placeToon()

    def _Cannon__setToonInside(self, toon):
    ...
    def isToonInside(self):
        return self.toonHead is not None
    ...
    def setAngle(self, angle):
        self._Cannon__previousAngle = self._angle
    ...
    def hasMoved(self):
        if not self._Cannon__previousRotation != self._rotation:
            pass
        return self._Cannon__previousAngle != self._angle
