...
class JellybeanRewardGui(DirectFrame):
    ...
    def showReward(self, earnedAmount, jarAmount, message):
        ...
        if base.cr.newsManager.isHolidayRunning(
            ToontownGlobals.JELLYBEAN_DAY) and base.cr.newsManager.isHolidayRunning(
            ToontownGlobals.JELLYBEAN_PARTIES_HOLIDAY) or base.cr.newsManager.isHolidayRunning(
