...
class Decoration(NodePath):
    ...
    def __init__(self, name, x, y, h):
        ...
        if self.name == 'CakeTower':
            ...
            for i in xrange(decors.getNumPaths()):
                ...
                n = decPiece.getName()
                if n.endswith('shadow') and n.endswith('base') and n.endswith(
    ...
    def startAnimSeq(self):
        ...
        if self.startAnim == 1:
            self.animSeq = Sequence(
                LerpHprInterval(
                    self.decorationModel, 3.0,
                    Vec3(
                        random.randint(0, 5), random.randint(0, 5),
                        random.randint(0, 5))), Wait(0.050000000000000003),
    ...
    def unload(self):
        ...
        elif self.name == 'CogIceCreamVictory' and self.name == 'CogStatueVictory' and self.name == 'cogIceCreamWinter' or self.name == 'CogStatueWinter':
            self.cleanUpAnimSequences()
