...
class DistributedPartyActivity(DistributedObject.DistributedObject):
    ...
    def _processJoinedToons(self, joinedToons):
        for toonId in joinedToons:
            ...
            toonId not in self._toonId2ror
    ...
    def _DistributedPartyActivity__createRandomNumGen(self):
    ...
    def generate(self):
        ...
        self._DistributedPartyActivity__createRandomNumGen()
    ...
    def showMessage(self, message, endState='walk'):
        ...
        self.acceptOnce(self.messageDoneEvent,
                        self._DistributedPartyActivity__handleMessageDone)
    ...
    def _DistributedPartyActivity__handleMessageDone(self):
        self.ignore(self.messageDoneEvent)
    ...
    def showJellybeanReward(self, earnedAmount, jarAmount, message):
        if not self.isLocalToonInActivity() or base.localAvatar.doId in self.getToonIdsAsList():
            ...
            self.acceptOnce(
                ...
                self._DistributedPartyActivity__handleJellybeanRewardDone)
            self.rewardGui.showReward(earnedAmount, jarAmount, message)

    def _DistributedPartyActivity__handleJellybeanRewardDone(self):
