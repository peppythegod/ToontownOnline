...
class Party(Place.Place):
    ...
    def __init__(self, loader, avId, zoneId, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Party', [
            ...
            State.State('push', self.enterPush, self.exitPush, [
                'walk']),
            State.State('partyPlanning', self.enterPartyPlanning, self.exitPartyPlanning, [
                'DFA',
                'teleportOut']),
    ...
    def _Party__updateLocalAvatarTeleportIn(self, requestStatus):
        ...
        if hasattr(base, 'distributedParty'):
            ...
            self.accept(
                'generate-' + str(base.distributedParty.partyInfo.hostId), self._Party__setPartyHat)
    ...
    def enterTeleportOut(self, requestStatus):
        Place.Place.enterTeleportOut(
            self, requestStatus, self._Party__teleportOutDone)
