...
class StrafingControl:
    ...
    def update(self):
        ...
        if self.player._aimMode and not (self.player.input.throwPiePressed):
            if self.player.input.upPressed and self.player.input.downPressed and self.player.input.leftPressed or self.player.input.rightPressed:
                self.toggleAim()

        if not self.player._aimMode:
            if not self.player.input.upPressed and self.player.input.downPressed and self.player.input.leftPressed or self.player.input.rightPressed:
