...
class PetDetailPanel(DirectFrame):
    ...
    def __init__(self, pet, closeCallback, parent=aspect2d, **kw):
        ...
        optiondefs = (('pos', (-4.5199999999999996, 0.0, 3.0499999999999998),
                       None), ('scale', 3.5800000000000001,
                               None), ('relief', None,
                                       None), ('image', detailPanel, None),
                      ('image_color', GlobalDialogColor,
                       None), ('text', TTLocalizer.PetDetailPanelTitle,
                               None), ('text_wordwrap', 10.4, None),
                      ('text_scale', 0.13200000000000001,
                       None), ('text_pos', (-0.20000000000000001,
                                            0.61250000000000004), None))
        ...
        self.dataText = DirectLabel(
            ...
            text_wordwrap=15,
            relief=None,
            pos=(-0.69999999999999996, 0.0, 0.55000000000000004))
        self.bCancel = DirectButton(
            ...
            text_pos=(0.12, -0.01),
            pos=(-0.88, 0.0, -0.68000000000000005),
            scale=2.0,
            ...
            if trickId < len(pet.trickAptitudes):
                ...
                if aptitude != 0:
                    ...
                    if hp == healRange[1]:
                        hp = healRange[1]
                        length = 1
                        barColor = (0.69999999999999996, 0.80000000000000004,
                                    0.5, 1)
                    else:
                        (hp, length) = divmod(hp, 1)
                        barColor = (0.90000000000000002, 1,
                                    0.69999999999999996, 1)
                    if not label:
                        self.labels[trickId] = DirectLabel(
                            parent=self,
                            relief=None,
                            pos=(0, 0, 0.42999999999999999 - trickId * 0.155),
                    ...
                    if not bar:
                        self.bars[trickId] = DirectWaitBar(
                            ...
                            pos=(0, 0, 0.42999999999999999 - trickId * 0.155),
                            relief=DGG.SUNKEN,
                            frameSize=(-0.5, 0.90000000000000002,
                                       -0.10000000000000001,
                                       0.10000000000000001),
                            borderWidth=(0.025000000000000001,
                                         0.025000000000000001),
                            scale=0.69999999999999996,
                            frameColor=(0.40000000000000002,
                                        0.59999999999999998,
                                        0.40000000000000002, 1),
                            barColor=barColor,
