    ...
    def __init__(self, pet, closeCallback, parent=aspect2d, **kw):
        ...
        optiondefs = (
            ...
            ('image_color',
             ...
             None),
            ('text',
             TTLocalizer.PetDetailPanelTitle,
             None),
            ('text_wordwrap',
             10.4,
             None),
            ...
            if trickId < len(pet.trickAptitudes):
                ...
                if aptitude != 0:
                    ...
                    if hp == healRange[1]:
                        ...
                        length = 1
                        barColor = (
                            0.69999999999999996, 0.80000000000000004, 0.5, 1)
                    else:
                        (hp, length) = divmod(hp, 1)
                        barColor = (
                            0.90000000000000002, 1, 0.69999999999999996, 1)
                    if not label:
                        self.labels[trickId] = DirectLabel(
                            ...
                            pos=(
                                0,
                                0,
                                0.42999999999999999 - trickId * 0.155),
