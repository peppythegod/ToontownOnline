...
class PetLookerAI:
    ...
    def enterPetLook(self):
        ...
        self._PetLookerAI__collNode = self._getPetLookerBodyNode(
        ).attachNewNode('PetLookerCollNode')
    ...
    def exitPetLook(self):
        ...
        self._PetLookerAI__collNode.removeNode()
        del self._PetLookerAI__collNode
        self._PetLookerAI__active = 0
    ...
    def _createPetLookSphere(self):
        ...
        self.lookSphereNodePath = self._PetLookerAI__collNode.attachNewNode(
            lookSphereNode)
    ...
    def _PetLookerAI__getOtherLookerDoIdFromCollEntry(self, collEntry):
