...
class DownloadWatcher(DirectObject):
    ...
    def __init__(self, phaseNames):
        ...
        self.bar = DirectWaitBar(
            guiId='DownloadWatcherBar', pos=(
                -0.81000000000000005, 0, -0.95999999999999996), relief=DGG.SUNKEN, frameSize=(
                ...
                0.02, 0.02), scale=0.25, range=100, sortOrder=50, frameColor=(
                    0.5, 0.5, 0.5, 0.5), barColor=(
                        0.20000000000000001, 0.69999999999999996, 0.20000000000000001, 0.5), text='0%', text_scale=0.16, text_fg=(
