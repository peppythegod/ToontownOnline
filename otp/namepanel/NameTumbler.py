...
class NameTumbler(DirectFrame):
    ...
    def __init__(self, nameList, category):
        DirectFrame.__init__(
            self, parent=aspect2d, relief='flat', scale=(
                1, 1, 1), state='disabled', frameColor=(
                1, 1, 1, 0))
    ...
    def loadTumblerGUI(self):
        ...
        self.tumblerscrollList = self.makeScrollList(
            self.displayList, self.makeLabel, [
    ...
    def deactivateTumbler(self):
        self.hilight.hide()
        self.isActive = 0
        self.tumblerscrollList.itemFrame['frameColor'] = (
