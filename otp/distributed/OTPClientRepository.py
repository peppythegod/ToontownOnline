...
class OTPClientRepository(ClientRepositoryBase):
    ...
    def __init__(self, serverVersion, launcher=None, playGame=None):
                                                                                                               ...
                                                                                                               config.GetString(
                                                                                                                   ...
                                                                                                                   'YES')) + '&PIRATES_SUB_%s_ID=%s' % (i,
                                                                                                                                                        config.GetInt(
                                                                                                                                                            ...
                                                                                                                                                            playerAccountId) + config.GetInt(
                                                                                                                                                            'fake-DISL-Sub-Id-Offset',
                                                                                                                                                            0)) + '&PIRATES_SUB_%s_LEVEL=%s' % (i,
                                                                                                                                                                                                config.GetInt(
        ...
        if config.GetBool(
                'detect-messenger-leaks',
                0) or config.GetBool(
                'ai-detect-messenger-leaks',
                0):
    ...
    enterLoginOff = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterLoginOff)
    ...
    _handleConnected = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(_handleConnected)
    ...
    def __handleLoginDone(self, doneStatus):
        ...
        if mode == 'success':
            ...
            self.notify.error(
                'Invalid doneStatus mode from loginScreen: ' +
                str(mode))
    ...
    exitFailedToConnect = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitFailedToConnect)
    ...
    exitFailedToGetServerConstants = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitFailedToGetServerConstants)
    ...
    enterShutdown = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterShutdown)
    ...
    exitShutdown = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitShutdown)
    ...
    enterWaitForGameList = report(types=[
        'args',
    ...
    waitForGetGameListResponse = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(waitForGetGameListResponse)

    def isGameListCorrect(self):
        return 1

    isGameListCorrect = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(isGameListCorrect)

    def exitWaitForGameList(self):
        self.handler = None

    exitWaitForGameList = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitWaitForGameList)
    ...
    enterMissingGameRootObject = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterMissingGameRootObject)
    ...
    exitMissingGameRootObject = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitMissingGameRootObject)
    ...
    enterWaitForShardList = report(types=[
        'args',
    ...
    _wantShardListComplete = report(types=[
        'args',
    ...
    exitWaitForShardList = report(types=[
        'args',
    ...
    enterNoShards = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterNoShards)
    ...
    exitNoShards = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitNoShards)
    ...
    enterNoShardsWait = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterNoShardsWait)
    ...
    exitNoShardsWait = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitNoShardsWait)
    ...
    enterReject = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterReject)

    def exitReject(self):
        self.handler = None

    exitReject = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitReject)
    ...
    exitNoConnection = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitNoConnection)
    ...
    enterAfkTimeout = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterAfkTimeout)
    ...
    exitAfkTimeout = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitAfkTimeout)
    ...
    enterPeriodTimeout = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterPeriodTimeout)
    ...
    exitPeriodTimeout = report(types=[
        'args',
    ...
    _requestAvatarList = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(_requestAvatarList)
    ...
    exitWaitForAvatarList = report(types=[
        'args',
    ...
    sendCreateAvatarMsg = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(sendCreateAvatarMsg)
    ...
    sendCreateAvatar2Msg = report(types=[
        'args',
    ...
    sendDeleteAvatarMsg = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(sendDeleteAvatarMsg)
    ...
    exitRejectRemoveAvatar = report(types=[
        'args',
    ...
    enterWaitForSetAvatarResponse = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterWaitForSetAvatarResponse)

    def exitWaitForSetAvatarResponse(self):
        self.cleanupWaitingForDatabase()
        self.handler = None

    exitWaitForSetAvatarResponse = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitWaitForSetAvatarResponse)

    def sendSetAvatarMsg(self, potAv):
        self.sendSetAvatarIdMsg(potAv.id)
        self.avData = potAv

    sendSetAvatarMsg = report(types=[
        'args',
    ...
    sendSetAvatarIdMsg = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(sendSetAvatarIdMsg)
    ...
    handleWaitForSetAvatarResponse = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(handleWaitForSetAvatarResponse)
    ...
    enterPlayingGame = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterPlayingGame)
    ...
    detectLeaks = report(types=[
        'args'], dConfigParam='teleport')(detectLeaks)
    ...
    enterGameOff = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterGameOff)

    def exitGameOff(self):
        self.handler = None

    exitGameOff = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitGameOff)
    ...
    enterWaitOnEnterResponses = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterWaitOnEnterResponses)
    ...
    handleWaitOnEnterResponses = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(handleWaitOnEnterResponses)
    ...
    uberZoneInterestComplete = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(uberZoneInterestComplete)
    ...
    exitWaitOnEnterResponses = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitWaitOnEnterResponses)
    ...
    _removeAllOV = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(_removeAllOV)
    ...
    removeShardInterest = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(removeShardInterest)
    ...
    _removeShardInterestComplete = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(_removeShardInterestComplete)
    ...
    enterPlayGame = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterPlayGame)
    ...
    exitPlayGame = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitPlayGame)
    ...
    enterSwitchShards = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(enterSwitchShards)

    def _handleOldShardGone(self):
        self.gameFSM.request('waitOnEnterResponses', self._switchShardParams)

    _handleOldShardGone = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(_handleOldShardGone)

    def exitSwitchShards(self):
        pass

    exitSwitchShards = report(types=[
        'args',
        'deltaStamp'], dConfigParam='teleport')(exitSwitchShards)
    ...
    def allowAnyTypedChat(self):
        if self.allowSecretChat() and self.allowWhiteListChat() or self.allowOpenChat():
            return True
        else:
            return False
    ...
    def needParentPasswordForSecretChat(self):
        if (self.isPaid() or self.secretChatNeedsParentPassword) and self.productName == 'Terra-DMC' and self.isBlue():
            pass
            ...
            if os.path.isdir(dir):
                for filename in os.listdir(dir):
                    if filename.endswith('.pyo') and filename.endswith(
                            '.pyc') and filename.endswith('.py') or filename == 'library.zip':
