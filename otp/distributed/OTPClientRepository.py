...
class OTPClientRepository(ClientRepositoryBase):
    ...
    enterLoginOff = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterLoginOff)

    def exitLoginOff(self):
        self.handler = None

    exitLoginOff = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitLoginOff)
    ...
    enterConnect = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterConnect)

    def failedToConnect(self, statusCode, statusString):
        self.loginFSM.request('failedToConnect', [statusCode, statusString])

    failedToConnect = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(failedToConnect)
    ...
    exitConnect = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitConnect)
    ...
    _OTPClientRepository__handleLoginDone = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(__handleLoginDone)
    ...
    exitLogin = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitLogin)
    ...
    enterFailedToConnect = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(enterFailedToConnect)
    ...
    enterShutdown = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterShutdown)
    ...
    enterWaitForGameList = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(enterWaitForGameList)
    ...
    _wantShardListComplete = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(_wantShardListComplete)
    ...
    _shardsAreReady = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(_shardsAreReady)
    ...
    exitWaitForShardList = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(exitWaitForShardList)
    ...
    enterNoShards = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterNoShards)
    ...
    _OTPClientRepository__handleNoShardsAck = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(__handleNoShardsAck)
    ...
    exitNoShards = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitNoShards)
    ...
    enterReject = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterReject)

    def exitReject(self):
        self.handler = None

    exitReject = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitReject)
    ...
    enterAfkTimeout = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterAfkTimeout)
    ...
    exitAfkTimeout = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitAfkTimeout)
    ...
    _OTPClientRepository__handlePeriodOk = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(__handlePeriodOk)
    ...
    enterWaitForAvatarList = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(enterWaitForAvatarList)
    ...
    exitWaitForAvatarList = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(exitWaitForAvatarList)
    ...
    handleWaitForAvatarList = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(handleWaitForAvatarList)
    ...
    handleGetAvatarsRespMsg = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(handleGetAvatarsRespMsg)
    ...
    sendCreateAvatar2Msg = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(sendCreateAvatar2Msg)
    ...
    def enterRejectRemoveAvatar(self, reasonCode):
        ...
        self.rejectRemoveAvatarBox = dialogClass(
            message='%s\n(%s)' % (OTPLocalizer.CRRejectRemoveAvatar,
                                  reasonCode),
    ...
    enterRejectRemoveAvatar = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(enterRejectRemoveAvatar)
    ...
    exitRejectRemoveAvatar = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(exitRejectRemoveAvatar)
    ...
    handleAvatarResponseMsg = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(handleAvatarResponseMsg)
    ...
    exitPlayingGame = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitPlayingGame)
    ...
    def _abandonShard(self):
        self.notify.error(
            '%s must override _abandonShard' % self.__class__.__name__)
    ...
    enterGameOff = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterGameOff)

    def exitGameOff(self):
        self.handler = None

    exitGameOff = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitGameOff)
    ...
    handleSetShardComplete = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(handleSetShardComplete)
    ...
    enterCloseShard = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterCloseShard)
    ...
    exitCloseShard = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitCloseShard)
    ...
    enterTutorialQuestion = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(enterTutorialQuestion)
    ...
    exitTutorialQuestion = report(
        types=['args', 'deltaStamp'],
        dConfigParam='teleport')(exitTutorialQuestion)
    ...
    enterPlayGame = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(enterPlayGame)
    ...
    handleGameDone = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(handleGameDone)
    ...
    exitPlayGame = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(exitPlayGame)
    ...
    gotTimeSync = report(
        types=['args', 'deltaStamp'], dConfigParam='teleport')(gotTimeSync)
    ...
    def logAccountInfo(self):
        ...
        if base.logPrivateInfo:
            ...
            if self.periodTimerSecondsRemaining is not None:
                self.notify.info(
                    'period time left: %s' % PythonUtil.formatElapsedSeconds(
    ...
    def getStartingDistrict(self):
        ...
        if base.fillShardsToIdealPop:
            ...
            self.notify.debug(
                'low: %s mid: %s high: %s' % (lowPop, midPop, highPop))
    ...
    def waitForDatabaseTimeout(self, extraTimeout=0, requestName='unknown'):
        ...
        globalClock.tick()
        taskMgr.doMethodLater(
            (OTPGlobals.DatabaseDialogTimeout + extraTimeout) * choice(
                __dev__, 10, 1),
    ...
    def _OTPClientRepository__showWaitingForDatabase(self, requestName):
        ...
        OTPClientRepository.notify.info(
            'timed out waiting for %s at %s' % (requestName,
    ...
    def _OTPClientRepository__giveUpWaitingForDatabase(self, requestName):
        OTPClientRepository.notify.info(
            'giving up waiting for %s at %s' % (requestName,
                                                globalClock.getFrameTime()))
        self.cleanupWaitingForDatabase()
        self.loginFSM.request('noConnection')
        return Task.done
    ...
    def recordPeriodTimer(self, task):
        ...
        self.notify.debug(
            'periodTimeRemaining: %s' % self.runningPeriodTimeRemaining)
    ...
    def gotInterestDoneMessage(self, di):
        if self.deferredGenerates:
            ...
            self.deferredGenerates.append((CLIENT_DONE_INTEREST_RESP, (dg,
                                                                       di)))
        else:
    ...
    def gotObjectLocationMessage(self, di):
        if self.deferredGenerates:
            ...
            if doId in self.deferredDoIds:
                self.deferredDoIds[doId][3].append((CLIENT_OBJECT_LOCATION,
                                                    (dg, di)))
            else:
